...
namespace GW2EIEvtcParser.ParsedData
{
    public class AgentData
    {
        ...
        internal AgentItem AddCustomAgent(long start, long end, AgentItem.AgentType type, string name, ParserHelper.Spec spec, int ID, bool isFake, ushort toughness = 0, ushort healing = 0, ushort condition = 0, ushort concentration = 0, uint hitboxWidth = 0, uint hitboxHeight = 0)
        {
            var rnd = new Random();
            ulong agentValue = 0;
            ...
            var agent = new AgentItem(agentValue, name, spec, ID, instID, type, toughness, healing, condition, concentration, hitboxWidth, hitboxHeight, start, end, isFake);
