...
internal static class EncounterDamageModifiers
{
    ...
    [
        ...
        new BuffOnActorDamageModifier(Mod_ShreddedArmor, ShreddedArmor, "Shredded Armor", "20% per stack", DamageSource.Incoming, 20, DamageType.Strike, DamageType.All, Source.EncounterSpecific, ByStack, BuffImages.Unknown, DamageModifierMode.PvE),
        // Enrages
