...
namespace GW2EIEvtcParser.EIData
{
    public abstract class DamageModifier : IVersionable
    {
        ...
        internal static readonly List<DamageModifier> CommonDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(SkillIDs.OldExposed, "Old Exposed (Strike)", "30%", DamageSource.All, 30.0, DamageType.Strike, DamageType.All, Source.Common, ByPresence, "https://wiki.guildwars2.com/images/6/6b/Exposed.png", GW2Builds.March2022Balance2, GW2Builds.EndOfLife, DamageModifierMode.All),
            new BuffDamageModifierTarget(SkillIDs.OldExposed, "Old Exposed (Condition)", "100%", DamageSource.All, 100.0, DamageType.Condition, DamageType.All, Source.Common, ByPresence, "https://wiki.guildwars2.com/images/6/6b/Exposed.png", GW2Builds.March2022Balance2, GW2Builds.EndOfLife, DamageModifierMode.All),
