...
namespace GW2EIEvtcParser.EIData
{
    public abstract class DamageModifier : IVersionable
    {
        ...
        private static readonly List<DamageModifier> _guardianDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(Buff.NumberOfBoonsID, "Power of the Virtuous", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ParserHelper.Source.Guardian, ByStack, "https://wiki.guildwars2.com/images/e/ee/Power_of_the_Virtuous.png", DamageModifierMode.All),
        ...
        private static readonly List<DamageModifier> _rangerDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(Buff.NumberOfBoonsID, "Bountiful Hunter", "1% per boon", DamageSource.All, 1.0, DamageType.Power, DamageType.All, ParserHelper.Source.Ranger, ByStack, "https://wiki.guildwars2.com/images/2/25/Bountiful_Hunter.png", DamageModifierMode.All),
        ...
        {
            new BuffDamageModifierTarget(Buff.NumberOfBoonsID, "Spiteful Talisman", "10% on boonless target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ParserHelper.Source.Necromancer, ByAbsence, "https://wiki.guildwars2.com/images/9/96/Spiteful_Talisman.png", DamageModifierMode.All),
