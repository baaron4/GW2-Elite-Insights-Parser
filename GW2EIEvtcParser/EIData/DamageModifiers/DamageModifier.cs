...
namespace GW2EIEvtcParser.EIData
{
    public abstract class DamageModifier : IVersionable
    {
        ...
        internal static readonly List<DamageModifier> FightSpecificDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(SkillIDs.Exposed67763, "Exposed Soo-Won (Strike)", "30%", DamageSource.All, 30.0, DamageType.Strike, DamageType.All, Source.FightSpecific, ByPresence, "https://wiki.guildwars2.com/images/6/6b/Exposed.png", DamageModifierMode.PvE),
            new BuffDamageModifierTarget(SkillIDs.Exposed67763, "Exposed Soo-won (Condition)", "100%", DamageSource.All, 100.0, DamageType.Condition, DamageType.All, Source.FightSpecific, ByPresence, "https://wiki.guildwars2.com/images/6/6b/Exposed.png", DamageModifierMode.PvE),
