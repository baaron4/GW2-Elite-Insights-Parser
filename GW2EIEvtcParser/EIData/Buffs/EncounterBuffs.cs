...
namespace GW2EIEvtcParser.EIData
{
    internal static class EncounterBuffs
    {
        ...
        internal static readonly List<Buff> FightSpecific = new List<Buff>
        {
            ...
            new Buff("Empowered Envy (Cerus)", EmpoweredEnvyCerus, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Malice (Cerus)", EmpoweredMaliceCerus, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Malice", EmpoweredMalice, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Envy", EmpoweredEnvy, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Rage", EmpoweredRage, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Regret", EmpoweredRegret, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Gluttony", EmpoweredGluttony, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
            new Buff("Empowered Despair", EmpoweredDespair, Source.FightSpecific, BuffClassification.Other, BuffImages.EmpoweredTempleOfFebe),
