...
namespace GW2EIEvtcParser.EIData
{
    internal static class EncounterBuffs
    {
        ...
        internal static readonly List<Buff> FightSpecific = new List<Buff>
        {
            ...
            new Buff("Gathering Shadows", GatheringShadows, Source.FightSpecific, BuffStackType.Stacking, 25, BuffClassification.Other, BuffImages.CaptainsInspiration),
            ...
            new Buff("Shared Destruction (Li)", SharedDestructionLi, Source.FightSpecific, BuffClassification.Other, BuffImages.MonsterSkill),
