...
internal static class EncounterBuffs
{
    ...
    internal static readonly IReadOnlyList<Buff> FightSpecific =
        [
            ...
            new Buff("Sacrifice", MatthiasSacrifice, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Sacrifice Selection", MatthiasSacrificeSelection, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Spatial Denial", SpatialDenial, Source.FightSpecific, BuffClassification.Other, SkillImages.PhantasmalWarlock),
            // Twisted Castle
            ...
            new Buff("Chaotic Haze", ChaoticHaze, Source.FightSpecific, BuffClassification.Other, BuffImages.ChaoticHaze),
            ...
            new Buff("Gravity Well (Xera)", GravityWellXera, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Celestial Dash", CelestialDashBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.CelestialDash),
            // Mursaat Overseer
            new Buff("Empowered (MO)", EmpoweredMO, Source.FightSpecific, BuffStackType.Stacking, 4, BuffClassification.Other, BuffImages.EmpoweredMursaarOverseer),
            ...
            new Buff("Green Selection", DeimosSelectedByGreen, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            //////////////////////////////////////////////
            // Soulless Horror
            ...
            new Buff("Source: Pure Oblivion", SourcePureOblivionBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.CounterMagicSkill),
            ...
            // Twin Largos
            new Buff("Aquatic Detainment", AquaticDetainmentBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Tidal Pool", TidalPoolBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            // Qadim
            new Buff("Flame Armor", FlameArmor, Source.FightSpecific, BuffClassification.Other, BuffImages.FlameArmor),
            ...
            new Buff("Resistance (Lava Elemental)", ResistanceLavaElemental, Source.FightSpecific, BuffStackType.Queue, 5, BuffClassification.Other, SkillImages.FireShield),
            new Buff("Shielded (Lava Elemental)", ShieldedLavaElemental, Source.FightSpecific, BuffClassification.Other, SkillImages.FireShield),
            ...
            new Buff("Diamond Palisade (Damage)", DiamondPalisadeDamage, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Diamond Palisade", DiamondPalisade, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Decima Beam Targeting CM 1", DecimaBeamLoadingCM1, Source.FightSpecific, BuffClassification.Hidden, BuffImages.Unknown),
            new Buff("Decima Beam Targeting CM 2", DecimaBeamLoadingCM2, Source.FightSpecific, BuffClassification.Hidden, BuffImages.Unknown),
            ...
            new Buff("Decima Red Beam Targeting CM 1", DecimaRedBeamLoadingCM1, Source.FightSpecific, BuffClassification.Hidden, BuffImages.Unknown),
            new Buff("Decima Red Beam Targeting CM 2", DecimaRedBeamLoadingCM2, Source.FightSpecific, BuffClassification.Hidden, BuffImages.Unknown),
            ...
            new Buff("Fluxlance Target", FluxlanceTargetBuff1, Source.FightSpecific, BuffClassification.Other, BuffImages.Target),
            ...
            new Buff("Aura of Corruption (Greer)", AuraOfCorruptionBuff_Greer, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Aura of Corruption (Reeg)", AuraOfCorruptionBuff_Reeg, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Aura of Corruption (Gree)", AuraOfCorruptionBuff_Gree, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Aura of Corruption (Ereg)", AuraOfCorruptionBuff_Ereg, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Fire", Fire, Source.FightSpecific, BuffStackType.Stacking, 25, BuffClassification.Other, BuffImages.FireEffect),
            ...
            new Buff("Cosmic Meteor", CosmicMeteor, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Electrocuted", Electrocuted, Source.FightSpecific, BuffStackType.Stacking, 25, BuffClassification.Other, SkillImages.AirAttunement),
            new Buff("Hypernova Launch", HypernovaLaunchBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.CelestialDash),
            ...
            new Buff("Aspect Tether", AspectTetherBuff, Source.FightSpecific, BuffStackType.StackingUniquePerSrc, 999, BuffClassification.Other, BuffImages.Target),
            new Buff("Rending Storm Target (Axe 1)", RendingStormAxeTargetBuff1, Source.FightSpecific, BuffClassification.Other, SkillImages.ConjureFlameAxe),
            new Buff("Rending Storm Target (Axe 2)", RendingStormAxeTargetBuff2, Source.FightSpecific, BuffClassification.Other, SkillImages.ConjureFlameAxe),
            ...
            // Mai Trin
            new Buff("Shared Destruction (Mai Trin)", SharedDestructionMaiTrinNM, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Shared Destruction CM (Mai Trin)", SharedDestructionMaiTrinCM, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Chaos and Destruction", ChaosAndDestructionBuff, Source.FightSpecific, BuffStackType.Stacking, 25, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Photon Saturation", PhotonSaturation, Source.FightSpecific, BuffClassification.Other, BuffImages.PhotonSaturation),
            new Buff("Ley Breach Target", LeyBreachTargetBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Death's Embrace", DeathsEmbraceNMCMBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Death's Embrace 2", DeathsEmbraceNMBuff, Source.FightSpecific, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Death's Hand Spread", DeathsHandSpreadBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            // Harvest Temple
            new Buff("Influence of the Void", InfluenceOfTheVoidBuff, Source.FightSpecific, BuffStackType.Stacking, 20, BuffClassification.Other, SkillImages.ThrowCursedArtifact),
            ...
            new Buff("Tribocharge", TribochargePlayerToNPCBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            new Buff("Noxious Vapor Blade (Target)", NoxiousVaporBladeTargetBuff, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            new Buff("Lost Control (Cosmic Observatory)", CosmicObservatoryLostControlBuff, Source.FightSpecific, BuffClassification.Debuff, SkillImages.ThrowCursedArtifact),
            new Buff("Shooting Stars Target", ShootingStarsTargetBuff, Source.FightSpecific, BuffClassification.Other, BuffImages.Target),
            new Buff("Demonic Aura", DagdaDemonicAura, Source.FightSpecific, BuffStackType.Stacking, 10, BuffClassification.Other, ItemImages.ChampionOfTheCrown),
            ...
            new Buff("Shared Destruction Target (Meteor Crash)", DagdaSharedDestruction_MeteorCrash, Source.FightSpecific, BuffClassification.Other, SkillImages.MonsterSkill),
            ...
            // Convergences
            // - Outer Nayos
            new Buff("Unstable Attunement (SotO)", UnstableAttunementSotO, Source.FightSpecific, BuffStackType.StackingConditionalLoss, 5, BuffClassification.Other, BuffImages.DebilitatingVoid),
            new Buff("Wizard's Blessing (SotO)", WizardsBlessingSotO, Source.FightSpecific, BuffStackType.Queue, 9, BuffClassification.Other, BuffImages.WizardsBlessing),
            new Buff("Wisp Form (SotO)", WispFormSotO, Source.FightSpecific, BuffClassification.Other, BuffImages.FracturedSpirit),
            new Buff("Kryptis Essence", KryptisEssence, Source.FightSpecific, BuffStackType.Stacking, 50, BuffClassification.Offensive, BuffImages.KryptisEssence),
            // - Mount Balrior
            new Buff("Unstable Attunement (JW)", UnstableAttunementJW, Source.FightSpecific, BuffStackType.StackingConditionalLoss, 5, BuffClassification.Other, BuffImages.DebilitatingVoid),
            new Buff("Wizard's Blessing (JW)", WizardsBlessingJW, Source.FightSpecific, BuffStackType.Queue, 9, BuffClassification.Other, BuffImages.WizardsBlessing),
            new Buff("Wisp Form (JW)", WispFormJW, Source.FightSpecific, BuffClassification.Other, BuffImages.FracturedSpirit),
            new Buff("Calibrated Essence", CalibratedEssence, Source.FightSpecific, BuffStackType.Stacking, 50, BuffClassification.Offensive, BuffImages.KryptisEssence),
            ...
            new Buff("Enhancement (+5% Damage vs. Dragonvoid)", EnhancementDragonsEnd, Source.FightSpecific, BuffClassification.Offensive, ItemImages.NourishmentUtility),
