...
namespace GW2EIEvtcParser.EIData
{
    public class Buff : IVersionable
    {
        ...
        internal static readonly List<Buff> FightSpecific = new List<Buff>
        {
                ...
                new Buff("Tidal Pool", TidalPoolEffect , Source.FightSpecific, BuffClassification.Other, "https://wiki.guildwars2.com/images/5/5f/Monster_Skill.png"),
                ...
                new Buff("Empowered (Watchknight Triumverate)", EmpowererWatchknightTriumverate, Source.FightSpecific, BuffStackType.Queue, 99, BuffClassification.Other,"https://wiki.guildwars2.com/images/d/d1/Charging_Energies_%28attack_effect%29.png"),
                //Open World Soo-Won
        ...
        {
                new Buff("Malnourished",Malnourished, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/67/Malnourished.png"),
                new Buff("Plate of Truffle Steak",PlateOfTruffleSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/4c/Plate_of_Truffle_Steak.png"),
                new Buff("Bowl of Sweet and Spicy Butternut Squash Soup",BowlOfSweetAndSpicyButternutSquashSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/df/Bowl_of_Sweet_and_Spicy_Butternut_Squash_Soup.png"),
                new Buff("Bowl Curry Butternut Squash Soup",BowlCurryButternutSquashSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/16/Bowl_of_Curry_Butternut_Squash_Soup.png"),
                new Buff("Bowl of Fancy Potatoe and Leek Soup",BowlOfFancyPotatoeAndLeekSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/e/e3/Bowl_of_Fancy_Potato_and_Leek_Soup.png"),
                new Buff("Red-Lentil Saobosa",RedLentilSaobosa, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/a/a8/Red-Lentil_Saobosa.png"),
                new Buff("Super Veggie Pizza",SuperVeggiePizza, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/66/Super_Veggie_Pizza.png"),
                new Buff("Rare Veggie Pizza",RareVeggiePizza, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/a/a0/Rare_Veggie_Pizza.png"),
                new Buff("Bowl of Garlic Kale Sautee",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/0/04/Bowl_of_Garlic_Kale_Sautee.png"),
                new Buff("Koi Cake",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/14/Koi_Cake.png"),
                new Buff("Prickly Pear Pie",PricklyPearPie, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/0/0a/Prickly_Pear_Pie.png"),
                new Buff("Bowl of Nopalitos Sauté",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/f1/Bowl_of_Nopalitos_Saut%C3%A9.png"),
                new Buff("Loaf of Candy Cactus Cornbread",LoafOfCandyCactusCornbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/b2/Loaf_of_Candy_Cactus_Cornbread.png"),
                new Buff("Delicious Rice Ball",DeliciousRiceBall, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/5/5d/Delicious_Rice_Ball.png"),
                new Buff("Slice of Allspice Cake",SliceOfAllspiceCake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/13/Slice_of_Allspice_Cake.png"),
                new Buff("Fried Golden Dumpling",FriedGoldenDumpling, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/14/Fried_Golden_Dumpling.png"),
                new Buff("Bowl of Seaweed Salad",BowlOfSeaweedSalad, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/1c/Bowl_of_Seaweed_Salad.png"),
                new Buff("Bowl of Orrian Truffle and Meat Stew",BowlOfOrrianTruffleAndMeatStew, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/b8/Bowl_of_Orrian_Truffle_and_Meat_Stew.png"),
                new Buff("Plate of Mussels Gnashblade",PlateOfMusselsGnashblade, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/7/7b/Plate_of_Mussels_Gnashblade.png"),
                new Buff("Spring Roll",SpringRoll, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/da/Spring_Roll.png"),
                new Buff("Plate of Beef Rendang",PlateOfBeefRendang, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/d0/Plate_of_Beef_Rendang.png"),
                new Buff("Dragon's Revelry Starcake",DragonsRevelryStarcake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/2/2b/Dragon%27s_Revelry_Starcake.png"),
                new Buff("Avocado Smoothie",AvocadoSmoothie, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/83/Avocado_Smoothie.png"),
                new Buff("Carrot Souffle",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/7/71/Carrot_Souffl%C3%A9.png"), //same as Dragon's_Breath_Bun
                new Buff("Plate of Truffle Steak Dinner",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/92/Plate_of_Truffle_Steak_Dinner.png"), //same as Dragon's Breath Bun
                new Buff("Dragon's Breath Bun",DragonsBreathBun, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/5/53/Dragon%27s_Breath_Bun.png"),
                new Buff("Karka Egg Omelet",KarkaEggOmelet, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/9e/Karka_Egg_Omelet.png"),
                new Buff("Steamed Red Dumpling",SteamedRedDumpling, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/8c/Steamed_Red_Dumpling.png"),
                new Buff("Saffron Stuffed Mushroom",Unknown, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/e/e2/Saffron_Stuffed_Mushroom.png"), //same as Karka Egg Omelet
                new Buff("Soul Pastry",SoulPastry, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/2/2c/Soul_Pastry.png"),
                new Buff("Bowl of Fire Meat Chili",BowlOfFireMeatChili, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/ba/Bowl_of_Fire_Meat_Chili.png"),
                new Buff("Plate of Fire Flank Steak",PlateOfFireFlankSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/2/27/Plate_of_Fire_Flank_Steak.png"),
                new Buff("Plate of Orrian Steak Frittes",PlateOfOrrianSteakFrittes, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/4d/Plate_of_Orrian_Steak_Frittes.png"),
                new Buff("Spicier Flank Steak",SpicierFlankSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/0/01/Spicier_Flank_Steak.png"),
                new Buff("Mango Pie",MangoPie, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/3d/Mango_Pie.png"),
                new Buff("Block of Tofu", BlockOfTofu, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/fa/Block_of_Tofu.png"),
                new Buff("Fishy Rice Bowl", FishyRiceBowl, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/1/14/Fishy_Rice_Bowl.png"),
                new Buff("Meaty Rice Bowl", MeatyRiceBowl, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/65/Meaty_Rice_Bowl.png"),
                new Buff("Plate of Kimchi Pancakes", PlateOfKimchiPancakes, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/34/Plate_of_Kimchi_Pancakes.png"),
        ...
        {     
                ...
                new Buff("Diminished",Diminished, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/71/Diminished.png"),
                new Buff("Rough Sharpening Stone", RoughSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/14/Rough_Sharpening_Stone.png"),
                new Buff("Simple Sharpening Stone", SimpleSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/ef/Simple_Sharpening_Stone.png"),
                new Buff("Standard Sharpening Stone", StandardSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/82/Standard_Sharpening_Stone.png"),
                new Buff("Quality Sharpening Stone", QualitySharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/6/68/Quality_Sharpening_Stone.png"),
                new Buff("Hardened Sharpening Stone", HardenedSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/8d/Hardened_Sharpening_Stone.png"),
                new Buff("Superior Sharpening Stone", SuperiorSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/78/Superior_Sharpening_Stone.png"),
                ...
                new Buff("Apprentice Maintenance Oil", ApprenticeMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/51/Apprentice_Maintenance_Oil.png"),
                new Buff("Journeyman Maintenance Oil", JourneymanMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/b/b1/Journeyman_Maintenance_Oil.png"),
                new Buff("Standard Maintenance Oil", StandardMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/a/a6/Standard_Maintenance_Oil.png"),
                new Buff("Artisan Maintenance Oil", ArtisanMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/75/Artisan_Maintenance_Oil.png"),
                new Buff("Quality Maintenance Oil", QualityMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/23/Quality_Maintenance_Oil.png"),
                new Buff("Master Maintenance Oil", MasterMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
                ...
                new Buff("Apprentice Tuning Crystal", ApprenticeTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/7d/Apprentice_Tuning_Crystal.png"),
                new Buff("Journeyman Tuning Crystal", JourneymanTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/1e/Journeyman_Tuning_Crystal.png"),
                new Buff("Standard Tuning Crystal", StandardTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/1e/Standard_Tuning_Crystal.png"),
                new Buff("Artisan Tuning Crystal", ArtisanTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/eb/Artisan_Tuning_Crystal.png"),
                new Buff("Quality Tuning Crystal", QualityTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/3/3b/Quality_Tuning_Crystal.png"),
                new Buff("Master Tuning Crystal", MasterTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/58/Master_Tuning_Crystal.png"),
                ...
                new Buff("Compact Hardened Sharpening Stone", CompactHardenedSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/1f/Compact_Hardened_Sharpening_Stone.png"),
                new Buff("Tin of Fruitcake", TinOfFruitcake, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/a/af/Tin_of_Fruitcake.png"),
                new Buff("Bountiful Sharpening Stone", BountifulSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/78/Superior_Sharpening_Stone.png"),
                new Buff("Toxic Sharpening Stone", ToxicSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/d/db/Toxic_Sharpening_Stone.png"),
                new Buff("Magnanimous Sharpening Stone", MagnanimousSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/a/aa/Magnanimous_Sharpening_Stone.png"),
                new Buff("Corsair Sharpening Stone", CorsairSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/0/06/Corsair_Sharpening_Stone.png"),
                new Buff("Furious Sharpening Stone", FuriousSharpeningStone, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/78/Superior_Sharpening_Stone.png"),
                new Buff("Holographic Super Cheese", HolographicSuperCheese, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/f/fa/Holographic_Super_Cheese.png"),
                new Buff("Compact Quality Maintenance Oil", CompactQualityMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/d/d8/Compact_Quality_Maintenance_Oil.png"),
                new Buff("Peppermint Oil", PeppermintOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/b/bc/Peppermint_Oil.png"),
                new Buff("Toxic Maintenance Oil", ToxicMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/a/a6/Toxic_Maintenance_Oil.png"),
                new Buff("Magnanimous Maintenance Oil", MagnanimousMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/53/Magnanimous_Maintenance_Oil.png"),
                new Buff("Enhanced Lucent Oil", EnhancedLucentOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/ee/Enhanced_Lucent_Oil.png"),
                new Buff("Potent Lucent Oil", PotentLucentOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/16/Potent_Lucent_Oil.png"),
                new Buff("Corsair Maintenance Oil", CorsairMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/53/Magnanimous_Maintenance_Oil.png"),
                new Buff("Furious Maintenance Oil", FuriousMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
                new Buff("Holographic Super Drumstick", HolographicSuperDrumstick, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/1/1d/Holographic_Super_Drumstick.png"),
                new Buff("Bountiful Maintenance Oil", BountifulMaintenanceOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
                new Buff("Compact Quality Tuning Crystal", CompactQualityTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/b/ba/Compact_Quality_Tuning_Crystal.png"),
                new Buff("Tuning Icicle", TuningIcicle, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/75/Tuning_Icicle.png"),
                new Buff("Bountiful Tuning Crystal", BountifulTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/58/Master_Tuning_Crystal.png"),
                new Buff("Toxic Focusing Crystal", ToxicFocusingCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/d/de/Toxic_Focusing_Crystal.png"),
                new Buff("Magnanimous Tuning Crystal", MagnanimousTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/23/Magnanimous_Tuning_Crystal.png"),
                new Buff("Furious Tuning Crystal", FuriousTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/58/Master_Tuning_Crystal.png"),
                new Buff("Corsair Tuning Crystal", CorsairTuningCrystal, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/f/f7/Corsair_Tuning_Crystal.png"),
                new Buff("Holographic Super Apple", HolographicSuperApple, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/ee/Holographic_Super_Apple.png"),
                new Buff("Sharpening Skull", SharpeningSkull, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/ee/Sharpening_Skull.png"),
                new Buff("Flask of Pumpkin Oil", FlaskOfPumpkinOil, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/71/Flask_of_Pumpkin_Oil.png"),
                new Buff("Lump of Crystallized Nougat", LumpOfCrystallizedNougat, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/8f/Lump_of_Crystallized_Nougat.png"),
                new Buff("Decade Enhancement", DecadeEnhancement, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/76/Decade_Enhancement_Station.png"),
        };

        internal static readonly List<Buff> OtherConsumables = new List<Buff>
        {       
                //
                new Buff("Reinforced Armor", ReinforcedArmor, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/8/83/Reinforced_Armor.png", GW2Builds.June2022Balance, GW2Builds.EndOfLife),
                //
                new Buff("15% Speed Bonus", SpeedBonus15, Source.Item, BuffStackType.Queue, 9, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/d/d7/Speed_Bonus_%28fifteen_percent%29.png"),
                new Buff("5% Damage Reduction", DamageReduction5, Source.Item, BuffStackType.Queue, 9, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/8/8b/Damage_Reduction_%28five_percent%29.png"),
                new Buff("Healthful Rejuvenation", HealthfulRejuvenation, Source.Item, BuffStackType.Queue, 9, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/1/1c/Healthful_Rejuvenation.png"),
                new Buff("5% Damage Bonus", DamageBonus5, Source.Item, BuffStackType.Queue, 9, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/6/66/Damage_Bonus_%28five_percent%29.png"),
                //
                new Buff("Skale Venom (Consumable)", SkaleVenomConsumable, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/9/96/Skale_Venom_%28consumable%29.png"),
                new Buff("Swift Moa Feather", SwiftMoaFeather, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/f/f0/Swift_Moa_Feather.png"),
        };

        internal static readonly List<Buff> Writs = new List<Buff>
        {

                new Buff("Writ of Basic Strength", WritOfBasicStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/7e/Writ_of_Basic_Strength.png"),
                new Buff("Writ of Strength", WritOfStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5e/Writ_of_Strength.png"),
                new Buff("Writ of Studied Strength", WritOfStudiedStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/23/Writ_of_Studied_Strength.png"),
                new Buff("Writ of Calculated Strength", WritOfCalculatedStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/8d/Writ_of_Calculated_Strength.png"),
                new Buff("Writ of Learned Strength", WritOfLearnedStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/8d/Writ_of_Calculated_Strength.png"),
                new Buff("Writ of Masterful Strength", WritOfMasterfulStrength, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/2b/Writ_of_Masterful_Strength.png"),
                new Buff("Writ of Basic Accuracy", WritOfBasicAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/82/Writ_of_Basic_Accuracy.png"),
                new Buff("Writ of Accuracy", WritOfAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/29/Writ_of_Accuracy.png"),
                new Buff("Writ of Studied Accuracy", WritOfStudiedAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/a/ad/Writ_of_Studied_Accuracy.png"),
                new Buff("Writ of Calculated Accuracy", WritOfCalculatedAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/27/Writ_of_Calculated_Accuracy.png"),
                new Buff("Writ of Learned Accuracy", WritOfLearnedAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5a/Writ_of_Masterful_Accuracy.png"),
                new Buff("Writ of Masterful Accuracy", WritOfMasterfulAccuracy, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/5/5a/Writ_of_Masterful_Accuracy.png"),
                new Buff("Writ of Basic Malice", WritOfBasicMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/9/9e/Writ_of_Basic_Malice.png"),
                new Buff("Writ of Malice", WritOfMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/c/c4/Writ_of_Malice.png"),
                new Buff("Writ of Studied Malice", WritOfStudiedMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/b/bd/Writ_of_Studied_Malice.png"),
                new Buff("Writ of Calculated Malice", WritOfCalculatedMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/7/75/Writ_of_Calculated_Malice.png"),
                new Buff("Writ of Learned Malice", WritOfLearnedMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/9/9b/Writ_of_Learned_Malice.png"),
                new Buff("Writ of Masterful Malice", WritOfMasterfulMalice, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/2/20/Writ_of_Masterful_Malice.png"),
                new Buff("Writ of Basic Speed", WritOfBasicSpeed, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/e/e6/Writ_of_Basic_Speed.png"),
                new Buff("Writ of Studied Speed", WritOfStudiedSpeed, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/d/d1/Recipe_sheet_fine_boots.png"),
                new Buff("Writ of Masterful Speed", WritOfMasterfulSpeed, Source.Item, BuffClassification.Enhancement, "https://wiki.guildwars2.com/images/8/8e/Recipe_sheet_masterwork_boots.png"),
        };

        internal static readonly List<Buff> Potions = new List<Buff>
        {
                new Buff("Potion Of Karka Toughness", PotionOfKarkaToughness, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/f/fb/Powerful_Potion_of_Inquest_Slaying.png"),
                // Slaying Potions
                new Buff("Powerful Potion of Flame Legion Slaying",PowerfulPotionOfFlameLegionSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/e/e2/Powerful_Potion_of_Flame_Legion_Slaying.png"),
                new Buff("Powerful Potion of Halloween Slaying",PowerfulPotionOfHalloweenSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/f/fe/Powerful_Potion_of_Halloween_Slaying.png"),
                new Buff("Powerful Potion of Centaur Slaying",PowerfulPotionOfCentaurSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/3/3b/Powerful_Potion_of_Centaur_Slaying.png"),
                new Buff("Powerful Potion of Krait Slaying",PowerfulPotionOfKraitSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/b/b4/Powerful_Potion_of_Krait_Slaying.png"),
                new Buff("Powerful Potion of Ogre Slaying",PowerfulPotionOfOgreSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/b/b5/Powerful_Potion_of_Ogre_Slaying.png"),
                new Buff("Powerful Potion of Elemental Slaying",PowerfulPotionOfElementalSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/5/5f/Powerful_Potion_of_Elemental_Slaying.png"),
                new Buff("Powerful Potion of Destroyer Slaying",PowerfulPotionOfDestroyerSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/b/bd/Powerful_Potion_of_Destroyer_Slaying.png"),
                new Buff("Powerful Potion of Nightmare Court Slaying",PowerfulPotionOfNightmareCourtSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/7/74/Powerful_Potion_of_Nightmare_Court_Slaying.png"),
                new Buff("Powerful Potion of Slaying Scarlet's Armies",PowerfulPotionOfSlayingScarletsArmies, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/e/ee/Powerful_Potion_of_Demon_Slaying.png"),
                new Buff("Powerful Potion of Undead Slaying",PowerfulPotionOfUndeadSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/b/bd/Powerful_Potion_of_Undead_Slaying.png"),
                new Buff("Powerful Potion of Dredge Slaying",PowerfulPotionOfDredgeSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/9/9a/Powerful_Potion_of_Dredge_Slaying.png"),
                new Buff("Powerful Potion of Inquest Slaying",PowerfulPotionOfInquestSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/f/fb/Powerful_Potion_of_Inquest_Slaying.png"),
                new Buff("Powerful Potion of Demon Slaying",PowerfulPotionOfDemonSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/e/ee/Powerful_Potion_of_Demon_Slaying.png"),
                new Buff("Powerful Potion of Grawl Slaying",PowerfulPotionOfGrawlSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/1/15/Powerful_Potion_of_Grawl_Slaying.png"),
                new Buff("Powerful Potion of Sons of Svanir Slaying",PowerfulPotionOfSonsOfSvanirSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/3/33/Powerful_Potion_of_Sons_of_Svanir_Slaying.png"),
                new Buff("Powerful Potion of Outlaw Slaying",PowerfulPotionOfOutlawSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/e/ec/Powerful_Potion_of_Outlaw_Slaying.png"),
                new Buff("Powerful Potion of Ice Brood Slaying",PowerfulPotionOfIceBroodSlaying, Source.Item, BuffClassification.OtherConsumable, "https://wiki.guildwars2.com/images/0/0d/Powerful_Potion_of_Ice_Brood_Slaying.png"),
                // Fractals 
                new Buff("Fractal Mobility", FractalMobility, Source.Item, BuffStackType.Stacking, 5, BuffClassification.OtherConsumable,"https://wiki.guildwars2.com/images/thumb/2/22/Mist_Mobility_Potion.png/40px-Mist_Mobility_Potion.png"),
                new Buff("Fractal Defensive", FractalDefensive, Source.Item, BuffStackType.Stacking, 5, BuffClassification.OtherConsumable,"https://wiki.guildwars2.com/images/thumb/e/e6/Mist_Defensive_Potion.png/40px-Mist_Defensive_Potion.png"),
                new Buff("Fractal Offensive", FractalOffensive, Source.Item, BuffStackType.Stacking, 5, BuffClassification.OtherConsumable,"https://wiki.guildwars2.com/images/thumb/8/8d/Mist_Offensive_Potion.png/40px-Mist_Offensive_Potion.png"),
        ...
        internal static readonly List<Buff> AscendedFood = new List<Buff>
        {
                ...
                new Buff("Bowl of Sesame Fruit Salad", BowlOfSesameFruitSalad, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/0/01/Bowl_of_Sesame_Fruit_Salad.png"),
                new Buff("Bowl of Spiced Fruit Salad", BowlOfSpicedFruitSalad, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/9c/Bowl_of_Spiced_Fruit_Salad.png"),
                new Buff("Cilantro Lime Sous-Vide Steak", CilantroLimeSousVideSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/65/Cilantro_Lime_Sous-Vide_Steak.png"),
                new Buff("Cilantro and Cured Meat Flatbread", CilantroAndCuredMeatFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/87/Cilantro_and_Cured_Meat_Flatbread.png"),
                new Buff("Clove and Veggie Flatbread", CloveAndVeggieFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/6e/Clove_and_Veggie_Flatbread.png"),
                new Buff("Clove-Spiced Creme Brulee", CloveSpicedCremeBrulee, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/a/a2/Clove-Spiced_Creme_Brulee.png"),
                new Buff("Clove-Spiced Eggs Benedict", CloveSpicedEggsBenedict, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/7/7d/Clove-Spiced_Eggs_Benedict.png"),
                new Buff("Clove-Spiced Pear and Cured Meat Flatbread", CloveSpicedPearAndCuredMeatFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/c/c5/Clove-Spiced_Pear_and_Cured_Meat_Flatbread.png"),
                new Buff("Eggs Benedict with Mint-Parsley Sauce", EggsBenedictWithMintParsleySauce, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/92/Eggs_Benedict_with_Mint-Parsley_Sauce.png"),
                new Buff("Mango Cilantro Creme Brulee", MangoCilantroCremeBrulee, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/3d/Mango_Cilantro_Creme_Brulee.png"),
                new Buff("Mint Creme Brulee", MintCremeBrulee, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/31/Mint_Creme_Brulee.png"),
                new Buff("Mint Strawberry Cheesecake", MintStrawberryCheesecake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/64/Mint_Strawberry_Cheesecake.png"),
                new Buff("Mint and Veggie Flatbread", MintAndVeggieFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/f9/Mint_and_Veggie_Flatbread.png"),
                new Buff("Mint-Pear Cured Meat Flatbread", MintPearCuredMeatFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/60/Mint-Pear_Cured_Meat_Flatbread.png"),
                new Buff("Mushroom Clove Sous-Vide Steak", MushroomCloveSousVideSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/ba/Mushroom_Clove_Sous-Vide_Steak.png"),
                new Buff("Orange Clove Cheesecake", OrangeCloveCheesecake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/3f/Orange_Clove_Cheesecake.png"),
                new Buff("Peppercorn and Veggie Flatbread", PeppercornAndVeggieFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/9d/Peppercorn_and_Veggie_Flatbread.png"),
                new Buff("Peppercorn-Crusted Sous-Vide Steak", PeppercornCrustedSousVideSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/2/2e/Peppercorn-Crusted_Sous-Vide_Steak.png"),
                new Buff("Peppercorn-Spiced Eggs Benedict", PeppercornSpicedEggsBenedict, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/c/c6/Peppercorn-Spiced_Eggs_Benedict.png"),
                new Buff("Peppered Cured Meat Flatbread", PepperedCuredMeatFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/2/2d/Peppered_Cured_Meat_Flatbread.png"),
                new Buff("Plate of Beef Carpaccio with Mint Garnish", PlateOfBeefCarpaccioWithMintGarnish, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/42/Plate_of_Beef_Carpaccio_with_Mint_Garnish.png"),
                new Buff("Plate of Clear Truffle and Cilantro Ravioli", PlateOfClearTruffleAndCilantroRavioli, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/0/05/Plate_of_Clear_Truffle_and_Cilantro_Ravioli.png"),
                new Buff("Plate of Clear Truffle and Mint Ravioli", PlateOfClearTruffleAndMintRavioli, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/9e/Plate_of_Clear_Truffle_and_Mint_Ravioli.png"),
                new Buff("Plate of Clear Truffle and Sesame Ravioli", PlateOfClearTruffleAndSesameRavioli, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/de/Plate_of_Clear_Truffle_and_Sesame_Ravioli.png"),
                new Buff("Plate of Clove-Spiced Beef Carpaccio", PlateOfCloveSpicedBeefCarpaccio, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/44/Plate_of_Clove-Spiced_Beef_Carpaccio.png"),
                new Buff("Plate of Clove-Spiced Clear Truffle Ravioli", PlateOfCloveSpicedClearTruffleRavioli, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/c/c2/Plate_of_Clove-Spiced_Clear_Truffle_Ravioli.png"),
                new Buff("Plate of Clove-Spiced Coq Au Vin", PlateOfCloveSpicedCoqAuVin, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/dc/Plate_of_Clove-Spiced_Coq_Au_Vin.png"),
                new Buff("Plate of Clove-Spiced Poultry Aspic", PlateOfCloveSpicedPoultryAspic, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/5/50/Plate_of_Clove-Spiced_Poultry_Aspic.png"),
                new Buff("Plate of Coq Au Vin with Mint Garnish", PlateOfCoqAuVinWithMintGarnish, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/7/7c/Plate_of_Coq_Au_Vin_with_Mint_Garnish.png"),
                new Buff("Plate of Coq Au Vin with Salsa", PlateOfCoqAuVinWithSalsa, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/80/Plate_of_Coq_Au_Vin_with_Salsa.png"),
                new Buff("Plate of Peppercorn-Spiced Beef Carpaccio", PlateOfPeppercornSpicedBeefCarpaccio, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/40/Plate_of_Peppercorn-Spiced_Beef_Carpaccio.png"),
                ...
                new Buff("Plate of Peppercorn-Spiced Poultry Aspic", PlateOfPeppercornSpicedPoultryAspic, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/4f/Plate_of_Peppercorn-Spiced_Poultry_Aspic.png"),
                new Buff("Plate of Peppered Clear Truffle Ravioli", PlateOfPepperedClearTruffleRavioli, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/fe/Plate_of_Peppered_Clear_Truffle_Ravioli.png"),
                new Buff("Plate of Poultry Aspic with Mint Garnish", PlateOfPoultryAspicWithMintGarnish, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/91/Plate_of_Poultry_Aspic_with_Mint_Garnish.png"),
                new Buff("Plate of Poultry Aspic with Salsa Garnish", PlateOfPoultryAspicWithSalsaGarnish, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/5/5b/Plate_of_Poultry_Aspic_with_Salsa_Garnish.png"),
                new Buff("Plate of Sesame Poultry Aspic", PlateOfSesamePoultryAspic, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/64/Plate_of_Sesame_Poultry_Aspic.png"),
                new Buff("Plate of Sesame-Crusted Coq Au Vin", PlateOfSesameCrustedCoqAuVin, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/3/3e/Plate_of_Sesame-Crusted_Coq_Au_Vin.png"),
                new Buff("Plate of Sesame-Ginger Beef Carpaccio", PlateOfSesameGingerBeefCarpaccio, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/b7/Plate_of_Sesame-Ginger_Beef_Carpaccio.png"),
                new Buff("Salsa Eggs Benedict", SalsaEggsBenedict, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/7/79/Salsa_Eggs_Benedict.png"),
                new Buff("Salsa-Topped Veggie Flatbread", SalsaToppedVeggieFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/f3/Salsa-Topped_Veggie_Flatbread.png"),
                new Buff("Sesame Cheesecake", SesameCheesecake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/e/ef/Sesame_Cheesecake.png"),
                new Buff("Sesame Creme Brulee", SesameCremeBrulee, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/63/Sesame_Creme_Brulee.png"),
                new Buff("Sesame Eggs Benedict", SesameEggsBenedict, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/f5/Sesame_Eggs_Benedict.png"),
                new Buff("Sesame Veggie Flatbread", SesameVeggieFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/db/Sesame_Veggie_Flatbread.png"),
                new Buff("Sesame-Asparagus and Cured Meat Flatbread", SesameAsparagusAndCuredMeatFlatbread, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/87/Sesame-Asparagus_and_Cured_Meat_Flatbread.png"),
                new Buff("Sous-Vide Steak with Mint-Parsley Sauce", SousVideSteakWithMintParsleySauce, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/99/Sous-Vide_Steak_with_Mint-Parsley_Sauce.png"),
                new Buff("Soy-Sesame Sous-Vide Steak", SoySesameSousVideSteak, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/d/da/Soy-Sesame_Sous-Vide_Steak.png"),
                new Buff("Spherified Cilantro Oyster Soup", SpherifiedCilantroOysterSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/e/e1/Spherified_Cilantro_Oyster_Soup.png"),
                new Buff("Spherified Clove-Spiced Oyster Soup", SpherifiedCloveSpicedOysterSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/fa/Spherified_Clove-Spiced_Oyster_Soup.png"),
                new Buff("Spherified Oyster Soup with Mint Garnish", SpherifiedOysterSoupWithMintGarnish, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/6/63/Spherified_Oyster_Soup_with_Mint_Garnish.png"),
                new Buff("Spherified Peppercorn-Spiced Oyster Soup", SpherifiedPeppercornSpicedOysterSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/43/Spherified_Peppercorn-Spiced_Oyster_Soup.png"),
                new Buff("Spherified Sesame Oyster Soup", SpherifiedSesameOysterSoup, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/5/51/Spherified_Sesame_Oyster_Soup.png"),
                new Buff("Spiced Pepper Creme Brulee", SpicedPepperCremeBrulee, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/b/ba/Spiced_Pepper_Creme_Brulee.png"),
                new Buff("Spiced Peppercorn Cheesecake", SpicedPeppercornCheesecake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/9/9c/Spiced_Peppercorn_Cheesecake.png"),
                new Buff("Strawberry Cilantro Cheesecake", StrawberryCilantroCheesecake, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/8/8d/Strawberry_Cilantro_Cheesecake.png"),
                new Buff("Plate of Imperial Palace Special", PlateOfImperialPalaceSpecial , Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/c/c4/Plate_of_Imperial_Palace_Special.png"),
                new Buff("Plate of Crispy Fish Pancakes", PlateOfCrispyFishPancakes , Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/f/f5/Plate_of_Crispy_Fish_Pancakes.png"),
                new Buff("Bowl of Jade Sea Bounty", BowlOfJadeSeaBounty, Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/4/40/Bowl_of_Jade_Sea_Bounty.png"),
                new Buff("Bowl of Echovald Hotpot", BowlOfEchovaldHotpot , Source.Item, BuffClassification.Nourishment, "https://wiki.guildwars2.com/images/e/e1/Bowl_of_Echovald_Hotpot.png"),
        };

        internal static readonly List<Buff> FoodProcs = new List<Buff>
        {
            // Effect procs for On Kill Food
            new Buff("Nourishment (Bonus Power)", NourishmentBonusPower, Source.Item, BuffClassification.Offensive, "https://wiki.guildwars2.com/images/d/d6/Champion_of_the_Crown.png"),
            new Buff("Nourishment (Bonus Power & Ferocity)", NourishmentBonusPowerFerocity, Source.Item, BuffClassification.Offensive, "https://wiki.guildwars2.com/images/d/d6/Champion_of_the_Crown.png"),
            new Buff("Malice (Bonus Condition Damage)", MaliceBonusConditionDamage, Source.Item, BuffClassification.Offensive, "https://wiki.guildwars2.com/images/d/d6/Champion_of_the_Crown.png"),
        };
    }
}
