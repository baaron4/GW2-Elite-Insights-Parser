...
namespace GW2EIEvtcParser.EIData
{
    internal static class CommonBuffs
    {
        ...
        internal static readonly List<Buff> Commons = new List<Buff>
        {
            ...
            new Buff("Protected Caravan", ProtectedCaravan, Source.Common, BuffClassification.Support, BuffImages.Perseverance),
            new Buff("Righteous Indignation", RighteousIndignation, Source.Common, BuffClassification.Support, BuffImages.Brilliance),
            new Buff("Gliding Disabled Warning", GlidingDisabledWarning, Source.Common, BuffClassification.Support, BuffImages.GlidingDisabledWarning),
            ...
            new Buff("Structural Vulnerability", StructuralVulnerability, Source.Common, BuffClassification.Support, BuffImages.StructuralVulnerability),
            new Buff("Sabotage Depot", SabotageDepot, Source.Common, BuffClassification.Support, BuffImages.SabotagedWeaponParts),
            new Buff("Iron Hide (Ram)", IronHideRam, Source.Common, BuffClassification.Support, BuffImages.IronHide),
            new Buff("Iron Hide (Guard)", IronHideGuards, Source.Common, BuffClassification.Support, BuffImages.IronHide),
            new Buff("Siege Decay Timer", SiegeDecayTimer, Source.Common, BuffClassification.Support, BuffImages.SiegeDecayTimer),
            new Buff("Presence of the Keep", PresenceOfTheKeep, Source.Common, BuffClassification.Support, BuffImages.PresenceOfTheKeep),
            new Buff("Oil Mastery III (Increased Armor)",IncreasedArmorOilMasteryIII, Source.Common, BuffClassification.Support, BuffImages.BurningOilMastery),
            new Buff("Chain Attached", ChainAttached, Source.Common, BuffClassification.Debuff, BuffImages.ChainPull),
            new Buff("Hardened Gates", HardenedGates, Source.Common, BuffClassification.Support, BuffImages.HardenedGates),
            ...
            new Buff("Hardened Siege Gear", HardenedSiegeGear, Source.Common, BuffClassification.Support, BuffImages.HardenedSiegeGear),
            ...
            new Buff("Marked (Sentry Turret 1)", MarkedSentryTurret1, Source.Common, BuffClassification.Debuff, BuffImages.FireTrebuchet),
            ...
            new Buff("Marked (Sentry Turret 3)", MarkedSentryTurret3, Source.Common, BuffClassification.Debuff, BuffImages.FireTrebuchet),
            ...
            new Buff("Structural Integrity", StructuralIntegrity, Source.Common, BuffClassification.Debuff, BuffImages.ThoughtlessPotion),
            new Buff("Gliding Disabled", GlidingDisabled, Source.Common, BuffClassification.Debuff, BuffImages.GlidingDisabled),
            new Buff("No Mount Use (Warclaw)", NoMountUseWarclaw, Source.Common, BuffClassification.Support, BuffImages.MountsDisabled),
            ...
            new Buff("Invulnerable Dolyak", InvulnerableDolyak, Source.Common, BuffClassification.Support, BuffImages.Brilliance),
            new Buff("Superspeed (Speedy Dolyak)", SuperspeedSpeedyDolyak, Source.Common, BuffClassification.Support, BuffImages.Superspeed),
