...
internal static class UtilityBuffs
{
    ...
    [     
        ...
        new Buff("Toxic Focusing Crystal", ToxicTuningCrystal, Source.Item, BuffClassification.Enhancement, BuffImages.ToxicTuningCrystal).WithBuilds(GW2Builds.StartOfLife, GW2Builds.November2024MountBalriorRelease),
        new Buff("Toxic Tuning Crystal", ToxicTuningCrystal, Source.Item, BuffClassification.Enhancement, BuffImages.ToxicTuningCrystal).WithBuilds(GW2Builds.November2024MountBalriorRelease),
