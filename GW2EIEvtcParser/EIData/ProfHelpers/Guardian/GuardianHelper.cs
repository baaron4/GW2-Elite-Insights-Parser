...
namespace GW2EIEvtcParser.EIData
{
    internal static class GuardianHelper
    {
        ...
        {        
                ...
                new Buff("Battle Presence (Absolute Resolve)", 17047, Source.Guardian, BuffStackType.Queue, 2, BuffNature.DefensiveBuffTable, "https://wiki.guildwars2.com/images/b/b2/Virtue_of_Resolve.png"),
