...
namespace GW2EIEvtcParser.EIData
{
    internal static class GuardianHelper
    {
        ...
        {        
                ...
                new Buff("Signet of Resolve (Shared)", 46554, Source.Guardian, BuffStackType.Stacking, 25, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/7/75/Signet_of_Resolve.png"),
                new Buff("Bane Signet",9092, Source.Guardian, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/5/56/Bane_Signet.png"),
                new Buff("Bane Signet (PI)",9240, Source.Guardian, BuffStackType.Stacking, 25, BuffNature.OffensiveBuff, "https://wiki.guildwars2.com/images/5/56/Bane_Signet.png"),
                ...
                new Buff("Signet of Judgment (PI)",9239, Source.Guardian, BuffStackType.Stacking, 25, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/f/fe/Signet_of_Judgment.png"),
                ...
                new Buff("Signet of Mercy (PI)",9238, Source.Guardian, BuffStackType.Stacking, 25, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/3/37/Signet_of_Mercy.png"),
                ...
                new Buff("Signet of Wrath (PI)",9237, Source.Guardian, BuffStackType.Stacking, 25, BuffNature.OffensiveBuff, "https://wiki.guildwars2.com/images/1/18/Signet_of_Wrath.png"),
                ...
                new Buff("Signet of Courage (Shared)",43487 , Source.Guardian, BuffStackType.Stacking, 25, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/5/5d/Signet_of_Courage.png"),
                //virtues
                ...
                //traits
                new Buff("Strength in Numbers",13796, Source.Guardian, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/7/7b/Strength_in_Numbers.png"),
                ...
                new Buff("Virtue of Resolve (Battle Presence)", 17046, Source.Guardian, BuffStackType.Queue, 2, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/2/27/Battle_Presence.png"),
                new Buff("Virtue of Resolve (Battle Presence - Absolute Resolve)", 17047, Source.Guardian, BuffStackType.Queue, 2, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/b/b2/Virtue_of_Resolve.png"),
                new Buff("Symbolic Avenger",56890, Source.Guardian, BuffStackType.Stacking, 5, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/e/e5/Symbolic_Avenger.png", GW2Builds.July2019Balance, GW2Builds.EndOfLife),
                ...
                new Buff("Inspiring Virtue",59592, Source.Guardian, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/8/8f/Virtuous_Solace.png", 102389, GW2Builds.EndOfLife),
