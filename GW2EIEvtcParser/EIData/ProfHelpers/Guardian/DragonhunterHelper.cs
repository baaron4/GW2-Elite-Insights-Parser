...
namespace GW2EIEvtcParser.EIData
{
    internal static class DragonhunterHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(30232, "Big Game Hunter", "10% to tethered target", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Dragonhunter, ByPresence, "https://wiki.guildwars2.com/images/7/76/Big_Game_Hunter.png", 0, GW2Builds.October2018Balance, DamageModifierMode.All, (x, log) => {
            ...
            new BuffDamageModifierTarget(30232, "Big Game Hunter", "20% to tethered target", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Dragonhunter, ByPresence, "https://wiki.guildwars2.com/images/7/76/Big_Game_Hunter.png", GW2Builds.October2018Balance, GW2Builds.February2020Balance, DamageModifierMode.All, (x, log) => {
                AgentItem src = x.From;
                AgentItem dst = x.To;
                AbstractBuffEvent effectApply = log.CombatData.GetBuffData(30232).Where(y => y is BuffApplyEvent bae && Math.Abs(bae.AppliedDuration - 8000) < ServerDelayConstant && bae.By == src && bae.To == dst).LastOrDefault(y => y.Time <= x.Time);
                if (effectApply != null)
        ...
        {
                new Buff("Justice (Dragonhunter)",30232, Source.Dragonhunter, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b0/Spear_of_Light.png"),
                new Buff("Shield of Courage (Active)", 29906, Source.Dragonhunter, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/63/Shield_of_Courage.png"),
                new Buff("Spear of Justice", 29632, Source.Dragonhunter, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/f/f1/Spear_of_Justice.png"),
                new Buff("Shield of Courage", 29523, Source.Dragonhunter, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/63/Shield_of_Courage.png"),
                new Buff("Wings of Resolve", 30308, Source.Dragonhunter, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/cb/Wings_of_Resolve.png"),
                new Buff("Hunter's Mark", 30778, Source.Dragonhunter, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e6/Hunter%27s_Ward.png"),
        };
