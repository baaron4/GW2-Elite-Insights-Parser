...
namespace GW2EIEvtcParser.EIData
{
    internal static class DragonhunterHelper
    {
        ...
        {
            new EffectCastFinder(TestOfFaith, EffectGUIDs.DragonhunterTestOfFaith).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == Spec.Dragonhunter),
            new EffectCastFinder(FragmentsOfFaith, EffectGUIDs.DragonhunterFragmentsOfFaith).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == Spec.Dragonhunter),
        };
