    ...
    internal static class FirebrandHelper
    {
        ...
        internal static void ComputeProfessionCombatReplayActors(AbstractPlayer player, ParsedEvtcLog log, CombatReplay replay)
        {
            ...
            foreach (EffectEvent effect in log.CombatData.GetEffectEventsBySrcWithGUID(player.AgentItem, EffectGUIDs.FirebrandValiantBulwark))
            {
                ...
                replay.Decorations.Add(new IconDecoration("https://wiki.guildwars2.com/images/7/73/Chapter_3-_Valiant_Bulwark.png", 128, 0.5f, lifespan, connector).UsingSkillMode(player, false));
            }
        }
    }
}
