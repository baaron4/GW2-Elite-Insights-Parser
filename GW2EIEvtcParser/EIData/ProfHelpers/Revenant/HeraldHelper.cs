...
namespace GW2EIEvtcParser.EIData
{
    internal static class HeraldHelper
    {
        ...
        {
            new BuffDamageModifier(NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png", DamageModifierMode.All).WithBuilds(GW2Builds.StartOfLife, GW2Builds.August2022Balance),
            new BuffDamageModifier(NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png", DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.August2022Balance),
            new BuffDamageModifier(NumberOfBoons, "Reinforced Potency", "1.5% per boon", DamageSource.NoPets, 1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.August2022Balance),
            //
            ...
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.July2019Balance, GW2Builds.November2022Balance),
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.November2022Balance),
            ...
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", DamageModifierMode.sPvPWvW).WithBuilds( GW2Builds.February2020Balance, GW2Builds.November2022Balance),
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", DamageModifierMode.sPvPWvW).WithBuilds( GW2Builds.November2022Balance),
            // 
