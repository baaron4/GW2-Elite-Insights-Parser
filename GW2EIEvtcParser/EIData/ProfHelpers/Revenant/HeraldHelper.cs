...
internal static class HeraldHelper
{
    ...
    [
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, TraitImages.EnvoyOfSustenance, DamageModifierMode.All).WithBuilds(GW2Builds.StartOfLife, GW2Builds.August2022Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, TraitImages.EnvoyOfSustenance, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.August2022Balance, GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.5% per boon", DamageSource.NoPets, 1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, TraitImages.EnvoyOfSustenance, DamageModifierMode.PvE).WithBuilds(GW2Builds.August2022Balance, GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.5% per boon", DamageSource.NoPets, 1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, TraitImages.EnvoyOfSustenance, DamageModifierMode.PvEsPvP).WithBuilds(GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.0% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, TraitImages.EnvoyOfSustenance, DamageModifierMode.WvW).WithBuilds(GW2Builds.June2024Balance),
        //
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.All).WithBuilds(GW2Builds.August2018Balance, GW2Builds.July2019Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.PvE).WithBuilds(GW2Builds.July2019Balance, GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.PvE).WithBuilds(GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.July2019Balance, GW2Builds.February2020Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.February2020Balance, GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, SkillImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.November2022Balance),
        // 
        new BuffOnActorDamageModifier(Mod_ForcefulPersistenceFacets, [FacetOfChaosBuff, FacetOfDarknessBuff, FacetOfElementsBuff, FacetOfNatureBuff, FacetOfStrengthBuff, FacetOfLightBuff], "Forceful Persistence (Facets)", "4% per active Facet", DamageSource.NoPets, 4.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, TraitImages.ForcefulPersistence, DamageModifierMode.PvE).WithBuilds(GW2Builds.August2018Balance, GW2Builds.June2022Balance),
        new BuffOnActorDamageModifier(Mod_ForcefulPersistenceFacets, [FacetOfChaosBuff, FacetOfDarknessBuff, FacetOfElementsBuff, FacetOfNatureBuff, FacetOfStrengthBuff, FacetOfLightBuff], "Forceful Persistence (Facets)", "3% per active Facet", DamageSource.NoPets, 3.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, TraitImages.ForcefulPersistence, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.August2018Balance, GW2Builds.October2024Balance),
        new BuffOnActorDamageModifier(Mod_ForcefulPersistenceFacets, [FacetOfChaosBuff, FacetOfDarknessBuff, FacetOfElementsBuff, FacetOfNatureBuff, FacetOfStrengthBuff, FacetOfLightBuff], "Forceful Persistence (Facets)", "4% per active Facet", DamageSource.NoPets, 4.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, TraitImages.ForcefulPersistence, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.October2024Balance),
        new BuffOnActorDamageModifier(Mod_ForcefulPersistenceFacets, [FacetOfChaosBuff, FacetOfDarknessBuff, FacetOfElementsBuff, FacetOfNatureBuff, FacetOfStrengthBuff, FacetOfLightBuff], "Forceful Persistence (Facets)", "5% per active Facet", DamageSource.NoPets, 5.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, TraitImages.ForcefulPersistence, DamageModifierMode.PvE).WithBuilds(GW2Builds.June2022Balance, GW2Builds.November2023Balance),
        new BuffOnActorDamageModifier(Mod_ForcefulPersistenceFacets, [FacetOfChaosBuff, FacetOfDarknessBuff, FacetOfElementsBuff, FacetOfNatureBuff, FacetOfStrengthBuff, FacetOfLightBuff], "Forceful Persistence (Facets)", "7% per active Facet", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, TraitImages.ForcefulPersistence, DamageModifierMode.PvE).WithBuilds(GW2Builds.November2023Balance),
