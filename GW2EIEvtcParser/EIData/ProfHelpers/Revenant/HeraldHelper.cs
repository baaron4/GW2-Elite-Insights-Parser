...
namespace GW2EIEvtcParser.EIData
{
    internal static class HeraldHelper
    {
        ...
        {         
            ...
            new Buff("Facet of Elements", FacetOfElementsEffect, Source.Herald, BuffClassification.Other, BuffImages.FacetOfElements),
            ...
            new Buff("Facet of Strength", FacetOfStrengthEffect, Source.Herald, BuffClassification.Other, BuffImages.FacetOfStrength),
            ...
            new Buff("Facet of Chaos", FacetOfChaosEffect, Source.Herald, BuffClassification.Other, BuffImages.FacetOfChaos),
            new Buff("Facet of Chaos (Traited)", FacetOfChaosTraited, Source.Herald, BuffClassification.Other, BuffImages.FacetOfChaos),
            new Buff("Facet of Nature", FacetOfNatureEffect, Source.Herald, BuffClassification.Other, BuffImages.FacetOfNature),
            ...
            new Buff("Legendary Dragon Stance", LegendaryDragonStanceEffect, Source.Herald, BuffClassification.Other, BuffImages.LegendaryDragonStance),
