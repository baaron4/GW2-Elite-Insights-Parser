...
internal static class HeraldHelper
{
    ...
    [
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.EnvoyOfSustenance, DamageModifierMode.All).WithBuilds(GW2Builds.StartOfLife, GW2Builds.August2022Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.EnvoyOfSustenance, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.August2022Balance, GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.5% per boon", DamageSource.NoPets, 1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.EnvoyOfSustenance, DamageModifierMode.PvE).WithBuilds(GW2Builds.August2022Balance, GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.5% per boon", DamageSource.NoPets, 1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.EnvoyOfSustenance, DamageModifierMode.PvEsPvP).WithBuilds(GW2Builds.June2024Balance),
        new BuffOnActorDamageModifier(Mod_ReinforcedPotency, NumberOfBoons, "Reinforced Potency", "1.0% per boon", DamageSource.NoPets, 1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.EnvoyOfSustenance, DamageModifierMode.WvW).WithBuilds(GW2Builds.June2024Balance),
        //
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.All).WithBuilds(GW2Builds.August2018Balance, GW2Builds.July2019Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.PvE).WithBuilds(GW2Builds.July2019Balance, GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.PvE).WithBuilds(GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.July2019Balance, GW2Builds.February2020Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.February2020Balance, GW2Builds.November2022Balance),
        new BuffOnActorDamageModifier(Mod_BurstOfStrength, BurstOfStrength, "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.StrikeAndCondition, DamageType.All, Source.Herald, ByPresence, BuffImages.BurstOfStrength, DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.November2022Balance),
        // 
    ...
    [
        new BuffOnActorDamageModifier(Mod_FacetOfNatureDwarf, FacetOfNatureDwarf, "Facet of Nature - Dwarf", "-10%", DamageSource.NoPets, -10.0, DamageType.Strike, DamageType.All, Source.Common, ByPresence, BuffImages.FacetOfNatureDwarf, DamageModifierMode.All).WithBuilds(GW2Builds.August2018Balance),
        new BuffOnActorDamageModifier(Mod_HardeningPersistence, HardeningPersistence, "Hardening Persistence", "-1% per stack", DamageSource.NoPets, -1.0, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.HardeningPersistence, DamageModifierMode.All).WithBuilds(GW2Builds.August2018Balance, GW2Builds.July2019Balance),
        new BuffOnActorDamageModifier(Mod_HardeningPersistence, HardeningPersistence, "Hardening Persistence", "-1.5% per stack", DamageSource.NoPets, -1.5, DamageType.Strike, DamageType.All, Source.Herald, ByStack, BuffImages.HardeningPersistence, DamageModifierMode.All).WithBuilds(GW2Builds.July2019Balance),
    ];
