...
namespace GW2EIEvtcParser.EIData
{
    internal static class HeraldHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(51653 , "Burst of Strength", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.July2019Balance, ulong.MaxValue, DamageModifierMode.PvE),
            ...
            new BuffDamageModifier(51653 , "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            // 
            new BuffDamageModifier(new long[] { 27336, 29275, 28036, 28243, 27376, 27983}, "Forceful Persistence (Facets)", "4% per active Facet", DamageSource.NoPets, 4.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, "https://wiki.guildwars2.com/images/5/5f/Forceful_Persistence.png", GW2Builds.August2018Balance, ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifier(new long[] { 27336, 29275, 28036, 28243, 27376, 27983}, "Forceful Persistence (Facets)", "3% per active Facet", DamageSource.NoPets, 3.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, "https://wiki.guildwars2.com/images/5/5f/Forceful_Persistence.png", GW2Builds.August2018Balance, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            //new BuffDamageModifier(new long[] { 27273, 27581, 28001}, "Forceful Persistence", "13% if active upkeep", DamageSource.NoPets, 13.0, DamageType.Power, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/5/5f/Forceful_Persistence.png", GW2Builds.August2018Balance, ulong.MaxValue, DamageModifierMode.All), // Hammers, Embrace, Impossible Odds but how to track Protective Solace?
        };
