...
namespace GW2EIEvtcParser.EIData
{
    internal static class HeraldHelper
    {
        ...
        {
            new BuffGainCastFinder(28085, LegendaryDragonStance, EIData.InstantCastFinder.DefaultICD), // Legendary Dragon Stance
            new BuffGainCastFinder(29371, FacetOfNature, EIData.InstantCastFinder.DefaultICD), // Facet of Nature
            new BuffGainCastFinder(28379, FacetOfDarkness, EIData.InstantCastFinder.DefaultICD), // Facet of Darkness
            new BuffGainCastFinder(27014, FacetOfElements, EIData.InstantCastFinder.DefaultICD), // Facet of Elements
            new BuffGainCastFinder(26644, FacetOfStrength, EIData.InstantCastFinder.DefaultICD), // Facet of Strength
            new BuffGainCastFinder(27760, FacetOfChaos, EIData.InstantCastFinder.DefaultICD), // Facet of Chaos
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.August2018Balance, GW2Builds.July2019Balance, DamageModifierMode.All),
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.July2019Balance, GW2Builds.EndOfLife, DamageModifierMode.PvE),
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.July2019Balance, GW2Builds.February2020Balance, DamageModifierMode.sPvPWvW),
            new BuffDamageModifier(BurstOfStrength , "Burst of Strength", "7%", DamageSource.NoPets, 7.0, DamageType.Strike, DamageType.All, Source.Herald, ByPresence, "https://wiki.guildwars2.com/images/7/7b/Burst_of_Strength.png", GW2Builds.February2020Balance, GW2Builds.EndOfLife, DamageModifierMode.sPvPWvW),
            // 
            new BuffDamageModifier(new long[] { FacetOfChaos, FacetOfDarkness, FacetOfElements, FacetOfNature, FacetOfStrength, FacetOfLight}, "Forceful Persistence (Facets)", "4% per active Facet", DamageSource.NoPets, 4.0, DamageType.Strike, DamageType.All, Source.Herald, ByMultiPresence, "https://wiki.guildwars2.com/images/5/5f/Forceful_Persistence.png", GW2Builds.August2018Balance, GW2Builds.EndOfLife, DamageModifierMode.PvE),
        ...
        {         
                ...
                new Buff("Facet of Darkness",FacetOfDarkness, Source.Herald, BuffClassification.Other,"https://wiki.guildwars2.com/images/e/e4/Facet_of_Darkness.png"),
                ...
                new Buff("Facet of Elements",FacetOfElements, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/c/ce/Facet_of_Elements.png"),
                ...
                new Buff("Facet of Strength",FacetOfStrength, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/a/a8/Facet_of_Strength.png"),
                new Buff("Facet of Strength (Traited)",FacetOfStrength, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/a/a8/Facet_of_Strength.png"),//Lingering buff with Draconic Echo trait
                new Buff("Facet of Chaos",FacetOfChaos, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/c/c7/Facet_of_Chaos.png"),
                ...
                new Buff("Facet of Nature",FacetOfNature, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/e/e9/Facet_of_Nature.png"),
                ...
                new Buff("Legendary Dragon Stance",LegendaryDragonStance, Source.Herald, BuffClassification.Other, "https://wiki.guildwars2.com/images/d/d5/Legendary_Dragon_Stance.png"),
