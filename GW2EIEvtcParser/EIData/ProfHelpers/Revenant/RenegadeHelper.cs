...
namespace GW2EIEvtcParser.EIData
{
    internal static class RenegadeHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(42883, "Kalla's Fervor", "2% per stack", DamageSource.NoPets, 2.0, DamageType.StrikeAndConditionAndLifeLeech, DamageType.All, Source.Renegade, ByStack, "https://wiki.guildwars2.com/images/9/9e/Kalla%27s_Fervor.png", 115190, ulong.MaxValue, DamageModifierMode.All),
            new BuffDamageModifier(45614, "Improved Kalla's Fervor", "3% per stack", DamageSource.NoPets, 3.0, DamageType.StrikeAndConditionAndLifeLeech, DamageType.All, Source.Renegade, ByStack, "https://wiki.guildwars2.com/images/9/9e/Kalla%27s_Fervor.png", 115190, ulong.MaxValue, DamageModifierMode.All),
        };
