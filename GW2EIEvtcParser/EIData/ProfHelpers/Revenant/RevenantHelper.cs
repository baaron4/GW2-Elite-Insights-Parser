...
namespace GW2EIEvtcParser.EIData
{
    internal static class RevenantHelper
    {
        ...
        {
                new Buff("Vengeful Hammers", 27273, Source.Revenant, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/c/c8/Vengeful_Hammers.png"),
                new Buff("Rite of the Great Dwarf", 26596, Source.Revenant, BuffNature.Defensive, "https://wiki.guildwars2.com/images/6/69/Rite_of_the_Great_Dwarf.png"),
                new Buff("Rite of the Great Dwarf (Traited)", 33330, Source.Revenant, BuffNature.Defensive, "https://wiki.guildwars2.com/images/6/69/Rite_of_the_Great_Dwarf.png"),
                new Buff("Embrace the Darkness", 28001, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/51/Embrace_the_Darkness.png"),
                new Buff("Enchanted Daggers", 28557, Source.Revenant, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/f/fa/Enchanted_Daggers.png"),
                new Buff("Phase Traversal", 28395, Source.Revenant, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/f/f2/Phase_Traversal.png"),
                new Buff("Impossible Odds", 27581, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/87/Impossible_Odds.png"),
                new Buff("Legendary Centaur Stance",27972, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/8a/Legendary_Centaur_Stance.png"),
                new Buff("Legendary Dwarf Stance",27205, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b2/Legendary_Dwarf_Stance.png"),
                new Buff("Legendary Demon Stance",27928, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/d1/Legendary_Demon_Stance.png"),
                new Buff("Legendary Assassin Stance",27890, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/0/02/Legendary_Assassin_Stance.png"),
                //traits
                new Buff("Vicious Lacerations",29395, Source.Revenant, BuffStackType.Stacking, 3, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/cd/Vicious_Lacerations.png", 0, GW2Builds.February2020Balance),
                new Buff("Assassin's Presence", 26854, Source.Revenant, BuffNature.Offensive, "https://wiki.guildwars2.com/images/5/54/Assassin%27s_Presence.png"),
                new Buff("Expose Defenses", 48894, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/5c/Mutilate_Defenses.png"),
                new Buff("Invoking Harmony",29025, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/ec/Invoking_Harmony.png"),
                new Buff("Unyielding Devotion",55044, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/4f/Unyielding_Devotion.png", GW2Builds.April2019Balance, GW2Builds.EndOfLife),
                new Buff("Selfless Amplification",30509, Source.Revenant, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/23/Selfless_Amplification.png"),
                new Buff("Battle Scars", 26646, Source.Revenant, BuffStackType.StackingConditionalLoss, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/30/Thrill_of_Combat.png", GW2Builds.February2020Balance, GW2Builds.EndOfLife),
                new Buff("Steadfast Rejuvenation",53500, Source.Revenant, BuffStackType.Stacking, 10, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/bf/Steadfast_Rejuvenation.png"),
        };
