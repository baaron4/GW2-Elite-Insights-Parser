...
namespace GW2EIEvtcParser.EIData
{
    internal static class VindicatorHelper
    {
        ...
        {
            new Buff("Legendary Alliance Stance",62919, Source.Revenant, BuffClassification.Other, "https://wiki.guildwars2.com/images/d/d6/Legendary_Alliance_Stance.png"),
            new Buff("Urn of Saint Viktor", 62864, Source.Vindicator, BuffClassification.Other,"https://wiki.guildwars2.com/images/f/ff/Urn_of_Saint_Viktor.png"),
            new Buff("Saint of zu Heltzer", 62994, Source.Vindicator, BuffClassification.Other,"https://wiki.guildwars2.com/images/3/36/Saint_of_zu_Heltzer.png"),
            new Buff("Forerunner of Death", 62811, Source.Vindicator, BuffClassification.Other,"https://wiki.guildwars2.com/images/9/95/Forerunner_of_Death.png"),
            new Buff("Imperial Guard", 62819, Source.Vindicator, BuffStackType.Stacking, 5, BuffClassification.Other, "https://wiki.guildwars2.com/images/7/7f/Imperial_Guard.png"),
        };
    }
}
