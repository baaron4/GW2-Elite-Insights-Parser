...
namespace GW2EIEvtcParser.EIData
{
    internal static class BladeswornHelper
    {
        ...
        {
            //new BuffDamageModifier(62811, "Fierce as Fire", "?%", DamageSource.NoPets, 0.0, DamageType.Strike, DamageType.All, Source.Bladesworn, ByStack, "https://wiki.guildwars2.com/images/8/8e/Fierce_as_Fire.png", 119939, GW2Builds.EndOfLife, DamageModifierMode.All),
        };
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            //new Buff("Fierce as Fire", 62836, Source.Bladesworn, BuffStackType.Stacking, 25, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/8/8e/Fierce_as_Fire.png", 119939, GW2Builds.EndOfLife),
