...
namespace GW2EIEvtcParser.EIData
{
    internal static class SpellbreakerHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                new Buff("Magebane Tether",42428, Source.Spellbreaker, BuffStackType.Stacking, 25, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/e/e5/Magebane_Tether.png"),
        };
