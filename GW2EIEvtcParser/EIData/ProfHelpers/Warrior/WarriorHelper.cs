...
internal static class WarriorHelper
{
    ...
    [
        ...
        new DamageLogDamageModifier(Mod_WarriorsCunningBarrier, "Warrior's Cunning (Barrier)", "50% against barrier", DamageSource.NoPets, 50.0, DamageType.Strike, DamageType.All, Source.Warrior, TraitImages.WarriorsCunning, (x, log) => x.ShieldDamage > 0 , DamageModifierMode.PvEWvW).WithBuilds(GW2Builds.December2019Balance, GW2Builds.June2023Balance),
        new DamageLogDamageModifier(Mod_WarriorsCunningBarrier, "Warrior's Cunning (Barrier)", "50% against barrier", DamageSource.NoPets, 50.0, DamageType.Strike, DamageType.All, Source.Warrior, TraitImages.WarriorsCunning, (x, log) => x.ShieldDamage > 0 , DamageModifierMode.PvE).WithBuilds(GW2Builds.June2023Balance),
        new DamageLogDamageModifier(Mod_WarriorsCunningBarrier, "Warrior's Cunning (Barrier)", "10% against barrier", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, TraitImages.WarriorsCunning, (x, log) => x.ShieldDamage > 0 , DamageModifierMode.sPvP).WithBuilds(GW2Builds.December2019Balance, GW2Builds.June2023Balance),
        new DamageLogDamageModifier(Mod_WarriorsCunningBarrier, "Warrior's Cunning (Barrier)", "10% against barrier", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, TraitImages.WarriorsCunning, (x, log) => x.ShieldDamage > 0 , DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.June2023Balance),
    ...
    [
        ...
        new Buff("Flames of War", FlamesOfWar, Source.Warrior, BuffClassification.Other, SkillImages.FlamesOfWarWarrior).WithBuilds(GW2Builds.SOTOBetaAndSilentSurfNM),
        // Signets
