...
namespace GW2EIEvtcParser.EIData
{
    internal static class WarriorHelper
    {
        ...
        {
            // Strength
            new BuffDamageModifier(PeakPerformance, "Peak Performance (absent)", "5%", DamageSource.NoPets, 5.0, DamageType.Strike, DamageType.All, Source.Warrior, ByAbsence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.July2018Balance),
            new BuffDamageModifier(PeakPerformance, "Peak Performance (present)", "20%", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Warrior, ByPresence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.July2018Balance, GW2Builds.May2021Balance),
            new BuffDamageModifier(PeakPerformance, "Peak Performance (present)", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Warrior, ByPresence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", DamageModifierMode.PvE).WithBuilds(GW2Builds.May2021Balance),
            new BuffDamageModifier(PeakPerformance, "Peak Performance (absent)", "3%", DamageSource.NoPets, 3.0, DamageType.Strike, DamageType.All, Source.Warrior, ByAbsence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.July2018Balance),
            new BuffDamageModifier(PeakPerformance, "Peak Performance (present)", "10%", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, ByPresence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", DamageModifierMode.sPvPWvW).WithBuilds(GW2Builds.July2018Balance),
