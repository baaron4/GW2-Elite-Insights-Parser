...
namespace GW2EIEvtcParser.EIData
{
    internal static class WarriorHelper
    {
        ...
        {
            //skills
                new Buff("Riposte",14434, Source.Warrior, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/d/de/Riposte.png"),
                //signets
                new Buff("Healing Signet",786, Source.Warrior, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/8/85/Healing_Signet.png"),
                new Buff("Dolyak Signet",14458, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/60/Dolyak_Signet.png"),
                new Buff("Signet of Fury",14459, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c1/Signet_of_Fury.png"),
                new Buff("Signet of Might",14444, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/40/Signet_of_Might.png"),
                new Buff("Signet of Stamina",14478, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/6b/Signet_of_Stamina.png"),
                new Buff("Signet of Rage",14496, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/bc/Signet_of_Rage.png"),
                //banners
                new Buff("Banner of Strength", 14417, Source.Warrior, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/e/e1/Banner_of_Strength.png/33px-Banner_of_Strength.png"),
                new Buff("Banner of Discipline", 14449, Source.Warrior, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/5/5f/Banner_of_Discipline.png/33px-Banner_of_Discipline.png"),
                new Buff("Banner of Tactics",14450, Source.Warrior, BuffNature.Support, "https://wiki.guildwars2.com/images/thumb/3/3f/Banner_of_Tactics.png/33px-Banner_of_Tactics.png"),
                new Buff("Banner of Defense",14543, Source.Warrior, BuffNature.Defensive, "https://wiki.guildwars2.com/images/thumb/f/f1/Banner_of_Defense.png/33px-Banner_of_Defense.png"),
                //stances
                new Buff("Shield Stance",756, Source.Warrior, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/d/de/Shield_Stance.png"),
                new Buff("Berserker's Stance",14453, Source.Warrior, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/8/8a/Berserker_Stance.png"),
                new Buff("Enduring Pain",787, Source.Warrior, BuffStackType.Queue, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/24/Endure_Pain.png"),
                new Buff("Balanced Stance",34778, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/27/Balanced_Stance.png"),
                new Buff("Defiant Stance",21816, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/db/Defiant_Stance.png"),
                new Buff("Rampage",14484, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e4/Rampage.png"),
                //traits
                new Buff("Soldier's Focus", 58102, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/29/Soldier%27s_Focus.png", GW2Builds.October2019Balance, GW2Builds.EndOfLife),
                new Buff("Brave Stride", 43063, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b8/Death_from_Above.png"),
                new Buff("Empower Allies", 14222, Source.Warrior, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/4/4c/Empower_Allies.png/20px-Empower_Allies.png"),
                new Buff("Peak Performance",46853, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png"),
                new Buff("Furious Surge", 30204, Source.Warrior, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/65/Furious.png"),
                ...
                new Buff("Rousing Resilience",24383, Source.Warrior, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/ca/Rousing_Resilience.png"),
                new Buff("Berserker's Power",42539, Source.Warrior, BuffStackType.Stacking, 3, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/6f/Berserker%27s_Power.png"),
                new Buff("Signet of Ferocity",41922, Source.Warrior, BuffStackType.Stacking, 5, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/ef/Signet_Mastery.png"),
                new Buff("Adrenal Health",34766, Source.Warrior, BuffStackType.Stacking, 3, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/24/Adrenal_Health.png"),
        };
