...
namespace GW2EIEvtcParser.EIData
{
    internal static class WarriorHelper
    {
        ...
        {
            // Strength
            new BuffDamageModifier(46853, "Peak Performance (absent)", "5%", DamageSource.NoPets, 5.0, DamageType.Strike, DamageType.All, Source.Warrior, ByAbsence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", 90455, GW2Builds.EndOfLife, DamageModifierMode.PvE),
            ...
            new BuffDamageModifier(46853, "Peak Performance (absent)", "3%", DamageSource.NoPets, 3.0, DamageType.Strike, DamageType.All, Source.Warrior, ByAbsence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", 90455, GW2Builds.EndOfLife, DamageModifierMode.sPvPWvW),
            new BuffDamageModifier(46853, "Peak Performance (present)", "10%", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, ByPresence, "https://wiki.guildwars2.com/images/9/98/Peak_Performance.png", 90455, GW2Builds.EndOfLife, DamageModifierMode.sPvPWvW),
