...
namespace GW2EIEvtcParser.EIData
{
    internal static class WarriorHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new DamageLogApproximateDamageModifier("Warrior's Cunning (High HP)", "25% if foe >90%", DamageSource.NoPets, 25.0, DamageType.Power, DamageType.All, Source.Warrior,"https://wiki.guildwars2.com/images/9/96/Warrior%27s_Cunning.png", (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) == 0.0 && x.To.GetCurrentHealthPercent(log, x.Time) >= 90.0 , ByPresence, 100690, ulong.MaxValue, DamageModifierMode.PvE),
            new DamageLogApproximateDamageModifier("Warrior's Cunning (High HP)", "25% if foe >80%", DamageSource.NoPets, 25.0, DamageType.Power, DamageType.All, Source.Warrior,"https://wiki.guildwars2.com/images/9/96/Warrior%27s_Cunning.png", (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) == 0.0 && x.To.GetCurrentHealthPercent(log, x.Time) >= 80.0 , ByPresence, ulong.MaxValue, ulong.MaxValue, DamageModifierMode.PvE),
            ...
            new DamageLogApproximateDamageModifier("Warrior's Cunning (High HP)", "7% if foe >90%", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, Source.Warrior,"https://wiki.guildwars2.com/images/9/96/Warrior%27s_Cunning.png", (x, log) =>x.To.GetCurrentBarrierPercent(log, x.Time) == 0.0 && x.To.GetCurrentHealthPercent(log, x.Time) >= 90.0 , ByPresence, 100690, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            new DamageLogApproximateDamageModifier("Warrior's Cunning (High HP)", "7% if foe >80%", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, Source.Warrior,"https://wiki.guildwars2.com/images/9/96/Warrior%27s_Cunning.png", (x, log) =>x.To.GetCurrentBarrierPercent(log, x.Time) == 0.0 && x.To.GetCurrentHealthPercent(log, x.Time) >= 80.0 , ByPresence, ulong.MaxValue, ulong.MaxValue, DamageModifierMode.sPvPWvW),
