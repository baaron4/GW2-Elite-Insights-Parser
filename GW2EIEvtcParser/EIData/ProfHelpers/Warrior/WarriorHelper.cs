...
namespace GW2EIEvtcParser.EIData
{
    internal static class WarriorHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new DamageLogDamageModifier("Warrior's Cunning (Barrier)", "50% against barrier", DamageSource.NoPets, 50.0, DamageType.Strike, DamageType.All, Source.Warrior, BuffImages.WarriorsCunning, (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) > 0.0 , DamageModifierMode.PvEWvW).UsingApproximate(true).WithBuilds(GW2Builds.December2019Balance, GW2Builds.June2023Balance),
            new DamageLogDamageModifier("Warrior's Cunning (Barrier)", "50% against barrier", DamageSource.NoPets, 50.0, DamageType.Strike, DamageType.All, Source.Warrior, BuffImages.WarriorsCunning, (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) > 0.0 , DamageModifierMode.PvE).UsingApproximate(true).WithBuilds(GW2Builds.June2023Balance),
            new DamageLogDamageModifier("Warrior's Cunning (Barrier)", "10% against barrier", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, BuffImages.WarriorsCunning, (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) > 0.0 , DamageModifierMode.sPvP).UsingApproximate(true).WithBuilds(GW2Builds.December2019Balance, GW2Builds.June2023Balance),
            new DamageLogDamageModifier("Warrior's Cunning (Barrier)", "10% against barrier", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Warrior, BuffImages.WarriorsCunning, (x, log) => x.To.GetCurrentBarrierPercent(log, x.Time) > 0.0 , DamageModifierMode.sPvPWvW).UsingApproximate(true).WithBuilds(GW2Builds.June2023Balance),
