...
namespace GW2EIEvtcParser.EIData
{
    internal static class BerserkerHelper
    {
        ...
        {
            new DamageCastFinder(31289, 31289, 500, GW2Builds.July2019Balance, ulong.MaxValue), // King of Fires
        };
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(29502, "Bloody Roar", "20% while in berserk", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresence, "https://wiki.guildwars2.com/images/e/e1/Bloody_Roar.png", GW2Builds.July2019Balance , ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifier(29502, "Bloody Roar", "15% while in berserk", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresence, "https://wiki.guildwars2.com/images/e/e1/Bloody_Roar.png", GW2Builds.July2019Balance , ulong.MaxValue, DamageModifierMode.sPvPWvW),
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                new Buff("Feel No Pain (Savage Instinct)",55030, Source.Berserker, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/4/4d/Savage_Instinct.png", GW2Builds.April2019Balance, ulong.MaxValue),
                new Buff("Always Angry",34099, Source.Berserker, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/6/63/Always_Angry.png", 0 , GW2Builds.April2019Balance),
        };
