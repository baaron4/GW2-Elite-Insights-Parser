...
namespace GW2EIEvtcParser.EIData
{
    internal static class BerserkerHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(29502, "Bloody Roar", "10% while in berserk", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresenceNonMultiplier, "https://wiki.guildwars2.com/images/e/e1/Bloody_Roar.png", 0 , 96406, DamageModifierMode.PvE),
            new BuffDamageModifier(29502, "Bloody Roar", "20% while in berserk", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresenceNonMultiplier, "https://wiki.guildwars2.com/images/e/e1/Bloody_Roar.png", 96406 , 97950, DamageModifierMode.PvE),
