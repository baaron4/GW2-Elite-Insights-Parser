...
internal static class BerserkerHelper
{
    ...
    [
        ...
        new BuffOnActorDamageModifier(Mod_BloodyRoar, BerserkBuff, "Bloody Roar", "25% while in berserk", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresence, TraitImages.BloodyRoar, DamageModifierMode.PvE).WithBuilds(GW2Builds.August2022Balance, GW2Builds.June2023BalanceAndSOTOBetaAndSilentSurfNM),
        new BuffOnActorDamageModifier(Mod_BloodyRoar, BerserkBuff, "Bloody Roar", "20% while in berserk", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Berserker, ByPresence, TraitImages.BloodyRoar, DamageModifierMode.PvE).WithBuilds(GW2Builds.June2023BalanceAndSOTOBetaAndSilentSurfNM, GW2Builds.January2024Balance),
    ...
    [
        ...
        new Buff("Flames of War", FlamesOfWar, Source.Berserker, BuffClassification.Other, SkillImages.FlamesOfWarWarrior).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2023BalanceAndSOTOBetaAndSilentSurfNM),
