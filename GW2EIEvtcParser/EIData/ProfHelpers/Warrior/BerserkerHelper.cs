...
namespace GW2EIEvtcParser.EIData
{
    internal static class BerserkerHelper
    {
        ...
        {
                new Buff("Berserk",29502, Source.Berserker, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/4/44/Berserk.png"),
                new Buff("Flames of War", 31708, Source.Berserker, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/6f/Flames_of_War_%28warrior_skill%29.png"),
                new Buff("Blood Reckoning", 29466 , Source.Berserker, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/d6/Blood_Reckoning.png"),
                new Buff("Rock Guard", 34256 , Source.Berserker, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c7/Shattering_Blow.png"),
                new Buff("Feel No Pain (Savage Instinct)",55030, Source.Berserker, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/4d/Savage_Instinct.png", GW2Builds.April2019Balance, GW2Builds.EndOfLife),
                new Buff("Always Angry",34099, Source.Berserker, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/63/Always_Angry.png", 0 , GW2Builds.April2019Balance),
        };
