...
namespace GW2EIEvtcParser.EIData
{
    internal static class MesmerHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                //signets
                new Buff("Signet of the Ether", 21751, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/7a/Signet_of_the_Ether.png"),
                new Buff("Signet of Domination",10231, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/3b/Signet_of_Domination.png"),
                new Buff("Signet of Illusions",10246, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/ce/Signet_of_Illusions.png"),
                new Buff("Signet of Inspiration",10235, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/ed/Signet_of_Inspiration.png"),
                new Buff("Signet of Midnight",10233, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/24/Signet_of_Midnight.png"),
                new Buff("Signet of Humility",30739, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b5/Signet_of_Humility.png"),
                //skills
                new Buff("Distortion",10243, Source.Mesmer, BuffStackType.Queue, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/22/Distortion.png"),
                new Buff("Blur", 10335 , Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/22/Distortion.png"),
                new Buff("Mirror",10357, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b8/Mirror.png"),
                new Buff("Echo",29664, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/ce/Echo.png"),
                new Buff("Illusionary Counter",10278, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e5/Illusionary_Counter.png"),
                new Buff("Illusionary Riposte",10279, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/91/Illusionary_Riposte.png"),
                new Buff("Illusionary Leap",10353, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/1/18/Illusionary_Leap.png"),
                new Buff("Portal Weaving",10198, Source.Mesmer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/81/Portal_Entre.png"),
                new Buff("Illusion of Life",10346, Source.Mesmer, BuffNature.Support, "https://wiki.guildwars2.com/images/9/92/Illusion_of_Life.png"),
                //traits
                new Buff("Fencer's Finesse", 30426 , Source.Mesmer, BuffStackType.Stacking, 10, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e7/Fencer%27s_Finesse.png"),
                new Buff("Illusionary Defense",49099, Source.Mesmer, BuffStackType.Stacking, 5, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e0/Illusionary_Defense.png"),
                new Buff("Compounding Power",49058, Source.Mesmer, BuffStackType.Stacking, 5, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e5/Compounding_Power.png"),
                new Buff("Phantasmal Force", 44691 , Source.Mesmer, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/5f/Mistrust.png"),
                new Buff("Reflection", 10225 , Source.Mesmer, BuffStackType.Queue, 9, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9d/Arcane_Shield.png"),
                new Buff("Reflection 2", 24014 , Source.Mesmer, BuffStackType.Queue, 9, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9d/Arcane_Shield.png"),
        };
