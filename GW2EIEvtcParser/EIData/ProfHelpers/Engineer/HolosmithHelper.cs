...
namespace GW2EIEvtcParser.EIData
{
    internal static class HolosmithHelper
    {
        ...
        {
            new BuffDamageModifier(LasersEdge, "Laser's Edge", "15%", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Holosmith, ByPresence, "https://wiki.guildwars2.com/images/5/5d/Laser%27s_Edge.png", 0, GW2Builds.July2019Balance, DamageModifierMode.PvE).WithApproximate(true),
        };
