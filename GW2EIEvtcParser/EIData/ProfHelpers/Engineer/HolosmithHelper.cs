...
namespace GW2EIEvtcParser.EIData
{
    internal static class HolosmithHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                new Buff("Laser's Edge",44414, Source.Holosmith, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/5/5d/Laser%27s_Edge.png",0 , GW2Builds.July2019Balance),
