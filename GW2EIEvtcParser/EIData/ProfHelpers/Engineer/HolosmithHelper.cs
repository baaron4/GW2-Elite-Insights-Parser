...
internal static class HolosmithHelper
{
    ...
    [
        ...
        new EffectCastFinderByDst(BladeBurstOrParticleAccelerator, EffectGUIDs.HolosmitBladeBurstParticleAccelerator1)
            .UsingDstSpecChecker(Spec.Holosmith)
            .UsingSecondaryEffectSameSrcChecker(EffectGUIDs.HolosmitBladeBurstParticleAccelerator2)
    ...
    [
        ...
        // Solar Focusing Lens
        new BuffConsumedOnActorDamageModifier(Mod_SolarFocusingLens, Afterburner, "Solar Focusing Lens", "10%", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Holosmith, TraitImages.SolarFocusingLens, DamageModifierMode.All),
    ];
