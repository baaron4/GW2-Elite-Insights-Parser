...
namespace GW2EIEvtcParser.EIData
{
    internal static class EngineerHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            new Buff("Pinpoint Distribution", PinpointDistribution, Source.Engineer, BuffClassification.Offensive, BuffImages.PinpointDistribution, GW2Builds.StartOfLife, GW2Builds.June2022Balance),
            new Buff("Thermal Vision", ThermalVision, Source.Engineer, BuffClassification.Other, BuffImages.SkilledMarksman),
            new Buff("Explosive Entrance", ExplosiveEntranceEffect, Source.Engineer, BuffClassification.Other, BuffImages.ExplosiveEntrance, GW2Builds.February2020Balance, GW2Builds.EndOfLife),
            new Buff("Explosive Temper", ExplosiveTemper, Source.Engineer, BuffStackType.Stacking, 10, BuffClassification.Other, BuffImages.ExplosiveTemper, GW2Builds.February2020Balance, GW2Builds.EndOfLife),
