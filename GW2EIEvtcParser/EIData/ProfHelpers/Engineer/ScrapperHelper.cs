...
namespace GW2EIEvtcParser.EIData
{
    internal static class ScrapperHelper
    {
        ...
        {
            new EffectCastFinder(BulwarkGyro, EffectGUIDs.ScrapperBulwarkGyro).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == Spec.Scrapper),
            new EffectCastFinder(PurgeGyro, EffectGUIDs.ScrapperPurgeGyro).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == Spec.Scrapper),
            new EffectCastFinder(DefenseField, EffectGUIDs.ScrapperDefenseField).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == Spec.Scrapper),
        };
