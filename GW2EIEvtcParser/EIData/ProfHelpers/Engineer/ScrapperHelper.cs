    ...
    internal static class ScrapperHelper
    {
        ...
        internal static void ComputeProfessionCombatReplayActors(AbstractPlayer player, ParsedEvtcLog log, CombatReplay replay)
        {
            ...
            foreach (EffectEvent effect in log.CombatData.GetEffectEventsBySrcWithGUID(player.AgentItem, EffectGUIDs.ScrapperDefenseField))
            {
                ...
                replay.Decorations.Add(new IconDecoration("https://wiki.guildwars2.com/images/c/c1/Defense_Field.png", 128, 0.5f, lifespan, connector).UsingSkillMode(player, false));
            }
        }
    }
}
