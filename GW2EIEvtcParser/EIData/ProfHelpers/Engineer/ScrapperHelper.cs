...
namespace GW2EIEvtcParser.EIData
{
    internal static class ScrapperHelper
    {
        ...
        {
                new Buff("Watchful Eye",31229, Source.Scrapper, BuffClassification.Defensive, "https://wiki.guildwars2.com/images/2/29/Bulwark_Gyro.png"),
                new Buff("Watchful Eye PvP",46910, Source.Scrapper, BuffClassification.Defensive, "https://wiki.guildwars2.com/images/2/29/Bulwark_Gyro.png"),
