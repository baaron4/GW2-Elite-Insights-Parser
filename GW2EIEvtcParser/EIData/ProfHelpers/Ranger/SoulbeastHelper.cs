...
namespace GW2EIEvtcParser.EIData
{
    internal static class SoulbeastHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(45600, "Twice as Vicious", "10% (10s) after disabling foe", DamageSource.NoPets, 10.0, DamageType.StrikeAndCondition, DamageType.All, Source.Soulbeast, ByPresence, "https://wiki.guildwars2.com/images/0/00/Twice_as_Vicious.png", GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifier(45600, "Twice as Vicious", "5% (10s) after disabling foe", DamageSource.NoPets, 5.0, DamageType.StrikeAndCondition, DamageType.All, Source.Soulbeast, ByPresence, "https://wiki.guildwars2.com/images/0/00/Twice_as_Vicious.png", GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            ...
            new BuffDamageModifier(725, "Furious Strength", "15% under fury", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Soulbeast, ByStack, "https://wiki.guildwars2.com/images/c/ca/Furious_Strength.png", GW2Builds.May2021BalanceHotFix, ulong.MaxValue, DamageModifierMode.All),
            new BuffDamageModifier(new long[] { 40272, 44932, 44693, 41720, 40069}, "Loud Whistle", "10% while merged and hp > 90%", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Soulbeast, ByPresence, "https://wiki.guildwars2.com/images/b/b6/Loud_Whistle.png", GW2Builds.May2018Balance, ulong.MaxValue, DamageModifierMode.All, (x,log) => x.IsOverNinety),
