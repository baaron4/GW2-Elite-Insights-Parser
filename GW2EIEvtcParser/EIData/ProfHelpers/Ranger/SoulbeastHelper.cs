...
namespace GW2EIEvtcParser.EIData
{
    internal static class SoulbeastHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(725, "Furious Strength", "7% under fury", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, Source.Soulbeast, ByStack, "https://wiki.guildwars2.com/images/c/ca/Furious_Strength.png", 0, 115190, DamageModifierMode.All),
            new BuffDamageModifier(725, "Furious Strength", "10% under fury", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Soulbeast, ByStack, "https://wiki.guildwars2.com/images/c/ca/Furious_Strength.png", 115190, ulong.MaxValue, DamageModifierMode.All),
