...
namespace GW2EIEvtcParser.EIData
{
    internal static class RangerHelper
    {
        ...
        {
                new Buff("Counterattack",14509, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c1/Counterattack.png"),
                //signets
                new Buff("Signet of Renewal",41147, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/1/11/Signet_of_Renewal.png"),
                new Buff("Signet of Stone (Passive)",12627, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/63/Signet_of_Stone.png"),
                new Buff("Signet of the Hunt (Passive)",12626, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/df/Signet_of_the_Hunt.png"),
                new Buff("Signet of the Wild",12518, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/23/Signet_of_the_Wild.png"),
                new Buff("Signet of the Wild (Pet)",12636, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/23/Signet_of_the_Wild.png"),
                new Buff("Signet of Stone (Active)",12543, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/6/63/Signet_of_Stone.png"),
                new Buff("Signet of the Hunt (Active)",12541, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/df/Signet_of_the_Hunt.png"),
                //spirits
                ...
                new Buff("Frost Spirit", 12544, Source.Ranger, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/c/c6/Frost_Spirit.png/33px-Frost_Spirit.png", 0, GW2Builds.May2018Balance),
                new Buff("Sun Spirit", 12540, Source.Ranger, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/d/dd/Sun_Spirit.png/33px-Sun_Spirit.png", 0, GW2Builds.May2018Balance),
                new Buff("Stone Spirit", 12547, Source.Ranger, BuffNature.Defensive, "https://wiki.guildwars2.com/images/thumb/3/35/Stone_Spirit.png/20px-Stone_Spirit.png", 0, GW2Builds.May2018Balance),
                ...
                //reworked
                new Buff("Water Spirit", 50386, Source.Ranger, BuffNature.Defensive, "https://wiki.guildwars2.com/images/thumb/0/06/Water_Spirit.png/33px-Water_Spirit.png", GW2Builds.May2018Balance, GW2Builds.EndOfLife),
                new Buff("Frost Spirit", 50421, Source.Ranger, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/c/c6/Frost_Spirit.png/33px-Frost_Spirit.png", GW2Builds.May2018Balance, GW2Builds.EndOfLife),
                new Buff("Sun Spirit", 50413, Source.Ranger, BuffNature.Offensive, "https://wiki.guildwars2.com/images/thumb/d/dd/Sun_Spirit.png/33px-Sun_Spirit.png", GW2Builds.May2018Balance, GW2Builds.EndOfLife),
                new Buff("Stone Spirit", 50415, Source.Ranger, BuffNature.Defensive, "https://wiki.guildwars2.com/images/thumb/3/35/Stone_Spirit.png/20px-Stone_Spirit.png", GW2Builds.May2018Balance, GW2Builds.EndOfLife),
                new Buff("Storm Spirit", 50381, Source.Ranger, BuffNature.Support, "https://wiki.guildwars2.com/images/thumb/2/25/Storm_Spirit.png/30px-Storm_Spirit.png", GW2Builds.May2018Balance, GW2Builds.EndOfLife),
                //skills
                new Buff("Attack of Opportunity",12574, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/47/Moment_of_Clarity.png"),
                new Buff("Call of the Wild",36781, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/8d/Call_of_the_Wild.png",0 , GW2Builds.July2019Balance),
                new Buff("Call of the Wild",36781, Source.Ranger, BuffStackType.Stacking, 3, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/8d/Call_of_the_Wild.png",GW2Builds.July2019Balance , GW2Builds.February2020Balance),
                new Buff("Strength of the Pack!",12554, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/4b/%22Strength_of_the_Pack%21%22.png"),
                new Buff("Sic 'Em!",33902, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9d/%22Sic_%27Em%21%22.png"),
                new Buff("Sic 'Em! (PvP)",56923, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9d/%22Sic_%27Em%21%22.png"),
                new Buff("Sharpening Stones",12536, Source.Ranger, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/af/Sharpening_Stone.png"),
                new Buff("Sharpen Spines",43266, Source.Ranger, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/95/Sharpen_Spines.png"),
                //traits
                new Buff("Spotter", 14055, Source.Ranger, BuffNature.Offensive, "https://wiki.guildwars2.com/images/b/b0/Spotter.png"),
                new Buff("Opening Strike",13988, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/44/Opening_Strike_%28effect%29.png"),
                new Buff("Quick Draw",29703, Source.Ranger, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/39/Quick_Draw.png"),
                new Buff("Light on your Feet",30673, Source.Ranger, BuffStackType.Queue, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/22/Light_on_your_Feet.png"),
        };
