...
namespace GW2EIEvtcParser.EIData
{
    internal static class RangerHelper
    {
        ...
        internal static readonly List<DamageModifierDescriptor> OutgoingDamageModifiers = new List<DamageModifierDescriptor>
        {
            ...
            new BuffOnActorDamageModifier(ForceOfNature, "Force of Nature", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Ranger, ByPresence, BuffImages.Unknown, DamageModifierMode.All)
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            // Mace
            new Buff("Force of Nature", ForceOfNature, Source.Ranger, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
            new Buff("Nature's Strength", NaturesStrength, Source.Ranger, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
            new Buff("Tapped Out", TappedOut, Source.Ranger, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
        };
