...
namespace GW2EIEvtcParser.EIData
{
    internal static class RangerHelper
    {
        ...
        {
            // Skills
            new BuffDamageModifier(SicEmEffect, "Sic 'Em!", "40%", DamageSource.NoPets, 40.0, DamageType.Strike, DamageType.All, Source.Ranger, ByPresence, BuffImages.SicEm, DamageModifierMode.PvE).UsingChecker((x, log) => {
            ...
            new BuffDamageModifier(SicEmEffect, "Sic 'Em!", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Ranger, ByPresence, BuffImages.SicEm, DamageModifierMode.sPvPWvW).UsingChecker((x, log) => {
                AgentItem src = x.From;
                AbstractBuffEvent effectApply = log.CombatData.GetBuffData(SicEmEffect).Where(y => y is BuffApplyEvent && y.To == src).LastOrDefault(y => y.Time <= x.Time);
                if (effectApply != null)
                {
            ...
            new BuffDamageModifier(SicEmEffect, "Sic 'Em!", "25%", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Ranger, ByPresence, BuffImages.SicEm, DamageModifierMode.All).UsingChecker( (x, log) => {
                AgentItem src = x.From;
                AbstractBuffEvent effectApply = log.CombatData.GetBuffData(SicEmEffect).Where(y => y is BuffApplyEvent && y.To == src).LastOrDefault(y => y.Time <= x.Time);
                if (effectApply != null)
                {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            new Buff("Frost Spirit", FrostSpiritOld, Source.Ranger, BuffClassification.Offensive, BuffImages.FrostSpirit, GW2Builds.StartOfLife, GW2Builds.May2018Balance),
            new Buff("Sun Spirit", SunSpiritOld, Source.Ranger, BuffClassification.Offensive, BuffImages.SunSpirit, GW2Builds.StartOfLife, GW2Builds.May2018Balance),
            new Buff("Stone Spirit", StoneSpiritOld, Source.Ranger, BuffClassification.Defensive, BuffImages.StoneSpirit, GW2Builds.StartOfLife, GW2Builds.May2018Balance),
            //new Boon("Storm Spirit (old)", 50381, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.DefensiveBuffTable, BuffImages.StormSpirit),
            // Spirits reworked
            new Buff("Water Spirit", WaterSpirit, Source.Ranger, BuffClassification.Defensive, BuffImages.WaterSpirit, GW2Builds.May2018Balance, GW2Builds.June2022Balance),
            new Buff("Frost Spirit", FrostSpirit, Source.Ranger, BuffClassification.Offensive, BuffImages.FrostSpirit, GW2Builds.May2018Balance, GW2Builds.June2022Balance),
            new Buff("Sun Spirit", SunSpirit, Source.Ranger, BuffClassification.Offensive, BuffImages.SunSpirit, GW2Builds.May2018Balance, GW2Builds.June2022Balance),
            new Buff("Stone Spirit", StoneSpirit, Source.Ranger, BuffClassification.Defensive, BuffImages.StoneSpirit, GW2Builds.May2018Balance, GW2Builds.June2022Balance),
            ...
            // Traits
            new Buff("Spotter", Spotter, Source.Ranger, BuffClassification.Offensive, BuffImages.Spotter, GW2Builds.StartOfLife, GW2Builds.June2022Balance),
