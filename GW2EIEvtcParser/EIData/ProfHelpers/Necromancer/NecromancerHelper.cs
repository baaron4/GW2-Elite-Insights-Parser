...
namespace GW2EIEvtcParser.EIData
{
    internal static class NecromancerHelper
    {
        ...
        {     
                //forms
                new Buff("Lich Form",10631, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/ab/Lich_Form.png"),
                new Buff("Death Shroud", 790, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/f/f5/Death_Shroud.png"),
                //signets
                new Buff("Signet of Vampirism",21761, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/73/Signet_of_Vampirism.png"),
                new Buff("Vampiric Mark",21766, Source.Necromancer, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/73/Signet_of_Vampirism.png"),
                new Buff("Signet of Vampirism (Shroud)",43885, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/73/Signet_of_Vampirism.png"),
                new Buff("Plague Signet",10630, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c5/Plague_Signet.png"),
                new Buff("Plague Sending",46832, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/7d/Plague_Sending.png"),
                new Buff("Plague Signet (Shroud)",44164, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c5/Plague_Signet.png"),
                new Buff("Signet of Spite",10621, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/df/Signet_of_Spite.png"),
                new Buff("Signet of Spite (Shroud)",43772, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/df/Signet_of_Spite.png"),
                new Buff("Signet of the Locust",10614, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/a3/Signet_of_the_Locust.png"),
                new Buff("Signet of the Locust (Shroud)",40283, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/a3/Signet_of_the_Locust.png"),
                new Buff("Signet of Undeath",10610, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9c/Signet_of_Undeath.png"),
                new Buff("Signet of Undeath (Shroud)",40583, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/9c/Signet_of_Undeath.png"),
                //skills
                new Buff("Spectral Walk",15083, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/33/Spectral_Walk.png", 0, GW2Builds.December2018Balance),
                new Buff("Spectral Walk",53476, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/33/Spectral_Walk.png", GW2Builds.December2018Balance, GW2Builds.EndOfLife),
                new Buff("Spectral Armor",10582, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/d1/Spectral_Armor.png"),
                new Buff("Locust Swarm", 10567, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/77/Locust_Swarm.png"),
                ...
                //traits
                new Buff("Corrupter's Defense",30845, Source.Necromancer, BuffStackType.Stacking, 10, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/1/11/Corrupter%27s_Fervor.png", 0, GW2Builds.October2019Balance),
                new Buff("Death's Carapace",30845, Source.Necromancer, BuffStackType.Stacking, 30, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/58/Death%27s_Carapace.png", GW2Builds.October2019Balance, GW2Builds.EndOfLife),
                new Buff("Flesh of the Master",13810, Source.Necromancer, BuffStackType.Stacking, 25, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/e9/Flesh_of_the_Master.png", 0, GW2Builds.October2019Balance),
                new Buff("Vampiric Aura", 30285, Source.Necromancer, BuffNature.Defensive, "https://wiki.guildwars2.com/images/d/da/Vampiric_Presence.png"),
                new Buff("Vampiric Strikes", 30398, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/d/da/Vampiric_Presence.png"),
                new Buff("Last Rites",29726, Source.Necromancer, BuffNature.Defensive, "https://wiki.guildwars2.com/images/1/1a/Last_Rites_%28effect%29.png"),
                new Buff("Soul Barbs",53489, Source.Necromancer, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/bd/Soul_Barbs.png"),
        };
