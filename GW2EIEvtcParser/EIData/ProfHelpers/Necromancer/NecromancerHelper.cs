...
namespace GW2EIEvtcParser.EIData
{
    internal static class NecromancerHelper
    {
        internal static readonly List<InstantCastFinder> InstantCastFinder = new List<InstantCastFinder>()
        {
            ...
            new BuffGainCastFinder(10583, 10582, EIData.InstantCastFinder.DefaultICD, GW2Builds.December2018Balance, ulong.MaxValue), // Spectral Armor
            new BuffGainCastFinder(10685, 15083, EIData.InstantCastFinder.DefaultICD, 0, GW2Builds.December2018Balance), // Spectral Walk
            new BuffGainCastFinder(10685, 53476, EIData.InstantCastFinder.DefaultICD, GW2Builds.December2018Balance, ulong.MaxValue), // Spectral Walk
        };
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(770, "Death's Embrace", "25% on while downed", DamageSource.NoPets, 25.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/5/5d/Death%27s_Embrace.png",GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifier(770, "Death's Embrace", "5% on while downed", DamageSource.NoPets, 5.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/5/5d/Death%27s_Embrace.png",GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.sPvPWvW),
        ...
        {     
                ...
                new Buff("Plague Sending",46832, Source.Necromancer, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/7/7d/Plague_Sending.png"),
                ...
                //skills
                new Buff("Spectral Walk",15083, Source.Necromancer, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/3/33/Spectral_Walk.png", 0, GW2Builds.December2018Balance),
                new Buff("Spectral Walk",53476, Source.Necromancer, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/3/33/Spectral_Walk.png", GW2Builds.December2018Balance, ulong.MaxValue),
                ...
                new Buff("Death's Carapace",30845, Source.Necromancer, BuffStackType.Stacking, 30, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/5/58/Death%27s_Carapace.png", GW2Builds.October2019Balance, ulong.MaxValue),
