...
namespace GW2EIEvtcParser.EIData
{
    internal static class NecromancerHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(Fear, "Dread", "20% on feared target", DamageSource.NoPets, 20.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/e/e2/Unholy_Fervor.png", 0, GW2Builds.August2018Balance, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(Fear, "Dread", "33% on feared target", DamageSource.NoPets, 33.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/e/e2/Unholy_Fervor.png",GW2Builds.August2018Balance, GW2Builds.February2020Balance, DamageModifierMode.All),
            new BuffDamageModifierTarget(Fear, "Dread", "33% on feared target", DamageSource.NoPets, 33.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/e/e2/Unholy_Fervor.png",GW2Builds.February2020Balance, 104844, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(Fear, "Dread", "15% on feared target", DamageSource.NoPets, 15.0, DamageType.Strike, DamageType.All, Source.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/e/e2/Unholy_Fervor.png",GW2Builds.February2020Balance, 104844, DamageModifierMode.sPvPWvW),
