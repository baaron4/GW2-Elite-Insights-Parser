...
namespace GW2EIEvtcParser.EIData
{
    internal static class HarbingerHelper
    {
        ...
        internal static readonly List<DamageModifierDescriptor> OutgoingDamageModifiers = new List<DamageModifierDescriptor>
        {
            ...
            new BuffOnFoeDamageModifier(Torment, "Wicked Corruption (Crit)", "10% critical to foes with torment", DamageSource.NoPets, 10, DamageType.Strike, DamageType.All, Source.Harbinger, ByPresence, BuffImages.WickedCorruption, DamageModifierMode.All).UsingChecker((evt, log) => evt.HasCrit).WithBuilds(GW2Builds.EODRelease),
