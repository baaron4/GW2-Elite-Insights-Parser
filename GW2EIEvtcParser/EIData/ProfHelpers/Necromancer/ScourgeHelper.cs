...
namespace GW2EIEvtcParser.EIData
{
    internal static class ScourgeHelper
    {
        ...
        internal static readonly List<InstantCastFinder> InstantCastFinder = new List<InstantCastFinder>()
        {
            ...
            new EffectCastFinder(TrailOfAnguish, EffectGUIDs.ScourgeTrailOfAnguish).UsingChecker((evt, combatData, agentData) => evt.Src.Spec == ParserHelper.Spec.Scourge).UsingICD(6100),
