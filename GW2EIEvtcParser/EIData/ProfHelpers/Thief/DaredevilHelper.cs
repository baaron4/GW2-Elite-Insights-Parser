...
namespace GW2EIEvtcParser.EIData
{
    internal static class DaredevilHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(32200, "Lotus Training", "10% cDam (4s) after dodging", DamageSource.NoPets, 10.0, DamageType.Condition, DamageType.All, Source.Daredevil, ByPresence, "https://wiki.guildwars2.com/images/e/ea/Lotus_Training.png", GW2Builds.February2020Balance, GW2Builds.June2021Balance, DamageModifierMode.PvE),
            new BuffDamageModifier(32200, "Lotus Training", "15% cDam (4s) after dodging", DamageSource.NoPets, 15.0, DamageType.Condition, DamageType.All, Source.Daredevil, ByPresence, "https://wiki.guildwars2.com/images/e/ea/Lotus_Training.png", GW2Builds.February2020Balance, GW2Builds.June2021Balance, DamageModifierMode.sPvPWvW),
            new BuffDamageModifier(32200, "Lotus Training", "15% cDam (4s) after dodging", DamageSource.NoPets, 15.0, DamageType.Condition, DamageType.All, Source.Daredevil, ByPresence, "https://wiki.guildwars2.com/images/e/ea/Lotus_Training.png", GW2Builds.June2021Balance, GW2Builds.EndOfLife, DamageModifierMode.All),
        ...
        {
                new Buff("Palm Strike",30423, Source.Daredevil, BuffClassification.Other, "https://wiki.guildwars2.com/images/1/1a/Palm_Strike.png"),
                new Buff("Pulmonary Impact",30510, Source.Daredevil, BuffStackType.Stacking, 25, BuffClassification.Other, "https://wiki.guildwars2.com/images/1/1a/Palm_Strike.png"),
                new Buff("Lotus Training", 32200, Source.Daredevil, BuffClassification.Other, "https://wiki.guildwars2.com/images/e/ea/Lotus_Training.png"),
                new Buff("Unhindered Combatant", 32931, Source.Daredevil, BuffClassification.Other, "https://wiki.guildwars2.com/images/a/a1/Unhindered_Combatant.png"),
                new Buff("Bounding Dodger", 33162, Source.Daredevil, BuffClassification.Other, "https://wiki.guildwars2.com/images/3/30/Bounding_Dodger.png"),
