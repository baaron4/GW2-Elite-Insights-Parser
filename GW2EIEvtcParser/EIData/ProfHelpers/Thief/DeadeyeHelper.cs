...
namespace GW2EIEvtcParser.EIData
{
    internal static class DeadeyeHelper
    {
        ...
        {
                new Buff("Kneeling",42869, Source.Deadeye, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/56/Kneel.png"),
                new Buff("Deadeye's Gaze", 46333, Source.Deadeye, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/78/Deadeye%27s_Mark.png"),
        };
