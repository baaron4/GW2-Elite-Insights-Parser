...
namespace GW2EIEvtcParser.EIData
{
    internal static class ThiefHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                new Buff("Skelk Venom",21780, Source.Thief, BuffStackType.StackingConditionalLoss, 5, BuffNature.DefensiveBuff, "https://wiki.guildwars2.com/images/7/75/Skelk_Venom.png"),
                new Buff("Ice Drake Venom",13095, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffNature.SupportBuff, "https://wiki.guildwars2.com/images/7/7b/Ice_Drake_Venom.png"),
                new Buff("Devourer Venom", 13094, Source.Thief, BuffStackType.StackingConditionalLoss, 2, BuffNature.SupportBuff, "https://wiki.guildwars2.com/images/4/4d/Devourer_Venom.png"),
                new Buff("Skale Venom", 13054, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffNature.OffensiveBuff, "https://wiki.guildwars2.com/images/1/14/Skale_Venom.png"),
                new Buff("Spider Venom",13036, Source.Thief, BuffStackType.StackingConditionalLoss, 6, BuffNature.OffensiveBuff, "https://wiki.guildwars2.com/images/3/39/Spider_Venom.png"),
                new Buff("Soul Stone Venom",49083, Source.Thief, BuffStackType.Stacking, 25, BuffNature.OffensiveBuff, "https://wiki.guildwars2.com/images/d/d6/Soul_Stone_Venom.png"),
                new Buff("Basilisk Venom", 13133, Source.Thief, BuffStackType.StackingConditionalLoss, 2, BuffNature.SupportBuff, "https://wiki.guildwars2.com/images/3/3a/Basilisk_Venom.png"),
