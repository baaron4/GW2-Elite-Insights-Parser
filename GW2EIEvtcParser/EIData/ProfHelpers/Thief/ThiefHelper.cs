...
namespace GW2EIEvtcParser.EIData
{
    internal static class ThiefHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            new Buff("Skelk Venom", SkelkVenom, Source.Thief, BuffStackType.StackingConditionalLoss, 5, BuffClassification.Defensive, BuffImages.SkelkVenom).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2024Balance),
            new Buff("Skelk Venom", SkelkVenom, Source.Thief, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Defensive, BuffImages.SkelkVenom).WithBuilds(GW2Builds.June2024Balance),
            new Buff("Ice Drake Venom", IceDrakeVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffClassification.Support, BuffImages.IceDrakeVenom).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2024Balance),
            new Buff("Ice Drake Venom", IceDrakeVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Support, BuffImages.IceDrakeVenom).WithBuilds(GW2Builds.June2024Balance),
            new Buff("Devourer Venom", DevourerVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 2, BuffClassification.Support, BuffImages.DevourerVenom).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2024Balance),
            new Buff("Devourer Venom", DevourerVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 10, BuffClassification.Support, BuffImages.DevourerVenom).WithBuilds(GW2Builds.June2024Balance),
            new Buff("Skale Venom", SkaleVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffClassification.Offensive, BuffImages.SkaleVenom).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2024Balance),
            new Buff("Skale Venom", SkaleVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Offensive, BuffImages.SkaleVenom).WithBuilds(GW2Builds.June2024Balance),
            new Buff("Spider Venom", SpiderVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 6, BuffClassification.Offensive, BuffImages.SpiderVenom).WithBuilds(GW2Builds.StartOfLife, GW2Builds.June2024Balance),
            new Buff("Spider Venom", SpiderVenomBuff, Source.Thief, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Offensive, BuffImages.SpiderVenom).WithBuilds(GW2Builds.June2024Balance),
