...
namespace GW2EIEvtcParser.EIData
{
    internal static class ThiefHelper
    {
        ...
        {
            // Deadly arts
            new BuffDamageModifierTarget(SkillIDs.NumberOfConditions, "Exposed Weakness", "2% per condition on target", DamageSource.NoPets, 2.0, DamageType.Strike, DamageType.All, Source.Thief, ByStack, "https://wiki.guildwars2.com/images/0/02/Exposed_Weakness.png", GW2Builds.July2018Balance, GW2Builds.EndOfLife, DamageModifierMode.All),
            new BuffDamageModifierTarget(SkillIDs.NumberOfConditions, "Exposed Weakness", "10% if condition on target", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Thief, ByPresence, "https://wiki.guildwars2.com/images/0/02/Exposed_Weakness.png", 0, GW2Builds.July2018Balance, DamageModifierMode.PvE),
