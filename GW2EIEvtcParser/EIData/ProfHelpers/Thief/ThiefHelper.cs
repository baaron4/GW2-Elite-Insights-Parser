...
namespace GW2EIEvtcParser.EIData
{
    internal static class ThiefHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
            ...
            // Spear
            new Buff("Distracting Throw", DistractingThrowBuff, Source.Thief, BuffStackType.Queue, 9, BuffClassification.Offensive, BuffImages.MonsterSkill),
            new Buff("Shadow Veil", ShadowVeilBuff, Source.Thief, BuffClassification.Defensive, BuffImages.MonsterSkill),
        };
