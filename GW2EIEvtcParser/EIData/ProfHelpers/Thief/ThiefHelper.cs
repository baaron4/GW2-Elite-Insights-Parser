...
namespace GW2EIEvtcParser.EIData
{
    internal static class ThiefHelper
    {
        ...
        {
                //signets
                new Buff("Signet of Malice",13049, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/ae/Signet_of_Malice.png"),
                new Buff("Assassin's Signet (Passive)",13047, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/23/Assassin%27s_Signet.png"),
                new Buff("Assassin's Signet (Active)",44597, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/23/Assassin%27s_Signet.png"),
                new Buff("Infiltrator's Signet",13063, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/8/8e/Infiltrator%27s_Signet.png"),
                new Buff("Signet of Agility",13061, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/1/1d/Signet_of_Agility.png"),
                new Buff("Signet of Shadows",13059, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/1/17/Signet_of_Shadows.png"),
                //venoms // src is always the user, makes generation data useless
                new Buff("Skelk Venom",21780, Source.Thief, BuffStackType.StackingConditionalLoss, 5, BuffNature.Defensive, "https://wiki.guildwars2.com/images/7/75/Skelk_Venom.png"),
                new Buff("Ice Drake Venom",13095, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffNature.Support, "https://wiki.guildwars2.com/images/7/7b/Ice_Drake_Venom.png"),
                new Buff("Devourer Venom", 13094, Source.Thief, BuffStackType.StackingConditionalLoss, 2, BuffNature.Support, "https://wiki.guildwars2.com/images/4/4d/Devourer_Venom.png"),
                new Buff("Skale Venom", 13054, Source.Thief, BuffStackType.StackingConditionalLoss, 4, BuffNature.Offensive, "https://wiki.guildwars2.com/images/1/14/Skale_Venom.png"),
                new Buff("Spider Venom",13036, Source.Thief, BuffStackType.StackingConditionalLoss, 6, BuffNature.Offensive, "https://wiki.guildwars2.com/images/3/39/Spider_Venom.png"),
                new Buff("Soul Stone Venom",49083, Source.Thief, BuffStackType.Stacking, 25, BuffNature.Offensive, "https://wiki.guildwars2.com/images/d/d6/Soul_Stone_Venom.png"),
                new Buff("Basilisk Venom", 13133, Source.Thief, BuffStackType.StackingConditionalLoss, 2, BuffNature.Support, "https://wiki.guildwars2.com/images/3/3a/Basilisk_Venom.png"),
                new Buff("Infiltration",13135, Source.Thief, BuffNature.GraphOnly,"https://wiki.guildwars2.com/images/2/25/Shadowstep.png"),
                //transforms
                new Buff("Dagger Storm",13134, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/c/c0/Dagger_Storm.png"),
                //traits
                new Buff("Hidden Killer",42720, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/e/ec/Hidden_Killer.png"),
                new Buff("Lead Attacks",34659, Source.Thief, BuffStackType.Stacking, 15, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/0/01/Lead_Attacks.png"),
                new Buff("Instant Reflexes",34283, Source.Thief, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/7d/Instant_Reflexes.png"),
