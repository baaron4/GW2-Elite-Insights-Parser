...
namespace GW2EIEvtcParser.EIData
{
    internal static class WeaverHelper
    {
        ...
        {
                new Buff("Dual Fire Attunement", FireDual, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b4/Fire_Attunement.png"),
                new Buff("Fire Water Attunement", FireWater, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/ar8Hn8G.png"),
                new Buff("Fire Air Attunement", FireAir, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/YU31LwG.png"),
                new Buff("Fire Earth Attunement", FireEarth, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/64g3rto.png"),
                new Buff("Dual Water Attunement", WaterDual, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/31/Water_Attunement.png"),
                new Buff("Water Fire Attunement", WaterFire, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/H1peqpz.png"),
                new Buff("Water Air Attunement", WaterAir, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/Gz1XwEw.png"),
                new Buff("Water Earth Attunement", WaterEarth, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/zqX3y4c.png"),
                new Buff("Dual Air Attunement", AirDual, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/9/91/Air_Attunement.png"),
                new Buff("Air Fire Attunement", AirFire, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/4ekncW5.png"),
                new Buff("Air Water Attunement", AirWater, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/HIcUaXG.png"),
                new Buff("Air Earth Attunement", AirEarth, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/MCCrMls.png"),
                new Buff("Dual Earth Attunement", EarthDual, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/a8/Earth_Attunement.png"),
                new Buff("Earth Fire Attunement", EarthFire, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/Vgu0B54.png"),
                new Buff("Earth Water Attunement", EarthWater, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/exrTKSW.png"),
                new Buff("Earth Air Attunement", EarthAir, Source.Weaver, BuffNature.GraphOnly, "https://i.imgur.com/Z3P8cPa.png"),
                new Buff("Primordial Stance",42086, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/3a/Primordial_Stance.png"),
                new Buff("Unravel",42683, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/4/4b/Unravel.png"),
                new Buff("Weave Self",42951, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/2a/Weave_Self.png"),
                new Buff("Woven Air",43038, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/bc/Woven_Air.png"),
                new Buff("Woven Fire",45110, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/b/b1/Woven_Fire.png"),
                new Buff("Woven Earth",45662, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/7a/Woven_Earth.png"),
                new Buff("Woven Water",43499, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/a6/Woven_Water.png"),
                new Buff("Perfect Weave",45267, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/2/2a/Weave_Self.png"),
                new Buff("Molten Armor",43586, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/71/Lava_Skin.png"),
                new Buff("Weaver's Prowess",42061, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/7/75/Weaver%27s_Prowess.png"),
                new Buff("Elements of Rage",42416, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/a/a2/Elements_of_Rage.png"),
                new Buff("Stone Resonance",45097, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/5/57/Stone_Resonance.png"),
                new Buff("Grinding Stones",51658, Source.Weaver, BuffNature.GraphOnly, "https://wiki.guildwars2.com/images/3/3d/Grinding_Stones.png"),
        };
