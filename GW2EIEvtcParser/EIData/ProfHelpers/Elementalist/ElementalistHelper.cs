    ...
    internal static class ElementalistHelper
    {
        ...
        internal static readonly List<DamageModifierDescriptor> OutgoingDamageModifiers = new List<DamageModifierDescriptor>
        {
            ...
            new BuffOnActorDamageModifier(FlameWheelBuff, "Flame Wheel", "15%", DamageSource.NoPets, 15.0, DamageType.StrikeAndCondition, DamageType.All, Source.Elementalist, ByPresence, BuffImages.FlameWheel, DamageModifierMode.PvE)
                .WithBuilds(GW2Builds.November2023Balance),
            new BuffOnActorDamageModifier(RagingRichochetBuff, "Raging Ricochet", "5%", DamageSource.NoPets, 5.0, DamageType.Condition, DamageType.All, Source.Elementalist, ByPresence, BuffImages.Unknown, DamageModifierMode.PvE)
        ...
        {       
            ...
            new Buff("Earth Bullet", EarthBullet, Source.Elementalist, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
            new Buff("Raging Ricochet", RagingRichochetBuff, Source.Elementalist, BuffStackType.Queue, 9, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds( GW2Builds.February2024NewWeapons),
            new Buff("Dazing Discharge", DazingDischargeBuff, Source.Elementalist, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
            new Buff("Shattering Stone", ShatteringStoneBuff, Source.Elementalist, BuffStackType.StackingConditionalLoss, 25, BuffClassification.Other, BuffImages.Unknown)
                .WithBuilds(GW2Builds.February2024NewWeapons),
        };
