...
namespace GW2EIEvtcParser.EIData
{
    internal static class ElementalistHelper
    {
        ...
        internal static readonly List<InstantCastFinder> InstantCastFinder = new List<InstantCastFinder>()
        {
            ...
            new DamageCastFinder(Sunspot, Sunspot).UsingSource(EIData.InstantCastFinder.InstantCastSource.Trait),
            new DamageCastFinder(EarthenBlast, EarthenBlast).UsingSource(EIData.InstantCastFinder.InstantCastSource.Trait),
            new DamageCastFinder(LightningStrike, LightningStrike),
            new DamageCastFinder(LightningRod, LightningRod).UsingSource(EIData.InstantCastFinder.InstantCastSource.Trait), 
