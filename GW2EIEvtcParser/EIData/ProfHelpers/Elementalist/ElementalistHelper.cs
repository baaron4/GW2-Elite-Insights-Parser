...
namespace GW2EIEvtcParser.EIData
{
    internal static class ElementalistHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(737, "Pyromancer's Training", "10% on burning target", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/e/e6/Pyromancer%27s_Training.png", GW2Builds.July2019Balance, ulong.MaxValue, DamageModifierMode.All),
            // Air
            ...
            new DamageLogApproximateDamageModifier("Flow like Water", "10% over >75%", DamageSource.NoPets, 10.0, DamageType.Strike, DamageType.All, Source.Elementalist, "https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", (x, log) => x.From.GetCurrentHealthPercent(log, x.Time) >= 75.0, ByPresence, GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.PvE),
            new DamageLogApproximateDamageModifier("Flow like Water", "5% over >75%", DamageSource.NoPets, 5.0, DamageType.Strike, DamageType.All, Source.Elementalist, "https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", (x, log) => x.From.GetCurrentHealthPercent(log, x.Time) >= 75.0, ByPresence, GW2Builds.February2020Balance, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            //new DamageLogDamageModifier("Flow like Water", "10% over 75% HP", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ParseHelper.Source.Elementalist,"https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", x => x.IsOverNinety, ByPresence, GW2Builds.July2019Balance, ulong.MaxValue),
            // Arcane
        ...
        {       
                ...
                new Buff("Mist Form 2",19718, Source.Elementalist, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/1/1b/Mist_Form.png"),
