...
namespace GW2EIEvtcParser.EIData
{
    internal static class ElementalistHelper
    {
        ...
        {
            // Fire
            new BuffDamageModifier(13342, "Persisting Flames", "1% per stack", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, Source.Elementalist, ByStack, "https://wiki.guildwars2.com/images/5/5f/Persisting_Flames.png", 104844 , ulong.MaxValue, DamageModifierMode.All),
            new BuffDamageModifier(new long[] { 5585, FireWater, FireAir, FireEarth, FireDual }, "Pyromancer's Training", "10% while fire attuned", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/e/e6/Pyromancer%27s_Training.png", 0, 97950, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(737, "Burning Rage", "10% on burning target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/b/bd/Burning_Rage.png", 0, 97950, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(737, "Pyromancer's Training", "10% on burning target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/e/e6/Pyromancer%27s_Training.png", 97950, ulong.MaxValue, DamageModifierMode.All),
            // Air
            new DamageLogDamageModifier( "Bolt to the Heart", "20% if target <50% HP", DamageSource.NoPets, 20.0, DamageType.Power, DamageType.All, Source.Elementalist,"https://wiki.guildwars2.com/images/f/f8/Bolt_to_the_Heart.png", (x, log) => x.AgainstUnderFifty, ByPresence, DamageModifierMode.All),
            // Earth
            new BuffDamageModifierTarget(736, "Serrated Stones", "5% to bleeding target", DamageSource.NoPets, 5.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/6/60/Serrated_Stones.png", DamageModifierMode.All),
            // Water
            new DamageLogDamageModifier("Aquamancer's Training", "10% over 90% HP", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist,"https://wiki.guildwars2.com/images/8/81/Aquamancer%27s_Training.png", (x, log) => x.IsOverNinety, ByPresence, 0, 97950, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(738, new long[] { 5586, WaterAir, WaterEarth, WaterFire, WaterDual}, "Piercing Shards w/ Water", "20% on vuln target while on water", DamageSource.NoPets, 20.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, ByPresence, "https://wiki.guildwars2.com/images/4/4b/Piercing_Shards.png", 97950, ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(738, new long[] { 5586, WaterAir, WaterEarth, WaterFire, WaterDual}, "Piercing Shards", "10% on vuln target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, ByAbsence, "https://wiki.guildwars2.com/images/4/4b/Piercing_Shards.png", 97950, ulong.MaxValue, DamageModifierMode.PvE),
            new BuffDamageModifierTarget(738, new long[] { 5586, WaterAir, WaterEarth, WaterFire, WaterDual}, "Piercing Shards w/ Water", "10% on vuln target while on water", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, ByPresence, "https://wiki.guildwars2.com/images/4/4b/Piercing_Shards.png", 97950, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            new BuffDamageModifierTarget(738, new long[] { 5586, WaterAir, WaterEarth, WaterFire, WaterDual}, "Piercing Shards", "5% on vuln target", DamageSource.NoPets, 5.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, ByAbsence, "https://wiki.guildwars2.com/images/4/4b/Piercing_Shards.png", 97950, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            new BuffDamageModifierTarget(738, new long[] { 5586, WaterAir, WaterEarth, WaterFire, WaterDual}, "Piercing Shards", "20% on vuln target while on water", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, ByPresence, ByPresence, "https://wiki.guildwars2.com/images/4/4b/Piercing_Shards.png", 0, 97950, DamageModifierMode.PvE),
            new DamageLogApproximateDamageModifier("Flow like Water", "10% over >75%", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, "https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", (x, log) => x.From.GetCurrentHealthPercent(log, x.Time) >= 75.0, ByPresence, 97950, 102321, DamageModifierMode.All),
            new DamageLogApproximateDamageModifier("Flow like Water", "10% over >75%", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, Source.Elementalist, "https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", (x, log) => x.From.GetCurrentHealthPercent(log, x.Time) >= 75.0, ByPresence, 102321, ulong.MaxValue, DamageModifierMode.PvE),
            new DamageLogApproximateDamageModifier("Flow like Water", "5% over >75%", DamageSource.NoPets, 5.0, DamageType.Power, DamageType.All, Source.Elementalist, "https://wiki.guildwars2.com/images/0/0a/Flow_like_Water.png", (x, log) => x.From.GetCurrentHealthPercent(log, x.Time) >= 75.0, ByPresence, 102321, ulong.MaxValue, DamageModifierMode.sPvPWvW),
            ...
            // Arcane
            new BuffDamageModifier(NumberOfBoonsID, "Bountiful Power", "2% per boon", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, Source.Elementalist, ByStack, "https://wiki.guildwars2.com/images/7/75/Bountiful_Power.png", DamageModifierMode.All),
        };
