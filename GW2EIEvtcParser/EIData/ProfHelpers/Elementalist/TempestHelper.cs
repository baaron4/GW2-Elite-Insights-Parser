...
namespace GW2EIEvtcParser.EIData
{
    internal static class TempestHelper
    {
        ...
        internal static readonly List<Buff> Buffs = new List<Buff>
        {
                ...
                new Buff("Transcendent Tempest",31353, Source.Tempest, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/a/ac/Transcendent_Tempest_%28effect%29.png", GW2Builds.October2019Balance, ulong.MaxValue),
