...
namespace GW2EIEvtcParser.EIData
{
    internal static class TempestHelper
    {
        ...
        internal static readonly List<DamageModifier> DamageMods = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(TranscendentTempest, "Transcendent Tempest", "15% after overload", DamageSource.NoPets, 15.0, DamageType.StrikeAndCondition, DamageType.All, Source.Tempest, ByPresence, BuffImages.TranscendentTempest, DamageModifierMode.PvE).WithBuilds(GW2Builds.August2022Balance, GW2Builds.SOTOReleaseAndBalance),
            new BuffDamageModifier(TranscendentTempest, "Transcendent Tempest", "25% after overload", DamageSource.NoPets, 25.0, DamageType.StrikeAndCondition, DamageType.All, Source.Tempest, ByPresence, BuffImages.TranscendentTempest, DamageModifierMode.PvE).WithBuilds(GW2Builds.SOTOReleaseAndBalance),
