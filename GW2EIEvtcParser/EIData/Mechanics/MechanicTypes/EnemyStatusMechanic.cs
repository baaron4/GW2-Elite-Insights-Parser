...
namespace GW2EIEvtcParser.EIData
{
    ...
    internal class EnemyStatusMechanic<T> : StatusMechanic<T> where T : AbstractStatusEvent
    {
        ...
        public EnemyStatusMechanic(string inGameName, MechanicPlotlySetting plotlySetting, string shortName, int internalCoolDown, StatusGetter getter, StatusChecker condition = null) : this(inGameName, plotlySetting, shortName, shortName, shortName, internalCoolDown, getter, condition)
        {
        }
