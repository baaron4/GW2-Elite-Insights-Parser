...
namespace GW2EIEvtcParser.EIData
{
    ...
    internal class FirstHitOnPlayerMechanic : HitOnPlayerMechanic
    {
        ...
        public FirstHitOnPlayerMechanic(long mechanicID, string inGameName, MechanicPlotlySetting plotlySetting, string shortName, int internalCoolDown, SkillChecker condition = null) : this(mechanicID, inGameName, plotlySetting, shortName, shortName, shortName, internalCoolDown, condition)
        {
        }
