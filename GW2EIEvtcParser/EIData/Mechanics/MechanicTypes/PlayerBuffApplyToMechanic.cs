...
namespace GW2EIEvtcParser.EIData
{
    ...
    internal class PlayerBuffApplyToMechanic : BuffApplyMechanic
    {
        ...
        public PlayerBuffApplyToMechanic(long mechanicID, string inGameName, MechanicPlotlySetting plotlySetting, string shortName, int internalCoolDown, BuffApplyChecker condition = null) : this(mechanicID, inGameName, plotlySetting, shortName, shortName, shortName, internalCoolDown, condition)
        {
        }
