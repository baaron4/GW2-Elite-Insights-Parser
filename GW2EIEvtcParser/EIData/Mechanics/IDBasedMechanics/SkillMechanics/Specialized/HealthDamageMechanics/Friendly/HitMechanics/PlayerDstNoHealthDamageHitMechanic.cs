...
internal class PlayerDstNoHealthDamageHitMechanic : PlayerDstNoHealthDamageMechanic
{
    ...
    public PlayerDstNoHealthDamageHitMechanic(long mechanicID, MechanicPlotlySetting plotlySetting, string shortName, string description, string fullName, int internalCoolDown) : base(mechanicID, plotlySetting, shortName, description, fullName, internalCoolDown)
    {
    }
