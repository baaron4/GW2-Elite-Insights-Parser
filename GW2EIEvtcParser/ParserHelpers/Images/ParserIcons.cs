...
internal static class ParserIcons
{
    ...
    private const string GW2WikiTangoURL = "https://raw.githubusercontent.com/baaron4/GW2-Elite-Insights-Parser/refs/heads/master/GW2EICustomAssets/GW2WikiTango/";
    // High Resolution Icons 200px
    private const string HighResUntamed = $"{GW2WikiTangoURL}Untamed_tango_icon_200px.png";
    private const string HighResSoulbeast = $"{GW2WikiTangoURL}Soulbeast_tango_icon_200px.png";
    private const string HighResDruid = $"{GW2WikiTangoURL}Druid_tango_icon_200px.png";
    private const string HighResRanger = $"{GW2WikiTangoURL}Ranger_tango_icon_200px.png";
    private const string HighResMechanist = $"{GW2WikiTangoURL}Mechanist_tango_icon_200px.png";
    private const string HighResHolosmith = $"{GW2WikiTangoURL}Holosmith_tango_icon_200px.png";
    private const string HighResScrapper = $"{GW2WikiTangoURL}Scrapper_tango_icon_200px.png";
    private const string HighResEngineer = $"{GW2WikiTangoURL}Engineer_tango_icon_200px.png";
    private const string HighResSpecter = $"{GW2WikiTangoURL}Specter_tango_icon_200px.png";
    private const string HighResDeadeye = $"{GW2WikiTangoURL}Deadeye_tango_icon_200px.png";
    private const string HighResDaredevil = $"{GW2WikiTangoURL}Daredevil_tango_icon_200px.png";
    private const string HighResThief = $"{GW2WikiTangoURL}Thief_tango_icon_200px.png";
    private const string HighResCatalyst = $"{GW2WikiTangoURL}Catalyst_tango_icon_200px.png";
    private const string HighResWeaver = $"{GW2WikiTangoURL}Weaver_tango_icon_200px.png";
    private const string HighResTempest = $"{GW2WikiTangoURL}Tempest_tango_icon_200px.png";
    private const string HighResElementalist = $"{GW2WikiTangoURL}Elementalist_tango_icon_200px.png";
    private const string HighResVirtuoso = $"{GW2WikiTangoURL}Virtuoso_tango_icon_200px.png";
    private const string HighResMirage = $"{GW2WikiTangoURL}Mirage_tango_icon_200px.png";
    private const string HighResChronomancer = $"{GW2WikiTangoURL}Chronomancer_tango_icon_200px.png";
    private const string HighResMesmer = $"{GW2WikiTangoURL}Mesmer_tango_icon_200px.png";
    private const string HighResHarbinger = $"{GW2WikiTangoURL}Harbinger_tango_icon_200px.png";
    private const string HighResScourge = $"{GW2WikiTangoURL}Scourge_tango_icon_200px.png";
    private const string HighResReaper = $"{GW2WikiTangoURL}Reaper_tango_icon_200px.png";
    private const string HighResNecromancer = $"{GW2WikiTangoURL}Necromancer_tango_icon_200px.png";
    private const string HighResBladesworn = $"{GW2WikiTangoURL}Bladesworn_tango_icon_200px.png";
    private const string HighResSpellbreaker = $"{GW2WikiTangoURL}Spellbreaker_tango_icon_200px.png";
    private const string HighResBerserker = $"{GW2WikiTangoURL}Berserker_tango_icon_200px.png";
    private const string HighResWarrior = $"{GW2WikiTangoURL}Warrior_tango_icon_200px.png";
    private const string HighResWillbender = $"{GW2WikiTangoURL}Willbender_tango_icon_200px.png";
    private const string HighResFirebrand = $"{GW2WikiTangoURL}Firebrand_tango_icon_200px.png";
    private const string HighResDragonhunter = $"{GW2WikiTangoURL}Dragonhunter_tango_icon_200px.png";
    private const string HighResGuardian = $"{GW2WikiTangoURL}Guardian_tango_icon_200px.png";
    private const string HighResVindicator = $"{GW2WikiTangoURL}Vindicator_tango_icon_200px.png";
    private const string HighResRenegade = $"{GW2WikiTangoURL}Renegade_tango_icon_200px.png";
    private const string HighResHerald = $"{GW2WikiTangoURL}Herald_tango_icon_200px.png";
    private const string HighResRevenant = $"{GW2WikiTangoURL}Revenant_tango_icon_200px.png";

    // Base Resolution Icons 20px
    private const string BaseResUntamed = $"{GW2WikiTangoURL}Untamed_tango_icon_20px.png";
    private const string BaseResSoulbeast = $"{GW2WikiTangoURL}Soulbeast_tango_icon_20px.png";
    private const string BaseResDruid = $"{GW2WikiTangoURL}Druid_tango_icon_20px.png";
    private const string BaseResRanger = $"{GW2WikiTangoURL}Ranger_tango_icon_20px.png";
    private const string BaseResMechanist = $"{GW2WikiTangoURL}Mechanist_tango_icon_20px.png";
    private const string BaseResHolosmith = $"{GW2WikiTangoURL}Holosmith_tango_icon_20px.png";
    private const string BaseResScrapper = $"{GW2WikiTangoURL}Scrapper_tango_icon_20px.png";
    private const string BaseResEngineer = $"{GW2WikiTangoURL}Engineer_tango_icon_20px.png";
    private const string BaseResSpecter = $"{GW2WikiTangoURL}Specter_tango_icon_20px.png";
    private const string BaseResDeadeye = $"{GW2WikiTangoURL}Deadeye_tango_icon_20px.png";
    private const string BaseResDaredevil = $"{GW2WikiTangoURL}Daredevil_tango_icon_20px.png";
    private const string BaseResThief = $"{GW2WikiTangoURL}Thief_tango_icon_20px.png";
    private const string BaseResCatalyst = $"{GW2WikiTangoURL}Catalyst_tango_icon_20px.png";
    private const string BaseResWeaver = $"{GW2WikiTangoURL}Weaver_tango_icon_20px.png";
    private const string BaseResTempest = $"{GW2WikiTangoURL}Tempest_tango_icon_20px.png";
    private const string BaseResElementalist = $"{GW2WikiTangoURL}Elementalist_tango_icon_20px.png";
    private const string BaseResVirtuoso = $"{GW2WikiTangoURL}Virtuoso_tango_icon_20px.png";
    private const string BaseResMirage = $"{GW2WikiTangoURL}Mirage_tango_icon_20px.png";
    private const string BaseResChronomancer = $"{GW2WikiTangoURL}Chronomancer_tango_icon_20px.png";
    private const string BaseResMesmer = $"{GW2WikiTangoURL}Mesmer_tango_icon_20px.png";
    private const string BaseResHarbinger = $"{GW2WikiTangoURL}Harbinger_tango_icon_20px.png";
    private const string BaseResScourge = $"{GW2WikiTangoURL}Scourge_tango_icon_20px.png";
    private const string BaseResReaper = $"{GW2WikiTangoURL}Reaper_tango_icon_20px.png";
    private const string BaseResNecromancer = $"{GW2WikiTangoURL}Necromancer_tango_icon_20px.png";
    private const string BaseResBladesworn = $"{GW2WikiTangoURL}Bladesworn_tango_icon_20px.png";
    private const string BaseResSpellbreaker = $"{GW2WikiTangoURL}Spellbreaker_tango_icon_20px.png";
    private const string BaseResBerserker = $"{GW2WikiTangoURL}Berserker_tango_icon_20px.png";
    private const string BaseResWarrior = $"{GW2WikiTangoURL}Warrior_tango_icon_20px.png";
    private const string BaseResWillbender = $"{GW2WikiTangoURL}Willbender_tango_icon_20px.png";
    private const string BaseResFirebrand = $"{GW2WikiTangoURL}Firebrand_tango_icon_20px.png";
    private const string BaseResDragonhunter = $"{GW2WikiTangoURL}Dragonhunter_tango_icon_20px.png";
    private const string BaseResGuardian = $"{GW2WikiTangoURL}Guardian_tango_icon_20px.png";
    private const string BaseResVindicator = $"{GW2WikiTangoURL}Vindicator_tango_icon_20px.png";
    private const string BaseResRenegade = $"{GW2WikiTangoURL}Renegade_tango_icon_20px.png";
    private const string BaseResHerald = $"{GW2WikiTangoURL}Herald_tango_icon_20px.png";
    private const string BaseResRevenant = $"{GW2WikiTangoURL}Revenant_tango_icon_20px.png";
    #endregion
    ...
    internal readonly static IReadOnlyDictionary<TargetID, string> TargetNPCIcons = new Dictionary<TargetID, string>()
    {
        ...
        { TargetID.JormagMovingFrostBeam, TrashGenericRedEnemySkull },
        { TargetID.JormagMovingFrostBeamNorth, TrashGenericRedEnemySkull },
        { TargetID.JormagMovingFrostBeamCenter, TrashGenericRedEnemySkull },
