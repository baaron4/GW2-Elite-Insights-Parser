...
namespace GW2EIEvtcParser.ParserHelpers
{
    internal static class ParserIcons
    {
        ...
        internal static IReadOnlyDictionary<ArcDPSEnums.TrashID, string> TrashNPCIcons { get; private set; } = new Dictionary<ArcDPSEnums.TrashID, string>()
        {
            ...
            { ArcDPSEnums.TrashID.TemporalAnomalyArtsariiv, TrashTemporalAnomaly },
            { ArcDPSEnums.TrashID.TemporalAnomalyArkk, TrashTemporalAnomaly },
            ...
            { ArcDPSEnums.TrashID.FanaticDagger1, TrashFanatic },
            { ArcDPSEnums.TrashID.FanaticDagger2, TrashFanatic },
            { ArcDPSEnums.TrashID.FanaticBow, TrashFanatic },
        ...
        internal static IReadOnlyDictionary<ArcDPSEnums.MinionID, string> MinionNPCIcons { get; private set; } = new Dictionary<ArcDPSEnums.MinionID, string>()
        {
            ...
            { ArcDPSEnums.MinionID.ThiefDaggerHuman, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefPistolHuman, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefUnknown1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefUnknown2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefDaggerAsura, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefPistolAsura, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefPistolCharr, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefDaggerCharr, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefPistolNorn, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefDaggerNorn, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefPistolSylvari, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefDaggerSylvari, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordAsura1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordNorn1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordAsura2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordCharr1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordSylvari1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordCharr2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordNorn2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordHuman1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordHuman2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.ThiefSwordSylvari2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilSylvari1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilAsura1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilHuman1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilAsura2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilNorn1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilNorn2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilCharr1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilSylvari2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilHuman2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DaredevilCharr2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeSylvari1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeHuman1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeCharr1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeSylvari2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeAsura1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeNorn1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeNorn2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeHuman2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeCharr2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.DeadeyeAsura2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterAsura1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterHuman1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterAsura2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterSylvari1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterHuman2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterNorn1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterCharr1, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterSylvari2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterCharr2, MinionThievesGuild },
            { ArcDPSEnums.MinionID.SpecterNorn2, MinionThievesGuild },
