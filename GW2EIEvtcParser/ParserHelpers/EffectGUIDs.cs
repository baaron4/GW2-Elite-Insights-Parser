...
public static class EffectGUIDs
{
    ...
    // Aetherblade Hideout
    public tatic readonly GUID AetherbladeHideoutKaleidoscopicChaosNM = new("C660211FCC31A54397A8F73BEC25EB73"); // Duration 5000 - Can have End Event
    public tatic readonly GUID AetherbladeHideoutKaleidoscopicChaosCM = new("BDF708225224C64183BA3CE2A609D37F"); // Duration 5000 - Can have End Event
    public tatic readonly GUID AetherbladeHideoutFocusedDestructionGreen = new("3EEDE16455C8C8449237BCC77F107548"); // Duration 6250 - Can have End Event
    public tatic readonly GUID AetherbladeHideoutTormentingWaveIndicator1 = new("E273E005F90E3041939C6235FF9CADBA"); // Duration 3000
    public tatic readonly GUID AetherbladeHideoutTormentingWaveIndicator2 = new("BA8AD38816F84246BB6F24203D3843FC"); // Duration 3000
    public tatic readonly GUID AetherbladeHideoutElectricBlastIndicator = new("1177BFB7901625428E749D8923ADA1A4"); // Duration 0
    public tatic readonly GUID AetherbladeHideoutElectricBlastDetonation = new("5DCCEF82D98807429081E3C647B6E5EE"); // Duration 0
    public tatic readonly GUID AetherbladeHideoutPuzzleCirclesDetonation = new("9417F62F39B64C4897B53B53008611B8"); // Duration 0
    public tatic readonly GUID AetherbladeHideoutPuzzleNormalMode = new("D4E5ED06119B5B40B74C09240498AF0A"); // Duration 12000 - Has End Event
    public tatic readonly GUID AetherbladeHideoutFissureOfTormentIndicator = new("67B2D706779AAB48A01962388DCA2ADB"); // Duration 1300
    public tatic readonly GUID AetherbladeHideoutFissureOfTormentDamage = new("2DCB402ABABAD34E87B0A8A8957C8E13"); // Duration 0
    public tatic readonly GUID AetherbladeHideoutLeyBreachIndicator1 = new("D4089DD8E0040146B3899EB2955AAE87"); // Duration 2000 - Conflicts with Kaineng Overlook effect
    public tatic readonly GUID AetherbladeHideoutLeyBreachIndicator2 = new("27E4543F5DD04844B5D98BC3EAFF9348"); // Duration 2000
    public tatic readonly GUID AetherbladeHideoutLeyBreachRedPuddle = new("4B62321544A6314ABEEECA3FF2D96116"); // Duration 30000 - Has End Event
    public tatic readonly GUID AetherbladeHideoutHeartpiercer = new("06EA9504DA08A0468E9CAFAA97CD9A36"); // Duration 2000
    // Ankka
    ...
    public static readonly GUID HarvestTempleSpreadNM = new("F39933B190100B4C87E808EF8E6C654A");
    public static readonly GUID HarvestTempleSpreadCM = new("BDF708225224C64183BA3CE2A609D37F");
    public static readonly GUID HarvestTempleRedPuddleSelectNM = new("0CD6F76C1BF9C049A2FCE4D86CB46475");
    public static readonly GUID HarvestTempleRedPuddleNM = new("60EE2CA1A95C514F8A325B654E0D9478");
    public static readonly GUID HarvestTempleRedPuddleSelectCM = new("61C1CD7E89346843B04FCE613EC487AA");
    public static readonly GUID HarvestTempleRedPuddleCM = new("FF0A7D32AD894E45993BE5ED748BF484");
