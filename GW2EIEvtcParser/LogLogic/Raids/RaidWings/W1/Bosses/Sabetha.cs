...
internal class Sabetha : SpiritVale
{
    internal readonly MechanicGroup Mechanics = new([
            ...
            new PlayerDstBuffApplyMechanic(ShellShocked, new (Symbols.CircleOpen,Colors.DarkGreen), "Launched", "Shell-Shocked (launched up to cannons)","Shell-Shocked", Sev2, 0),
            new PlayerDstBuffApplyMechanic(SapperBombBuff, new (Symbols.Circle,Colors.DarkGreen), "Sap Bomb", "Got a Sapper Bomb","Sapper Bomb", Sev1, 0),
            new PlayerDstHealthDamageMechanic(Firestorm, new (Symbols.Square,Colors.Red), "Flamewall", "Firestorm (killed by Flamewall)","Flamewall", Sev0, 0)
                .UsingChecker((de, log) => de.HasKilled),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(TimeBomb_Encounter, new (Symbols.Circle,Colors.LightOrange), "Timed Bomb", "Got a Timed Bomb (Expanding circle)","Timed Bomb", Sev0, 0),
                new PlayerDstHealthDamageMechanic([TimeBombDamage_Encounter, TimeBombDamage2_Encounter], new (Symbols.Hexagram, Colors.DarkMagenta), "TimeB Down", "Downed by Time Bomb", "Time Bomb Down", Sev0, 0)
                    .UsingChecker((hde, log) => hde.HasDowned),
                new PlayerDstHealthDamageMechanic([TimeBombDamage_Encounter, TimeBombDamage2_Encounter], new (Symbols.HexagramOpen, Colors.DarkMagenta), "TimeB Kill", "Killed by Time Bomb", "Time Bomb Kill", Sev0, 0)
                    .UsingChecker((hde, log) => hde.HasKilled),
            ]),
            new PlayerDstHealthDamageHitMechanic(FlakShot, new (Symbols.HexagramOpen,Colors.LightOrange), "Flak", "Flak Shot (Fire Patches)","Flak Shot", Sev2, 0),
            new PlayerDstHealthDamageHitMechanic(CannonBarrage, new (Symbols.Circle,Colors.Yellow), "Cannon", "Cannon Barrage (stood in AoE)","Cannon Shot", Sev1, 0),
            new PlayerDstHealthDamageHitMechanic(FlameBlast, new (Symbols.TriangleLeftOpen,Colors.Yellow), "Karde Flame", "Flame Blast (Karde's Flamethrower)","Flamethrower (Karde)", Sev1, 0),
            new PlayerDstHealthDamageHitMechanic(BanditKick, new (Symbols.TriangleRight,Colors.Magenta), "Kick.B", "Kicked by Bandit","Bandit Kick", Sev0, 0)
                .UsingBuffChecker(Stability, false),
            new PlayerCastStartMechanic(KickHeavyBomb, new (Symbols.Cross, Colors.CobaltBlue), "Kick Bomb", "Kicked Heavy Bomb", "Heavy Bomb Kick", Sev0, 0)
            ...
            new MechanicGroup([
                ...
                new EnemyCastEndMechanic(PlatformQuake, new (Symbols.DiamondTall,Colors.DarkGreen), "CCed.K", "Platform Quake (Breakbar broken) ","CCed", Sev0, 0)
                    .UsingChecker((ce, log) => ce.ActualDuration <= 4400),
                new EnemyCastEndMechanic(PlatformQuake, new (Symbols.DiamondTall,Colors.Red), "CC.K Fail", "Platform Quake (Breakbar failed) ","CC Fail", Sev0, 0)
                    .UsingChecker( (ce,log) =>  ce.ActualDuration > 4400),
            ]),
        ]);
