...
internal class StatueOfIce : HallOfChains
{
    internal readonly MechanicGroup Mechanics = new(
        [
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(KingsWrathConeAoE, new (Symbols.TriangleUp, Colors.White), "Cone AoE", "Hit by King's Wrath (Cone AoEs)", "King's Wrath Cone AoE Hit", Sev0, 0),
                new PlayerDstHealthDamageHitMechanic(KingsWrathConeShards, new (Symbols.TriangleLeft, Colors.LightBlue), "Cone Shards", "Hit by King's Wrath (Frontal Cone Shards)", "King's Wrath Cone Shards Hit", Sev0, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic(NumbingBreach, new (Symbols.BowtieOpen, Colors.LightBlue), "Cracks", "Stood on Numbing Breach (Ice Cracks in the Ground)", "Cracks", Sev0, 0),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(FrozenWind, new (Symbols.CircleOpen, Colors.Green), "Green", "Frozen Wind (Stood in Green)", "Green Stack", Sev0, 0),
                new PlayerDstBuffApplyMechanic(Glaciate, new (Symbols.Square, Colors.Purple), "Glaciate", "Glaciated (Frozen by 4th Stack of Frozen Wind)", "Glaciate", Sev0, 0),
                new EnemySrcEffectMechanic(EffectGUIDs.BrokenKingIceBreakerGreenExplosion, new (Symbols.CircleX, Colors.DarkGreen), "Ice Breaker", "Hailstorm Explosion (Missed Green)", "Ice Breaker (Green Missed)", Sev0, 0),
            ]),
        ]);
