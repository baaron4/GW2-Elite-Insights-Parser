...
internal class TwinLargos : MythwrightGambit
{
    internal readonly MechanicGroup Mechanics = new([
            new MechanicGroup([
                new EnemyCastStartMechanic(AquaticBarrage, new (Symbols.DiamondTall,Colors.DarkTeal), "CC.L", "Breakbar","Breakbar", Sev3, 0),
                new EnemyCastEndMechanic(AquaticBarrage, new (Symbols.DiamondTall,Colors.DarkGreen), "CCed.L", "Breakbar broken","CCed", Sev0, 0),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Waterlogged, new (Symbols.HexagonOpen,Colors.LightBlue), "Debuff", "Waterlogged (stacking water debuff)","Waterlogged", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(VaporRush, new (Symbols.TriangleLeftOpen,Colors.LightBlue), "Charge", "Vapor Rush (Triple Charge)","Vapor Rush Charge", Sev0, 0),
                new PlayerDstHealthDamageHitMechanic(TidalPoolSkill, new (Symbols.Circle,Colors.LightBlue), "Pool", "Tidal Pool","Tidal Pool", Sev2, 0),
                new PlayerDstBuffApplyMechanic(TidalPoolBuff, new (Symbols.Diamond,Colors.Teal), "Poison", "Expanding Water Field","Water Poison", Sev0, 0),
                ...
                new PlayerDstBuffApplyMechanic(AquaticAuraNikare, new (Symbols.DiamondOpen,Colors.Teal), "Nik Aura", "Increasing Damage Debuff on Nikare's Last Platform","Nikare Aura Debuff", Sev2, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SeaSwell, new (Symbols.CircleOpen,Colors.DarkPurple), "Wave", "Sea Swell (Shockwave)","Shockwave", Sev0, 0)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic(AquaticVortex, new (Symbols.StarSquareOpenDot,Colors.LightBlue), "Tornado", "Aquatic Vortex (Water Tornados)","Tornado", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(VaporJet, new (Symbols.Square,Colors.Pink), "Steal", "Vapor Jet (Boon Steal)","Boon Steal", Sev0, 0),
                new PlayerDstBuffApplyMechanic(AquaticAuraKenut, new (Symbols.SquareOpen,Colors.Teal), "Ken Aura", "Increasing Damage Debuff on Kenut's Last Platform","Kenut Aura Debuff", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(CycloneBurst, new (Symbols.YUpOpen,Colors.Pink), "Y Field", "Cyclone Burst (triangular rotating fields on Kenut)","Cyclone Burst", Sev2, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic(Geyser, new (Symbols.Hexagon,Colors.Teal), "KB/Launch", "Geyser (Launching Aoes)","Launch Field", Sev3, 0),
            new EnemyDstBuffApplyMechanic(EnragedTwinLargos, new (Symbols.StarDiamond,Colors.Red), "Enrage", "Enraged","Enrage", Sev0, 0),
        ]);
