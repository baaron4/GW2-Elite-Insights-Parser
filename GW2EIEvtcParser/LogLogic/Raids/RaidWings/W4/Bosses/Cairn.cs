...
internal class Cairn : BastionOfThePenitent
{
    internal readonly MechanicGroup Mechanics = new([
            ...
            new PlayerDstHealthDamageHitMechanic(CairnDisplacement, new (Symbols.Circle,Colors.LightOrange), "Port", "Orange Teleport Field","Orange TP", Sev0, 0),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([SpatialManipulation1, SpatialManipulationInitial, SpatialManipulation2, SpatialManipulation3, SpatialManipulation4, SpatialManipulationFastTrigger], new (Symbols.Circle,Colors.DarkGreen), "Std.Green", "Stood in Green Spatial Manipulation Field","Green", Sev2, 0)
                    .WithStabilitySubMechanic(
                        new SubMechanic(new (Symbols.Circle,Colors.Green), "Green.C", "Green Spatial Manipulation Field (lift)","Green (lift)", Sev2, 0),
                        false
                    )
                    .WithStabilitySubMechanic(
                        new SubMechanic(new (Symbols.CircleOpen,Colors.Green), "Stab.Green.C", "Green Spatial Manipulation Field while affected by stability","Stabilized Green", Sev0, 0),
                        true
                    )
                    .UsingIgnored()
                ,
            ...
            new MechanicGroup([
                ...
                new EnemySrcMissileMechanic(MeteorSwarm, new (Symbols.DiamondTall,Colors.Orange), "Refl.KB","Reflected Knockback Crystals", "Reflected KB Crystal", Sev0, 0)
                    .UsingReflected(),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(SharedAgony, new (Symbols.Circle,Colors.Red), "Agony", "Shared Agony Debuff Application","Shared Agony", Sev0, 0),//could flip
                new PlayerDstBuffApplyMechanic(SharedAgony25, new (Symbols.StarTriangleUpOpen,Colors.Pink), "Agony 25", "Shared Agony Damage (25% Player's HP)","SA dmg 25%", Sev1, 0), // Seems to be a (invisible) debuff application for 1 second from the Agony carrier to the closest(?) person in the circle.
                new PlayerDstBuffApplyMechanic(SharedAgony50, new (Symbols.StarDiamondOpen,Colors.Orange), "Agony 50", "Shared Agony Damage (50% Player's HP)","SA dmg 50%", Sev1, 0), //Chaining from the first person hit by 38170, applying a 1 second debuff to the next person.
                new PlayerDstBuffApplyMechanic(SharedAgony75, new (Symbols.StarOpen,Colors.Red), "Agony 75", "Shared Agony Damage (75% Player's HP)","SA dmg 75%", Sev1, 0), //Chaining from the first person hit by 37768, applying a 1 second debuff to the next person.
            ]),
            ...
            new PlayerDstHealthDamageHitMechanic(GravityWave, new (Symbols.Octagon,Colors.Magenta), "Donut", "Expanding Crystal Donut Wave (Knockback)","Crystal Donut", Sev1, 0)
