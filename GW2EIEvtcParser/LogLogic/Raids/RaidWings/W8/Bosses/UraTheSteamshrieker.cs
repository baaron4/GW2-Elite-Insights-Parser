...
internal class UraTheSteamshrieker : MountBalrior
{
    ...
    internal readonly MechanicGroup Mechanics = new([
            // Sulfuric Geysers
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SulfuricEruption, new MechanicPlotlySetting(Symbols.StarOpen, Colors.LightBlue), "SulfErup.H", "Hit by Sulfuric Eruption (Geyser Spawn)", "Sulfuric Eruption Hit", MechanicSeverity.Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(EruptionVent, new MechanicPlotlySetting(Symbols.TriangleNW, Colors.DarkPink), "ErupVent.H", "Hit by Eruption Vent (Geyser Shockwave)", "Eruption Vent Hit", MechanicSeverity.Sev0, 0),
                new PlayerDstEffectMechanic([EffectGUIDs.UraSulfuricGeyserTarget, EffectGUIDs.UraSulfuricGeyserTargetCM], new MechanicPlotlySetting(Symbols.Hexagon, Colors.Blue), "SulfGey.T", "Targeted by Sulfuric Geyser (Spawn)", "Sulfuric Geyser Spawn Target", MechanicSeverity.Sev0, 0),
                new PlayerSrcBuffRemoveFromMechanic(HardenedCrust, new MechanicPlotlySetting(Symbols.CircleCrossOpen, Colors.White), "Dispel.Sulf", "Dispelled Sulfuric Geyser (Removed Hardened Crust)", "Dispelled Sulfuric Geyser", MechanicSeverity.Sev1, 0)
            ...
            // Titanspawn Geysers
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(CreateTitanspawnGeyser, new MechanicPlotlySetting(Symbols.CircleXOpen, Colors.Orange), "UraJump.H", "Hit by Create Titanspawn Geyser AoE (Ura jump in place)", "Create Titanspawn Geyser Hit", MechanicSeverity.Sev1, 0)
                    .WithStabilitySubMechanic(
                        new SubMechanic(new MechanicPlotlySetting(Symbols.CircleXOpen, Colors.LightOrange), "UraJump.CC", "CC by Create Titanspawn Geyser AoE (Ura jump in place)", "Create Titanspawn Geyser CC", MechanicSeverity.Sev0, 0),
                        false
                    ),
                new PlayerSrcBuffRemoveFromMechanic(HardenedCrust, new MechanicPlotlySetting(Symbols.CircleX, Colors.White), "Dispel.Titn", "Dispelled Titanspawn Geyser (Removed Hardened Crust)", "Dispelled Titanspawn Geyser", MechanicSeverity.Sev0, 0)
                    .UsingChecker((brae, log) => brae.To.IsAnySpecies([TargetID.TitanspawnGeyser, TargetID.TitanspawnGeyserGadget])),
                new PlayerBreakbarDamageMechanic(new MechanicPlotlySetting(Symbols.StarDiamond, Colors.White), "Titn.BrkDmg", "Breakbar Damage done against Titanspawn Geysers", "Breakbar Damage Titanspawn Geysers", MechanicSeverity.Sev0, 0, (log, a) => log.CombatData.GetBreakbarDamageData(a))
                    .UsingChecker((brae, log) => brae.To.IsAnySpecies([TargetID.TitanspawnGeyser, TargetID.TitanspawnGeyserGadget]))
                    .UsingWeight(),
            ]),
            // Toxic Geysers
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([ToxicGeyser1, ToxicGeyser2, ToxicGeyserCM], new MechanicPlotlySetting(Symbols.StarSquare, Colors.GreenishYellow), "ToxGeyser.H", "Hit by Toxic Geyser", "Toxic Geyser Hit", MechanicSeverity.Sev1, 0),
                new PlayerSrcBuffRemoveFromMechanic(HardenedCrust, new MechanicPlotlySetting(Symbols.CircleCross, Colors.White), "Dispel.Toxc", "Dispelled Toxic Geyser (Removed Hardened Crust)", "Dispelled Toxic Geyser", MechanicSeverity.Sev0, 0)
                    .UsingChecker((brae, log) => brae.To.IsSpecies(TargetID.ToxicGeyser)),
                new PlayerBreakbarDamageMechanic(new MechanicPlotlySetting(Symbols.StarSquare, Colors.White), "Toxc.BrkDmg", "Breakbar Damage done against Toxic Geysers", "Breakbar Damage Toxic Geysers", MechanicSeverity.Sev0, 0, (log, a) => log.CombatData.GetBreakbarDamageData(a))
                    .UsingChecker((brae, log) => brae.To.IsSpecies(TargetID.ToxicGeyser))
                    .UsingWeight(),
            ]),
            // Ura
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(ScaldingAura, new MechanicPlotlySetting(Symbols.Pentagon, Colors.LightPink), "ScalAura.H", "Hit by Scalding Aura (Ura's Hitbox)", "Scalding Aura Hit", MechanicSeverity.Sev2, 0),
                new PlayerDstBuffApplyMechanic(SulfuricAcid, new MechanicPlotlySetting(Symbols.TriangleNEOpen, Colors.Purple), "SulfAcid.A", "Received Sulfuric Acid", "Sulfuric Acid Application", MechanicSeverity.Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(SulfuricFroth, new MechanicPlotlySetting(Symbols.TriangleLeft, Colors.LightGrey), "SulfFroth.H", "Hit by Sulfuric Froth (Acid Projectile from Ura)", "Sulfuric Froth Hit", MechanicSeverity.Sev2, 0),
            ]),
            // Steam Prison
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SteamPrison, new MechanicPlotlySetting(Symbols.CircleOpenDot, Colors.Orange), "Ste.Prison.H", "Hit by Steam Prison", "Steam Prison Hit", MechanicSeverity.Sev1, 0),
                new PlayerDstEffectMechanic(EffectGUIDs.UraSteamPrisonIndicator, new MechanicPlotlySetting(Symbols.CircleOpenDot, Colors.LightOrange), "Ste.Prison.T", "Targeted by Steam Prison (Ring)", "Steam Prison Target", MechanicSeverity.Sev0, 0),
            ]),
            // Pressure Blast
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(PressureBlastTargetBuff, new MechanicPlotlySetting(Symbols.CircleOpen, Colors.LightBlue), "Pres.Blast.T", "Targeted by Pressure Blast (Bubbles)", "Pressure Blast Target", MechanicSeverity.Sev0, 0),
                new PlayerDstBuffApplyMechanic(PressureBlastBubbleBuff, new MechanicPlotlySetting(Symbols.CircleOpen, Colors.Blue), "Pres.Blast.Up", "Lifted in a bubble by Pressure Blast", "Pressure Blast Bubble", MechanicSeverity.Sev0, 0),
                new PlayerSrcBuffRemoveFromMechanic(PressureBlastBubbleBuff, new MechanicPlotlySetting(Symbols.CircleOpen, Colors.White), "Dispel.P", "Dispelled Player (Removed Pressure Blast)", "Dispelled Player", MechanicSeverity.Sev0, 0)
                    .UsingChecker((brae, log) => brae.To.IsPlayer),
            ]),
            // Dispel
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Deterrence, new MechanicPlotlySetting(Symbols.Diamond, Colors.LightRed), "Pick-up Shard", "Picked up the Bloodstone Shard", "Bloodstone Shard Pick-up", MechanicSeverity.Sev1, 0)
                    .UsingTimeClamper((time, log, encounterPhase) => Math.Max(encounterPhase.Start, time)),
                new PlayerDstBuffApplyMechanic(BloodstoneSaturation, new MechanicPlotlySetting(Symbols.Diamond, Colors.DarkPurple), "Dispel", "Used Dispel (SAK)", "Used Dispel", MechanicSeverity.Sev1, 0),
            ]),
            // Fumaroller
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(BreakingGround, new MechanicPlotlySetting(Symbols.Star, Colors.Red), "BreGround.H", "Hit by Breaking Ground (Fumaroller 8 pointed star)", "Breaking Ground Hit", MechanicSeverity.Sev0, 0),
                new PlayerDstHealthDamageHitMechanic(MantleGrinder, new MechanicPlotlySetting(Symbols.HourglassOpen, Colors.DarkPurple), "MantGrind.H", "Hit by Mantle Grinder (Fumaroller Roll)", "Mantle Grinder Hit", MechanicSeverity.Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(FullSteam, new MechanicPlotlySetting(Symbols.Octagon, Colors.GreyishGreen), "FullSteam.H", "Hit by Full Steam (Fumaroller Dash)", "Full Steam Hit", MechanicSeverity.Sev1, 0),
            ]),
            // Ventshot
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(PressureRelease, new MechanicPlotlySetting(Symbols.CircleOpenDot, Colors.CobaltBlue), "PresRel.H", "Hit by Pressure Release (Ventshot Jump AoE)", "Pressure Release Hit", MechanicSeverity.Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(ForcedEruption, new MechanicPlotlySetting(Symbols.PentagonOpen, Colors.Blue), "ForcErup.H", "Hit by Forced Eruption (Ventshot Homing Orb)", "Forced Eruption Hit", MechanicSeverity.Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(SearingSnipe, new MechanicPlotlySetting(Symbols.StarTriangleUpOpen, Colors.LightBlue), "SearSnipe.H", "Hit by Searing Snipe (Ventshot Projectile)", "Searing Snipe Hit", MechanicSeverity.Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(StoneSlamConeKnockback, new MechanicPlotlySetting(Symbols.TriangleLeft, Colors.Orange), "StnSlam.CC", "CC by Stone Slam (Ventshot Cone)", "Stone Slam CC", MechanicSeverity.Sev0, 0)
                    .UsingBuffChecker(Stability, false),
            ]),
            new EnemyCastStartMechanic(Return, new MechanicPlotlySetting(Symbols.TriangleRightOpen, Colors.White), "Return", "Ura returned to the center", "Return", MechanicSeverity.Sev1, 100),
            new EnemyDstBuffApplyMechanic(RisingPressure, new MechanicPlotlySetting(Symbols.TriangleUp, Colors.LightOrange), "Rising Pressure", "Applied Rising Pressure", "Rising Pressure", MechanicSeverity.Sev1, 0),
            new EnemyDstBuffApplyMechanic(TitanicResistance, new MechanicPlotlySetting(Symbols.TriangleUpOpen, Colors.LightOrange), "Titanic Resistance", "Applied Titanic Resistance", "Titanic Resistance", MechanicSeverity.Sev1, 0),
        ]);
