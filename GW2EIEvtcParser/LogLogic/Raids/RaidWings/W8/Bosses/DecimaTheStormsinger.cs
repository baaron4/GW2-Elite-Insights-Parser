...
internal class DecimaTheStormsinger : MountBalrior
{
    ...
    internal readonly MechanicGroup Mechanics = new([
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([ChorusOfThunderDamage, ChorusOfThunderCM], new (Symbols.Circle, Colors.LightOrange), "ChorThun.H", "Hit by Chorus of Thunder (Spreads AoE / Conduit AoE)", "Chorus of Thunder Hit", Sev1, 0),
                new PlayerDstEffectMechanic(EffectGUIDs.DecimaChorusOfThunderAoE, new (Symbols.Circle, Colors.LightGrey), "ChorThun.T", "Targeted by Chorus of Thunder (Spreads)", "Chorus of Thunder Target", Sev1, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic([DiscordantThunderCM], new (Symbols.Circle, Colors.Orange), "DiscThun.H", "Hit by Discordant Thunder", "Discordant Thunder Hit", Sev1, 0),
            new PlayerDstHealthDamageHitMechanic(HarmoniousThunder, new (Symbols.Circle, Colors.Yellow), "HarmThun.H", "Hit by Harmonious Thunder", "Harmonious Thunder Hit", Sev1, 0),
            // TODO: Seismic Crash needs to be fully verified again in both modes
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([SeismicCrashNM, SeismicCrashCM, SeismicCrashCM2, SeismicCrashCM3, SeismicCrashCM4, SeismicCrashCM5, SeismicCrashCM6], new (Symbols.Hourglass, Colors.White), "SeisCrash.H", "Hit by Seismic Crash (Concentric Rings)", "Seismic Crash Hit", Sev3, 0)
                    .WithStabilitySubMechanic(
                        new SubMechanic(new (Symbols.Hourglass, Colors.DarkWhite), "SeisCrash.CC", "CC by Seismic Crash (Concentric Rings)", "Seismic Crash CC", Sev0, 0),
                        false
                    ),
                new PlayerDstHealthDamageMechanic(SeismicCrashHitboxDamage, new (Symbols.CircleCross, Colors.LightRed), "SeisCrash.Dwn", "Downed by Seismic Crash (Hitbox)", "Seismic Crash Downed", Sev0, 0)
                    .UsingChecker((hde, log) => hde.To.IsDowned(log, hde.Time))
                    .WithBuilds(GW2Builds.December2024MountBalriorNerfs),
                new PlayerDstHealthDamageMechanic(SeismicCrashHitboxDamage, new (Symbols.CircleCross, Colors.Red), "SeisCrash.D", "Seismic Crash Death (Hitbox)", "Seismic Crash Death", Sev0, 0)
            ...
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([SeismicReposition_80_50, SeismicReposition_70_40, SeismicReposition_40_TO_10, SeismicReposition_10], new (Symbols.HourglassOpen, Colors.White), "SeisRepos.H", "Hit by Seismic Reposition (Concentric Rings Leap)", "Seismic Reposition Hit", Sev3, 0)
                    .WithStabilitySubMechanic(
                        new SubMechanic(new (Symbols.HourglassOpen, Colors.DarkWhite), "SeisRepos.CC", "CC by Seismic Reposition (Concentric Rings Leap)", "Seismic Reposition CC", Sev0, 0),
                        false
                    ),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([EarthrendCastAndOuterRingDamageNM, EarthrendCastAndOuterRingDamageCM], new (Symbols.CircleOpen, Colors.Blue), "Earthrend.H", "Hit by Earthrend (Outer Doughnut)", "Earthrend Hit", Sev2, 0)
                    .WithStabilitySubMechanic(
                        new SubMechanic(new (Symbols.CircleOpen, Colors.DarkBlue), "Earthrend.CC", "CC by Earthrend (Outer Doughnut)", "Earthrend CC", Sev0, 0),
                        false
                    ),
                new PlayerDstHealthDamageMechanic(EarthrendInnerHitboxDamageNM, new (Symbols.CircleCrossOpen, Colors.LightRed), "Earthrend.Dwn", "Downed by Earthrend (Hitbox)", "Earthrend Downed", Sev0, 0)
                    .UsingChecker((hde, log) => hde.To.IsDowned(log, hde.Time))
                    .WithBuilds(GW2Builds.December2024MountBalriorNerfs),
                new PlayerDstHealthDamageMechanic([EarthrendInnerHitboxDamageNM, EarthrendInnerHitboxDamageCM], new (Symbols.CircleCrossOpen, Colors.Red), "Earthrend.D", "Earthrend Death (Hitbox)", "Earthrend Death", Sev0, 0)
                    .UsingChecker((hde, log) => hde.To.IsDead(log, hde.Time)), // If a player is already in downstate they get killed in NM, not logged in CM
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(Fluxlance, new (Symbols.StarSquare, Colors.LightOrange), "Fluxlance.H", "Hit by Fluxlance (Single Orange Arrow)", "Fluxlance Hit", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic([FluxlanceFusillade, FluxlanceFusilladeCM], new (Symbols.StarDiamond, Colors.LightOrange), "FluxFusi.H", "Hit by Fluxlance Fusillade (Sequential Orange Arrows)", "Fluxlance Fusillade Hit", Sev2, 0),
                ...
                new PlayerDstBuffApplyMechanic(FluxlanceTargetBuff1, new (Symbols.StarTriangleDown, Colors.Orange), "Fluxlance.T", "Targeted by Fluxlance", "Fluxlance Target", Sev1, 0),
                new PlayerDstBuffApplyMechanic(FluxlanceRedArrowTargetBuff, new (Symbols.StarTriangleDown, Colors.Red), "FluxRed.T", "Targeted by Fluxlance (Red Arrow)", "Fluxlance (Red Arrow)", Sev0, 0),
                new PlayerDstBuffApplyMechanic([TargetOrder1JW, TargetOrder2JW, TargetOrder3JW, TargetOrder4JW, TargetOrder5JW], new (Symbols.StarTriangleDown, Colors.LightOrange), "FluxOrder.T", "Targeted by Fluxlance (Target Order)", "Fluxlance Target (Sequential)", Sev1, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([SparkingAuraTier1, SparkingAuraTier1CM], new (Symbols.CircleX, Colors.Green), "SparkAura1.H", "Sparking Aura (Absorbed Tier 1 Green Damage)", "Absorbed Tier 1 Green", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic([SparkingAuraTier2, SparkingAuraTier2CM], new (Symbols.CircleX, Colors.LightMilitaryGreen), "SparkAura2.H", "Sparking Aura (Absorbed Tier 2 Green Damage)", "Absorbed Tier 2 Green", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic([SparkingAuraTier3, SparkingAuraTier3CM], new (Symbols.CircleX, Colors.DarkGreen), "SparkAura3.H", "Sparking Aura (Absorbed Tier 3 Green Damage)", "Absorbed Tier 3 Green", Sev2, 0),
            ...
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([FulgentFence, FulgentFenceCM], new (Symbols.Octagon, Colors.Purple), "FulFence.H", "Hit by Fulgent Fence (Barriers between Conduits)", "Fulgence Fence Hit", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([FulgentAuraTier1, FulgentAuraTier1CM, FulgentAuraTier2, FulgentAuraTier2CM, FulgentAuraTier3, FulgentAuraTier3CM], new (Symbols.CircleXOpen, Colors.Purple), "FulAura.H", "Hit by Fulgent Aura (Conduit AoE)", "Fulgent Aura Hit", Sev0, 0),
                new PlayerDstHealthDamageHitMechanic([ReverberatingImpact, ReverberatingImpactCM], new (Symbols.StarOpen, Colors.LightBlue), "RevImpact.H", "Hit by Reverberating Impact (Hit a Conduit)", "Reverberating Impact Hit", Sev0, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(Earthfall, new (Symbols.YUp, Colors.LightPink), "Earthfall.H", "Hit by Earthfall (Transcendent Boudlers Jump)", "Earthfall Hit", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(Sparkwave, new (Symbols.TriangleDown, Colors.LightOrange), "Sparkwave.H", "Hit by Sparkwave (Transcendent Boulders Cone)", "Sparkwave Hit", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic(ChargedGround, new (Symbols.CircleOpenDot, Colors.CobaltBlue), "CharGrnd.H", "Hit by Charged Ground (Transcendent Boulders AoEs)", "Charged Ground Hit", Sev0, 0),
            ]),
            new MechanicGroup([
            ...
            new EnemyDstBuffApplyMechanic(ChargeDecima, new (Symbols.BowtieOpen, Colors.DarkMagenta), "Charge", "Charge Stacks", "Charge Stacks", Sev0, 0),
        ]);
