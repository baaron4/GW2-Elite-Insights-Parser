...
internal class Sabir : TheKeyOfAhdashim
{
    internal readonly MechanicGroup Mechanics = new([
            new MechanicGroup([
                new PlayerDstHealthDamageMechanic(DireDrafts, new MechanicPlotlySetting(Symbols.Circle,Colors.Orange), "B.Tornado", "Hit by big tornado", "Big Tornado Hit", MechanicSeverity.Sev0, 500)
                    .UsingChecker((de, log) => de.HasDowned || de.HasKilled),
                new PlayerDstHealthDamageMechanic(UnbridledTempest, new MechanicPlotlySetting(Symbols.Hexagon,Colors.Pink), "Shockwave", "Hit by Shockwave", "Shockwave Hit", MechanicSeverity.Sev0, 0)
                    .UsingChecker((de, log) => de.HasDowned || de.HasKilled),
                new PlayerDstHealthDamageMechanic(FuryOfTheStorm, new MechanicPlotlySetting(Symbols.Circle,Colors.Purple), "Arena AoE", "Hit by Arena wide AoE", "Arena AoE hit", MechanicSeverity.Sev0, 0)
                    .UsingChecker( (de, log) => de.HasDowned || de.HasKilled ),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([ DynamicDeterrentNM, DynamicDeterrentCM ], new MechanicPlotlySetting(Symbols.YUpOpen,Colors.Pink), "Rot.KB", "Pushed by rotating breakbar", "Pushed", MechanicSeverity.Sev0, 0)
                    .UsingBuffChecker(Stability, false),
                new EnemyCastStartMechanic([ DynamicDeterrentNM, DynamicDeterrentCM ], new MechanicPlotlySetting(Symbols.Star, Colors.Yellow), "Dynamic Deterrent", "Casted Dynamic Deterrent", "Cast Dynamic Deterrent", MechanicSeverity.Sev2, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic([ StormsEdgeLeftHand, StormsEdgeRightHand ], new MechanicPlotlySetting(Symbols.BowtieOpen, Colors.Blue), "Storm's Edge", "Hit by Storm's Edge", "Storm's Edge", MechanicSeverity.Sev1, 0),
            new PlayerDstHealthDamageHitMechanic(ChainLightning, new MechanicPlotlySetting(Symbols.HexagonOpen, Colors.White), "Chain Lightning", "Hit by Chain Lightning", "Chain Lightning Hit", MechanicSeverity.Sev1, 0),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(Electrospark, new MechanicPlotlySetting(Symbols.CircleCross, Colors.Orange), "Electrospark", "Hit by Electrospark", "Electrospark", MechanicSeverity.Sev1, 0),
                new MechanicGroup([
            ...
            new MechanicGroup([
                new MechanicGroup([
                    new EnemyCastStartMechanic(RegenerativeBreakbar, new MechanicPlotlySetting(Symbols.DiamondWide,Colors.Magenta), "Reg.Breakbar", "Regenerating Breakbar","Regenerative Breakbar", MechanicSeverity.Sev2, 0),
                    new EnemyDstBuffRemoveMechanic(IonShield, new MechanicPlotlySetting(Symbols.DiamondWide,Colors.DarkTeal), "Reg.Breakbar Brkn", "Regenerative Breakbar Broken", "Regenerative Breakbar Broken", MechanicSeverity.Sev0, 2000),
                ]),
                new MechanicGroup([
                    new EnemyDstBuffApplyMechanic(RepulsionField, new MechanicPlotlySetting(Symbols.DiamondTall,Colors.Magenta), "Rot.Breakbar", "Rotating Breakbar","Rotating Breakbar", MechanicSeverity.Sev2, 0),
                    new EnemyDstBuffRemoveMechanic(RepulsionField, new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkTeal), "Rot.Breakbar Brkn", "Rotating Breakbar Broken","Rotating Breakbar Broken", MechanicSeverity.Sev0, 0),
                ]),
            ]),
        ]);
