...
internal class Freezie : FestivalRaidEncounterLogic
{
    public Freezie(int triggerID) : base(triggerID)
    {
        MechanicList.Add(new MechanicGroup([
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(AuroraBeamTargetBuff, new (Symbols.Star, Colors.Purple), "AuroraBeam.T", "Targeted by Aurora Beam", "Aurora Beam Target", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([AuroraBeam1, AuroraBeam2, AuroraBeam3], new (Symbols.StarDiamond, Colors.Purple), "AuroraBeam.H", "Hit by Aurora Beam", "Aurora Beam Hit", Sev0, 0),
                new EnemyCastStartMechanic([AuroraBeam1, AuroraBeam2, AuroraBeam3], new (Symbols.StarDiamondOpen, Colors.Purple), "AuroraBeam.C", "Casted Aurora Beam", "Aurora Beam Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(GiantSnowballFreezieTargetBuff1, new (Symbols.Star, Colors.Purple, 5), "GiantSnowball.T", "Targeted by Giant Snowball", "Giant Snowball Target", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic(GiantSnowballFreezieDamage, new (Symbols.Circle, Colors.White), "GiantSnowball.H", "Hit by Giant Snowball", "Giant Snowball Hit", Sev0, 0),
                new EnemyCastStartMechanic(GiantSnowballFreezieCast, new (Symbols.CircleOpen, Colors.White), "GiantSnowball.C", "Casted Giant Snowball", "Giant Snowball Cast", Sev3, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic(Blizzard, new (Symbols.CircleOpen, Colors.Orange), "Blizzard.H", "Hit by Blizzard (Outer circle)", "Blizzard Hit", Sev1, 0),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(FrostPatchDamage, new (Symbols.Octagon, Colors.Blue), "FrostPatch.H", "Hit by Frost Patch (Cracks)", "Frost Patch Hit (Cracks)", Sev1, 0),
                new EnemyCastStartMechanic(FrostPatchSkill, new (Symbols.Octagon, Colors.LightBlue), "FrostPatch.C", "Casted Frost Patch", "Frost Patch Cast", Sev3, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic([JuttingIceSpikes1, JuttingIceSpikes2], new (Symbols.TriangleDown, Colors.LightGrey), "IceSpike.H", "Hit by Jutting Ice Spike", "Jutting Ice Spike Hit", Sev2, 0),
            new PlayerCastStartMechanic(FireSnowball, new (Symbols.TriangleUp, Colors.White), "Snowball.C", "Used SAK: Throw Snowball", "Threw Snowball", Sev2, 0),
            new EnemyDstBuffApplyMechanic(IcyBarrier, new (Symbols.Square, Colors.DarkBlue), "IcyBarrier.A", "Icy Barrier Applied", "Icy Barrier Application", Sev1, 0),
        ])
        );
        Extension = "freezie";
