...
internal class CosmicObservatory : SecretOfTheObscureRaidEncounter
{
    public CosmicObservatory(int triggerID) : base(triggerID)
    {
        MechanicList.Add( new MechanicGroup([
            ...
            new MechanicGroup([
                new MechanicGroup([
                    new AchievementEligibilityMechanic(Ach_DancedStars, new (Symbols.TriangleDownOpen, Colors.DarkBlue), "DancStars.Achiv.L", "Achievement Eligibility: Danced with the Stars Lost", "Danced with the Stars Lost", 0)
                            .UsingChecker((evt, log) => evt.Lost),
                    new AchievementEligibilityMechanic(Ach_DancedStars, new (Symbols.TriangleDownOpen, Colors.Blue), "DancStars.Achiv.K", "Achievement Eligibility: Danced with the Stars Kept", "Danced with the Stars Kept", 0)
                            .UsingChecker((evt, log) => !evt.Lost)
                ]),
                new PlayerDstHealthDamageHitMechanic([ SpinningNebulaCentral, SpinningNebulaWithTeleport ], new (Symbols.TriangleDown, Colors.DarkBlue), "Spin.Neb.H", "Spining Nebula Hit (Spin Projectiles)", "Spinning Nebula Hit", Sev0, 0),
                new EnemyCastStartMechanic([ SpinningNebulaCentral, SpinningNebulaWithTeleport ], new (Symbols.CircleCross, Colors.LightRed), "Spinning Nebula", "Spinning Nebula Cast", "Cast Spinning Nebula", Sev3, 0),
            ]),
            new PlayerDstHealthDamageHitMechanic(DemonicBlast, new (Symbols.TriangleUp, Colors.Red), "Dmn.Blst.H", "Demonic Blast Hit (Cones AoEs)", "Demonic Blast Hit", Sev1, 0),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SoulFeast, new (Symbols.Circle, Colors.DarkRed), "Sl.Fst.H", "Soul Feat (Pulsing Orb AoEs)", "Soul Feast Hit", Sev0, 0),
                new PlayerDstBuffApplyMechanic(Revealed, new (Symbols.Bowtie, Colors.Teal), "Sl.Fst.T", "Soul Feast Target", "Targeted by Soul Feast", Sev0, 0)
                    .UsingChecker((bae, log) => bae.CreditedBy.IsSpecies(TargetID.Dagda)),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(PlanetCrashProjectileSkill, new (Symbols.StarDiamond, Colors.White), "PlnCrhProj.H", "Planet Crash (Projectiles Hits)", "Planet Crash Projectiles Hit", Sev2, 0),
                new EnemyCastStartMechanic(PlanetCrashSkill, new (Symbols.Star, Colors.Blue), "Planet Crash", "Planet Crash Cast", "Cast Planet Crash", Sev3, 0),
                new EnemyDstBuffApplyMechanic(Exposed31589, new (Symbols.Star, Colors.LightBlue), "Planet Crash (Int)", "Interrupted Planet Crash", "Interrupted Planet Crash", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.Dagda)),
                new EnemySrcHealthDamageMechanic(PlanetCrashSkill, new (Symbols.Star, Colors.DarkBlue), "Planet Crash (Land)", "Planet Crash Landed", "Fully Casted Planet Crash", Sev0, 1000)
                    .UsingChecker((ahde, log) => ahde.HealthDamage >= 0 && ahde.To.IsPlayer),
            ]),
            new PlayerDstHealthDamageHitMechanic(ChargingConstellationDamage, new (Symbols.Star, Colors.White), "ChargCons.H", "Charging Constellation Hit", "Charging Constellation Hit", Sev2, 0),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(ShootingStarsTargetBuff, new (Symbols.TriangleDown, Colors.Green), "StarsTarg.A", "Shooting Stars Target (Green Arrow)", "Targeted by Shooting Stars", Sev1, 0),
                new EnemyCastStartMechanic(ShootingStars, new (Symbols.TriangleUp, Colors.Green), "Shooting Stars", "Shooting Stars Cast", "Cast Shooting Stars", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(ResidualAnxiety, new (Symbols.DiamondOpen, Colors.Red), "Rsdl.Anxty", "Residual Anxiety", "Residual Anxiety", Sev0, 0),
                new PlayerDstBuffApplyMechanic(CosmicObservatoryLostControlBuff, new (Symbols.Diamond, Colors.Red), "Lst.Ctrl", "Lost Control (10 stacks of Residual Anxiety)", "Lost Control", Sev0, 0),
            ]),
            new PlayerDstBuffApplyMechanic(DagdaSharedDestruction_MeteorCrash, new (Symbols.Circle, Colors.Green), "Shar.Des.T", "Targeted by Shared Destruction (Greens - Meteor Crash)", "Shared Destruction Target (Green - Meteor Crash)", Sev1, 0),
            ...
            new PlayerDstBuffApplyMechanic(ExtremeVulnerability, new (Symbols.X, Colors.DarkRed), "ExtVuln.A", "Applied Extreme Vulnerability", "Extreme Vulnerability Application", Sev0, 0),
            new MechanicGroup([
                new PlayerSrcBuffRemoveSingleFromMechanic(DagdaDemonicAura, new (Symbols.Bowtie, Colors.LightBlue), "DemAur.R", "Removed Stacks of Demonic Aura", "Demonic Aura Stacks Removed", Sev1),
                new EnemyDstBuffRemoveSingleMechanic(DagdaDemonicAura, new (Symbols.BowtieOpen, Colors.LightBlue), "DemAur.L", "Lost stacks of Demonic Aura", "Demonic Aura Stacks Lost", Sev0)
                    .UsingChecker((abre, log) => abre.CreditedBy.IsPlayer),
            ]),
            new MechanicGroup([
                new PlayerSrcHealthDamageMechanic(PurifyingLight, new (Symbols.Hourglass, Colors.LightBlue), "PurLight.C", "Casted Purifying Light", "Casted Purifying Light", Sev2, 0),
                new PlayerSrcHealthDamageHitMechanic(PurifyingLight, new (Symbols.HourglassOpen, Colors.LightBlue), "PurLight.Soul.C", "Casted Purifying Light (Hit Soul Feast)", "Purifying Light Hit Soul Feast", Sev1, 0)
                    .UsingChecker((ahde, log) => ahde.To.IsSpecies(TargetID.SoulFeast)),
                new PlayerSrcHealthDamageHitMechanic(PurifyingLight, new (Symbols.HourglassOpen, Colors.Blue), "PurLight.Dagda.C", "Casted Purifying Light (Hit Dagda)", "Purifying Light Hit Dagda", Sev0, 0)
                    .UsingChecker((ahde, log) => ahde.To.IsSpecies(TargetID.Dagda)),
            ]),
            new PlayerDstEffectMechanic(EffectGUIDs.CosmicObservatoryDemonicFever, new (Symbols.Circle, Colors.LightOrange), "DemFev.T", "Targeted by Demonic Fever (Orange Spread AoEs)", "Demonic Fever Target", Sev0, 0),
        ])
        );
