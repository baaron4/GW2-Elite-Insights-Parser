...
internal class FraenirOfJormag : Bjora
{
    public FraenirOfJormag(int triggerID) : base(triggerID)
    {
        MechanicList.Add(new MechanicGroup([      
            new PlayerDstHealthDamageHitMechanic(Icequake, new MechanicPlotlySetting(Symbols.Hexagram, Colors.Red), "Icequake", "Knocked by Icequake", "Icequake", MechanicSeverity.Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new PlayerDstHealthDamageHitMechanic(IceShockWaveFraenir, new MechanicPlotlySetting(Symbols.Square, Colors.Red), "Ice Shock Wave", "Knocked by Ice Shock Wave", "Ice Shock Wave", MechanicSeverity.Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new PlayerDstHealthDamageHitMechanic(IceArmSwingFraenir, new MechanicPlotlySetting(Symbols.Pentagon, Colors.Orange), "IceArmSwing.CC", "Knocked by Ice Arm Swing", "Ice Arm Swing", MechanicSeverity.Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new MechanicGroup([          
                new PlayerDstHealthDamageHitMechanic(FrozenMissile, new MechanicPlotlySetting(Symbols.BowtieOpen, Colors.Orange), "FrozenMissile.CC", "Launched by Frozen Missile", "Frozen Missile", MechanicSeverity.Sev0, 4000)
                    .UsingBuffChecker(Stability, false),
                new EnemyCastStartMechanic(FrozenMissile, new MechanicPlotlySetting(Symbols.BowtieOpen, Colors.LightOrange), "Frozen Missile", "Cast Frozen Missile", "Frozen Missile", MechanicSeverity.Sev2, 4000),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SeismicCrush, new MechanicPlotlySetting(Symbols.Circle, Colors.Orange), "SeismicCrush.CC", "Knocked by Seismic Crush", "Seismic Crush", MechanicSeverity.Sev0, 4000)
                    .UsingBuffChecker(Stability, false),
                new EnemyCastStartMechanic(SeismicCrush, new MechanicPlotlySetting(Symbols.Square, Colors.Purple), "Seismic Crush (Breakbar)", "Cast Seismic Crush & Breakbar", "Seismic Crush", MechanicSeverity.Sev2, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(FrigidFusillade, new MechanicPlotlySetting(Symbols.TriangleDown, Colors.Teal), "FrigidFusillade.H", "Hit by Frigid Fusillade (Fraenir Arrows)", "Frigid Fusillade", MechanicSeverity.Sev1, 0),
                new EnemyCastStartMechanic(FrigidFusillade, new MechanicPlotlySetting(Symbols.TriangleDown, Colors.DarkTeal), "Frigid Fusillade", "Cast Frigid Fusillade", "Frigid Fusillade", MechanicSeverity.Sev2, 0),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Frozen, new MechanicPlotlySetting(Symbols.Circle, Colors.Blue), "Frozen", "Frozen", "Frozen", MechanicSeverity.Sev0, 500),
                new PlayerDstBuffRemoveMechanic(Frozen, new MechanicPlotlySetting(Symbols.CircleOpen, Colors.Blue), "Unfrozen", "Unfrozen", "Unfrozen", MechanicSeverity.Sev0, 500),
            ]),
            new PlayerDstBuffApplyMechanic(Snowblind, new MechanicPlotlySetting(Symbols.Square, Colors.Blue), "Snowblind", "Snowblind", "Snowblind", MechanicSeverity.Sev1, 500),
        ])
        );
        Extension = "fraenir";
