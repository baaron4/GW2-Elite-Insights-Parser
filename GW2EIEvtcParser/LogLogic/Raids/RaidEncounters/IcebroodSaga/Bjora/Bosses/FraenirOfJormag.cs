...
internal class FraenirOfJormag : Bjora
{
    public FraenirOfJormag(int triggerID) : base(triggerID)
    {
        MechanicList.Add(new MechanicGroup([      
            new PlayerDstHealthDamageHitMechanic(Icequake, new (Symbols.Hexagram, Colors.Red), "Icequake", "Knocked by Icequake", "Icequake", Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new PlayerDstHealthDamageHitMechanic(IceShockWaveFraenir, new (Symbols.Square, Colors.Red), "Ice Shock Wave", "Knocked by Ice Shock Wave", "Ice Shock Wave", Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new PlayerDstHealthDamageHitMechanic(IceArmSwingFraenir, new (Symbols.Pentagon, Colors.Orange), "IceArmSwing.CC", "Knocked by Ice Arm Swing", "Ice Arm Swing", Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new MechanicGroup([          
                new PlayerDstHealthDamageHitMechanic(FrozenMissile, new (Symbols.BowtieOpen, Colors.Orange), "FrozenMissile.CC", "Launched by Frozen Missile", "Frozen Missile", Sev0, 4000)
                    .UsingBuffChecker(Stability, false),
                new EnemyCastStartMechanic(FrozenMissile, new (Symbols.BowtieOpen, Colors.LightOrange), "Frozen Missile", "Cast Frozen Missile", "Frozen Missile", Sev3, 4000),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SeismicCrush, new (Symbols.Circle, Colors.Orange), "SeismicCrush.CC", "Knocked by Seismic Crush", "Seismic Crush", Sev0, 4000)
                    .UsingBuffChecker(Stability, false),
                new EnemyCastStartMechanic(SeismicCrush, new (Symbols.Square, Colors.Purple), "Seismic Crush (Breakbar)", "Cast Seismic Crush & Breakbar", "Seismic Crush", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(FrigidFusillade, new (Symbols.TriangleDown, Colors.Teal), "FrigidFusillade.H", "Hit by Frigid Fusillade (Fraenir Arrows)", "Frigid Fusillade", Sev2, 0),
                new EnemyCastStartMechanic(FrigidFusillade, new (Symbols.TriangleDown, Colors.DarkTeal), "Frigid Fusillade", "Cast Frigid Fusillade", "Frigid Fusillade", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Frozen, new (Symbols.Circle, Colors.Blue), "Frozen", "Frozen", "Frozen", Sev0, 500),
                new PlayerDstBuffRemoveMechanic(Frozen, new (Symbols.CircleOpen, Colors.Blue), "Unfrozen", "Unfrozen", "Unfrozen", Sev1, 500),
            ]),
            new PlayerDstBuffApplyMechanic(Snowblind, new (Symbols.Square, Colors.Blue), "Snowblind", "Snowblind", "Snowblind", Sev1, 500),
        ])
        );
        Extension = "fraenir";
