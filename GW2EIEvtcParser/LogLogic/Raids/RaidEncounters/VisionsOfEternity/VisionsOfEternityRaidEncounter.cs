...
internal abstract class VisionsOfEternityRaidEncounter : RaidEncounterLogic
{
    public VisionsOfEternityRaidEncounter(int triggerID) : base(triggerID)
    {
        LogCategoryInformation.SubCategory = SubLogCategory.VisionsOfEternity;
