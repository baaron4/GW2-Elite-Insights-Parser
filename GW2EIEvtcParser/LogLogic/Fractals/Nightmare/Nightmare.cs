...
internal abstract class Nightmare : FractalLogic
{
    public Nightmare(int triggerID) : base(triggerID)
    {
        ...
        MechanicList.Add(new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic([CascadeOfTorment1, CascadeOfTorment2], new MechanicPlotlySetting(Symbols.CircleOpen,Colors.LightOrange), "Rings", "Cascade of Torment (Alternating Rings)","Rings", MechanicSeverity.Sev0, 0),
        ]));
    }
