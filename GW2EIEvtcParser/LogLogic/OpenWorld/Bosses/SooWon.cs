...
internal class SooWon : OpenWorldLogic
{
    public SooWon(int triggerID) : base(triggerID)
    {
        ...
        new PlayerDstHealthDamageHitMechanic(TsunamiSlamOW, new MechanicPlotlySetting(Symbols.TriangleDown,Colors.DarkRed), "Slam", "Soo-Won slams the ground in front of her creating a circular tsunami", "Tsunami Slam", MechanicSeverity.P1, 0),
        new PlayerDstHealthDamageHitMechanic(VoidPurgeOW, new MechanicPlotlySetting(Symbols.Circle,Colors.DarkPurple), "Acid", "Player took damage from an acid pool", "Acid Pool", MechanicSeverity.P1, 0),
        new PlayerDstHealthDamageMechanic(ClawSlapOW, new MechanicPlotlySetting(Symbols.TriangleUp,Colors.Orange), "Claw Slap", "Soo-Won swipes in an arc in front of her knocking players back", "Claw Slap", MechanicSeverity.P0, 0)
            .UsingChecker((de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant) ^ de.HasDowned ^ de.HasKilled),
        new PlayerDstHealthDamageHitMechanic(TailSlap, new MechanicPlotlySetting(Symbols.Square,Colors.Orange), "Tail Slap", "Soo-Won slaps the majority of the platform, opposite her head, with her tail", "Tail Slap", MechanicSeverity.P1, 0),
        new PlayerDstHealthDamageHitMechanic(BiteOW, new MechanicPlotlySetting(Symbols.Diamond,Colors.Orange), "Bite", "Soo-Won bites half the platform while swapping sides", "Bite", MechanicSeverity.P1, 0),
        new MechanicGroup([

            new PlayerDstHealthDamageMechanic(NightmareDevastationOW1, new MechanicPlotlySetting(Symbols.Square,Colors.Purple), "Wave (Half)", "Tidal wave that covers one half of the platform", "Tidal Wave (Half)", MechanicSeverity.P0, 0),
            new PlayerDstHealthDamageMechanic(NightmareDevastationOW2, new MechanicPlotlySetting(Symbols.Square,Colors.DarkPurple), "Wave (Full)", "Tidal wave that covers the entire platform", "Tidal Wave (Full)", MechanicSeverity.P0, 0),
        ]),
        new PlayerDstBuffApplyMechanic(WispForm, new MechanicPlotlySetting(Symbols.Circle,Colors.Green), "Wisp", "Wisp Form from standing in a green circle", "Wisp Form", MechanicSeverity.P1, 0),
        new PlayerDstHealthDamageMechanic(SeveredFromBody, new MechanicPlotlySetting(Symbols.Circle,Colors.Red), "Failed Green", "Player failed to return to the top of the Harvest Temple after becoming a wisp", "Failed Green", MechanicSeverity.P0, 0).UsingChecker((de, log) => de.HasKilled),
        new MechanicGroup([
            new PlayerDstBuffApplyMechanic(Drown1, new MechanicPlotlySetting(Symbols.Circle,Colors.LightBlue), "Bubble", "Player was trapped in a bubble by Soo-Won's Tail", "Bubble", MechanicSeverity.P1, 0),
            new PlayerDstBuffApplyMechanic(Drown2, new MechanicPlotlySetting(Symbols.Circle,Colors.DarkTeal), "Whirlpool", "Player was trapped in a whirlpool", "Whirlpool", MechanicSeverity.P1, 0),
        ]),
        new MechanicGroup([
            new EnemyDstBuffApplyMechanic(HardenedShell, new MechanicPlotlySetting(Symbols.DiamondWide, Colors.DarkTeal), "Tail", "Soo-Won's Tail spawned", "Tail", MechanicSeverity.P1, 0),
            new EnemyDstBuffRemoveMechanic(HardenedShell, new MechanicPlotlySetting(Symbols.DiamondWide, Colors.DarkGreen), "Tail Killed", "Soo-Won's Tail killed", "Tail Killed", MechanicSeverity.P0, 0)
                .UsingChecker((bre, log) => !bre.To.HasBuff(log, Invulnerability757, bre.Time - ParserHelper.ServerDelayConstant + 500)),
            new EnemyDstBuffRemoveMechanic(HardenedShell, new MechanicPlotlySetting(Symbols.DiamondWide, Colors.Yellow), "Tail Despawned", "Soo-Won's Tail despawned due to phase change", "Tail Despawned", MechanicSeverity.P0, 0)
                .UsingChecker((bre, log) => bre.To.HasBuff(log, Invulnerability757, bre.Time - ParserHelper.ServerDelayConstant + 500)),
        ]),
        new EnemyDstBuffApplyMechanic(DamageImmunity1, new MechanicPlotlySetting(Symbols.Diamond, Colors.Pink), "Side Swap", "Soo-Won breifly becomes invulnerable and switches sides of the arena", "Side Swap", MechanicSeverity.P2, 0),
        new EnemyDstBuffApplyMechanic(OldExposed, new MechanicPlotlySetting(Symbols.DiamondTall, Colors.DarkGreen), "CCed", "Breakbar successfully broken", "CCed", MechanicSeverity.P0, 0)
