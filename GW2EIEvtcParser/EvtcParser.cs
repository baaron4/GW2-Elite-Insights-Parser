...
namespace GW2EIEvtcParser
{
    public class EvtcParser
    {
        ...
        private void CompleteAgents()
        {
            ...
            _allAgentsList.RemoveAll(x => !(x.InstID != 0 && x.LastAware - x.FirstAware >= 0 && x.FirstAware != 0 && x.LastAware != long.MaxValue) && (x.Type != AgentItem.AgentType.Player && x.Type != AgentItem.AgentType.NonSquadPlayers));
