...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Artsariiv : ShatteredObservatory
    {
        public Artsariiv(int triggerID) : base(triggerID)
        {
            ...
            {
            new PlayerBuffApplyMechanic(CorporealReassignment, "Corporeal Reassignment", new MechanicPlotlySetting("diamond-tall",Colors.Red), "Skull","Exploding Skull mechanic application","Corporeal Reassignment",0),
            new HitOnPlayerMechanic(Vault, "Vault", new MechanicPlotlySetting("triangle-down-open",Colors.Yellow), "Vault","Vault from Big Adds", "Vault (Add)",0),
            new HitOnPlayerMechanic(SlamArtsariiv, "Slam", new MechanicPlotlySetting("circle",Colors.LightOrange), "Slam","Slam (Vault) from Boss", "Vault (Arts)",0),
            new HitOnPlayerMechanic(TeleportLunge, "Teleport Lunge", new MechanicPlotlySetting("star-triangle-down-open",Colors.LightOrange), "3 Jump","Triple Jump Mid->Edge", "Triple Jump",0),
            new HitOnPlayerMechanic(AstralSurge, "Astral Surge", new MechanicPlotlySetting("circle-open",Colors.Yellow), "Floor Circle","Different sized spiraling circles", "1000 Circles",0),
            new HitOnPlayerMechanic(new long[] { RedMarble1, RedMarble2 }, "Red Marble", new MechanicPlotlySetting("circle",Colors.Red), "Marble","Red KD Marble after Jump", "Red Marble",0),
            ...
            new SpawnMechanic((int)ArcDPSEnums.TrashID.Spark, "Spark", new MechanicPlotlySetting("star",Colors.Teal),"Spark","Spawned a Spark (missed marble)", "Spark",0),
            });
            Extension = "arts";
