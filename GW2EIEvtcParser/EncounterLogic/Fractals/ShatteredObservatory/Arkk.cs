...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Arkk : ShatteredObservatory
    {
        public Arkk(int triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(RollingChaos, "Rolling Chaos", new MechanicPlotlySetting(Symbols.Circle,Colors.LightRed), "KD Marble","Rolling Chaos (Arrow marble)", "KD Marble",0),
