    ...
    internal class Skorvald : ShatteredObservatory
    {
        ...
        internal override long GetFightOffset(FightData fightData, AgentData agentData, List<CombatItem> combatData)
        {
            ...
            if (logStartNPCUpdate != null)
            {
                ...
                CombatItem firstNonZeroHPUpdate = combatData.FirstOrDefault(x => x.IsStateChange == ArcDPSEnums.StateChange.HealthUpdate && x.SrcMatchesAgent(skorvald) && x.DstAgent > 0 && x.Time <= logStartNPCUpdate.Time + ParserHelper.ServerDelayConstant);
