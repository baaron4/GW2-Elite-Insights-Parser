...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class AiKeeperOfThePeak : FractalLogic
    {
        ...
        public AiKeeperOfThePeak(int triggerID) : base(triggerID)
        {
            ...
            {
                // General
                new HitOnPlayerMechanic(61463, "Elemental Whirl", new MechanicPlotlySetting("square",Colors.LightRed), "Ele.Whrl.","Elemental Whirl", "Elemental Whirl",0),
                // Air
            new HitOnPlayerMechanic(new long[] {61574, 61534, 61196 }, "Elemental Manipulation (Air)", new MechanicPlotlySetting("square",Colors.Magenta), "Ar.Mnp.","Elemental Manipulation (Air)", "Elemental Manipulation (Air)",0),
            new HitOnPlayerMechanic(new long[] {61487, 61565 }, "Fulgor Sphere", new MechanicPlotlySetting("circle",Colors.Magenta), "Flg.Sph.","Fulgor Sphere", "Fulgor Sphere",0),
            new HitOnPlayerMechanic(61470, "Volatile Wind", new MechanicPlotlySetting("triangle-left",Colors.Magenta), "Vlt.Wnd.","Volatile Wind", "Volatile Wind",0),
            new HitOnPlayerMechanic(61205, "Wind Burst", new MechanicPlotlySetting("triangle-down-open",Colors.Magenta), "Wnd.Brst.","Wind Burst", "Wind Burst",0),
            new HitOnPlayerMechanic(61205, "Wind Burst Launch", new MechanicPlotlySetting("triangle-down",Colors.Magenta), "L.Wnd.Burst","Launched up by Wind Burst", "Wind Burst Launch",0,(de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(61190 , "Call of Storms", new MechanicPlotlySetting("triangle-up",Colors.Magenta), "Call.Strs","Call of Storms", "Call of Storms",0),
            new EnemyBuffApplyMechanic(WhirlwindShield, "Whirlwind Shield",new MechanicPlotlySetting("asterisk-open",Colors.Magenta), "W.Shield" ,"Whirlwind Shield","Whirlwind Shield",0),
            // Fire
            new HitOnPlayerMechanic(new long[] {61279, 61256, 61271 }, "Elemental Manipulation (Fire)", new MechanicPlotlySetting("square",Colors.Orange), "Fr.Mnp.","Elemental Manipulation (Fire)", "Elemental Manipulation (Fire)",0),
            new HitOnPlayerMechanic(new long[] {61273, 61582 }, "Roiling Flames", new MechanicPlotlySetting("circle",Colors.Orange), "Rlng.Flms.","Roiling Flames", "Roiling Flames",0),
            new HitOnPlayerMechanic(61548, "Volatile Fire", new MechanicPlotlySetting("triangle-left",Colors.Orange), "Vlt.Fr.","Volatile Fire", "Volatile Fire",0),
            new SkillOnPlayerMechanic(61348, "Call Meteor", new MechanicPlotlySetting("hexagram",Colors.Orange), "Mtr.H","Hit by Meteor", "Meteor Hit",1000, (evt, log) => evt.HasDowned || evt.HasKilled),
            new HitOnPlayerMechanic(61248, "Flame Burst", new MechanicPlotlySetting("triangle-down",Colors.Orange), "Flm.Brst.","Flame Burst", "Flame Burst",0),
            new HitOnPlayerMechanic(61445, "Firestorm", new MechanicPlotlySetting("triangle-up",Colors.Orange), "Fr.Strm","Firestorm", "Firestorm",0),
            new EnemyCastStartMechanic(61439, "Call Meteor", new MechanicPlotlySetting("asterisk-open",Colors.Orange), "Smn.Meteor", "Summoned Meteor", "Summon Meteor", 0),
            // Water
            new HitOnPlayerMechanic(new long[] {61172, 61207, 61556 }, "Elemental Manipulation (Water)", new MechanicPlotlySetting("square",Colors.LightBlue), "Wtr.Mnp.","Elemental Manipulation (Water)", "Elemental Manipulation (Water)",0),
            new HitOnPlayerMechanic(new long[] {61556, 61177 }, "Torrential Bolt", new MechanicPlotlySetting("circle",Colors.LightBlue), "Tr.Blt.","Torrential Bolt", "Torrential Bolt",0),
            new HitOnPlayerMechanic(61419, "Volatile Water", new MechanicPlotlySetting("triangle-left",Colors.LightBlue), "Vlt.Wtr.","Volatile Water", "Volatile Water",0),
            new HitOnPlayerMechanic(61251, "Aquatic Burst", new MechanicPlotlySetting("triangle-down",Colors.LightBlue), "Aq.Brst.","Aquatic Burst", "Aquatic Burst",0),
            new EnemyBuffApplyMechanic(TidalBarrier, "Tidal Barrier", new MechanicPlotlySetting("asterisk-open",Colors.LightBlue), "Tdl.Bar.", "Tidal Barrier", "Tidal Barrier", 0),
            new PlayerBuffApplyMechanic(TidalBargain, "Tidal Bargain", new MechanicPlotlySetting("star-open",Colors.LightBlue), "Tdl.Brgn.","Downed by Tidal Bargain", "Tidal Bargain",0),
            new PlayerBuffRemoveMechanic(TidalBargain, "Tidal Bargain Downed", new MechanicPlotlySetting("star",Colors.LightBlue), "Tdl.Brgn.Dwn.","Downed by Tidal Bargain", "Tidal Bargain Downed",0, (evt, log) => evt.RemovedStacks == 10 && Math.Abs(evt.RemovedDuration - 90000) < 10 * ParserHelper.ServerDelayConstant && log.CombatData.GetBuffData(Downed).Any(x => Math.Abs(x.Time - evt.Time) < 50 && x is BuffApplyEvent bae && bae.To == evt.To)),
            // Dark
            new HitOnPlayerMechanic(new long[] {61602, 61606, 61604, 61508, 61217, 61529, 61260, 61600, 61527 }, "Empathic Manipulation", new MechanicPlotlySetting("square",Colors.LightPurple), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(new long[] {61344, 61499 }, "Focused Wrath", new MechanicPlotlySetting("circle",Colors.LightPurple), "Fcsd.Wrth.","Focused Wrath", "Focused Wrath",0),
            new HitOnPlayerMechanic(61289, "Negative Burst", new MechanicPlotlySetting("diamond-wide",Colors.LightPurple), "N.Brst.","Negative Burst", "Negative Burst",500),
            new HitOnPlayerMechanic(61184, "Terrorstorm", new MechanicPlotlySetting("diamond-tall",Colors.LightPurple), "TrrStrm","Terrorstorm", "Terrorstorm",0),
            new PlayerBuffApplyMechanic(CrushingGuilt, "Crushing Guilt", new MechanicPlotlySetting("star-open",Colors.LightPurple), "Crsh.Glt.","Crushing Guilt", "Crushing Guilt",0),
            new PlayerBuffRemoveMechanic(CrushingGuilt, "Crushing Guilt Down", new MechanicPlotlySetting("star",Colors.LightPurple), "Crsh.Glt.Dwn.","Downed by Crushing Guilt", "Crushing Guilt Down",0, (evt, log) => evt.RemovedStacks == 10 && Math.Abs(evt.RemovedDuration - 90000) < 10 * ParserHelper.ServerDelayConstant && log.CombatData.GetBuffData(Downed).Any(x => Math.Abs(x.Time - evt.Time) < 50 && x is BuffApplyEvent bae && bae.To == evt.To)),
            new EnemyCastStartMechanic(61508, "Empathic Manipulation (Fear)", new MechanicPlotlySetting("triangle-up",Colors.LightPurple), "Fear Mnp.", "Empathic Manipulation (Fear)", "Empathic Manipulation (Fear)", 0),
            new EnemyCastEndMechanic(61508, "Empathic Manipulation (Fear) Interrupt", new MechanicPlotlySetting("triangle-up-open",Colors.LightPurple), "IntFear.Mnp.", "Empathic Manipulation (Fear) Interrupt", "Empathic Manipulation (Fear) Interrupt", 0, (evt, log) => evt is AnimatedCastEvent ace && ace.Status == AbstractCastEvent.AnimationStatus.Interrupted),
            new EnemyCastStartMechanic(61606, "Empathic Manipulation (Sorrow)", new MechanicPlotlySetting("triangle-left",Colors.LightPurple), "Sor.Mnp.", "Empathic Manipulation (Sorrow)", "Empathic Manipulation (Sorrow)", 0),
            new EnemyCastEndMechanic(61606, "Empathic Manipulation (Sorrow) Interrupt", new MechanicPlotlySetting("triangle-left-open",Colors.LightPurple), "IntSor.Mnp.", "Empathic Manipulation (Sorrow) Interrupt", "Empathic Manipulation (Sorrow) Interrupt", 0, (evt, log) => evt is AnimatedCastEvent ace && ace.Status == AbstractCastEvent.AnimationStatus.Interrupted),
            new EnemyCastStartMechanic(61602, "Empathic Manipulation (Guilt)", new MechanicPlotlySetting("triangle-right",Colors.LightPurple), "Glt.Mnp.", "Empathic Manipulation (Guilt)", "Empathic Manipulation (Guilt)", 0),
            new EnemyCastEndMechanic(61602, "Empathic Manipulation (Guilt) Interrupt", new MechanicPlotlySetting("triangle-right-open",Colors.LightPurple), "Int.Glt.Mnp.", "Empathic Manipulation (Guilt) Interrupt", "Empathic Manipulation (Guilt) Interrupt", 0, (evt, log) => evt is AnimatedCastEvent ace && ace.Status == AbstractCastEvent.AnimationStatus.Interrupted),
            new EnemyBuffApplyMechanic(CacophonousMind, "Cacophonous Mind", new MechanicPlotlySetting("pentagon",Colors.LightPurple), "Ccphns.Mnd.","Cacophonous Mind", "Cacophonous Mind",0),
            });
            Extension = "ai";
