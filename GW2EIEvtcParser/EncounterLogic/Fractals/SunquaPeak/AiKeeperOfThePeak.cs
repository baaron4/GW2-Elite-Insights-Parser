...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class AiKeeperOfThePeak : FractalLogic
    {
        ...
        public AiKeeperOfThePeak(int triggerID) : base(triggerID)
        {
            ...
            //new HitOnPlayerMechanic(, "Volatile Wind", new MechanicPlotlySetting("triangle-left","rgb(255,0,255)"), "Vlt.Wnd.","Volatile Wind", "Volatile Wind",0),
            ...
            //new HitOnPlayerMechanic(, "Call of Storms", new MechanicPlotlySetting("triangle-up","rgb(255,0,255)"), "Call Strs","Call of Storms", "Call of Storms",0),
            ...
            //new HitOnPlayerMechanic(, "Volatile Fire", new MechanicPlotlySetting("triangle-left","rgb(255,125,0)"), "Vlt.Fr.","Volatile Fire", "Volatile Fire",0),
            ...
            //new HitOnPlayerMechanic(, "Firestorm", new MechanicPlotlySetting("triangle-up","rgb(255,125,0)"), "Fr.Strm","Firestorm", "Firestorm",0, (evt, log) => evt.HasKilled),
            ...
            //new HitOnPlayerMechanic(, "Volatile Water", new MechanicPlotlySetting("triangle-left","rgb(0,125,255)"), "Vlt.Wtr.","Volatile Water", "Volatile Water",0),
