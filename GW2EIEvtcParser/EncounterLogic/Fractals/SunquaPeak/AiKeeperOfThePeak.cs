    ...
    internal class AiKeeperOfThePeak : FractalLogic
    {
        ...
        public AiKeeperOfThePeak(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                // Air
            new HitOnPlayerMechanic(new long[] {61574, 61534, 61196 }, "Elemental Manipulation (Air)", new MechanicPlotlySetting("square","rgb(255,0,255)"), "Ar.Mnp.","Elemental Manipulation (Air)", "Elemental Manipulation (Air)",0),
            new HitOnPlayerMechanic(new long[] {61487, 61565 }, "Fulgor Sphere", new MechanicPlotlySetting("circle","rgb(255,0,255)"), "Flg.Sph.","Fulgor Sphere", "Fulgor Sphere",0),
            ...
            // Fire
            new HitOnPlayerMechanic(new long[] {61279, 61256, 61271 }, "Elemental Manipulation (Fire)", new MechanicPlotlySetting("square","rgb(255,125,0)"), "Fr.Mnp.","Elemental Manipulation (Fire)", "Elemental Manipulation (Fire)",0),
            new HitOnPlayerMechanic(new long[] {61273, 61582 }, "Roiling Flames", new MechanicPlotlySetting("circle","rgb(255,125,0)"), "Rlng.Flms.","Roiling Flames", "Roiling Flames",0),
            ...
            // Water
            new HitOnPlayerMechanic(new long[] {61172, 61207, 61556 }, "Elemental Manipulation (Water)", new MechanicPlotlySetting("square","rgb(0,125,255)"), "Wtr.Mnp.","Elemental Manipulation (Water)", "Elemental Manipulation (Water)",0),
            new HitOnPlayerMechanic(new long[] {61556, 61177 }, "Torrential Bolt", new MechanicPlotlySetting("circle","rgb(0,125,255)"), "Tr.Blt.","Torrential Bolt", "Torrential Bolt",0),
            ...
            // Dark
            new HitOnPlayerMechanic(new long[] {61602, 61606, 61604, 61508, 61217, 61529, 61260, 61600, 61527 }, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(new long[] {61344, 61499 }, "Focused Wrath", new MechanicPlotlySetting("circle","rgb(150,125,255)"), "Fcsd.Wrth.","Focused Wrath", "Focused Wrath",0),
