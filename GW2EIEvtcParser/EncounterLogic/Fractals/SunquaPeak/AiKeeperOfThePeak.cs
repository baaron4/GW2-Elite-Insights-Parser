    ...
    internal class AiKeeperOfThePeak : FractalLogic
    {
        ...
        public AiKeeperOfThePeak(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                // Air
            new HitOnPlayerMechanic(61574, "Elemental Manipulation (Air)", new MechanicPlotlySetting("square","rgb(255,0,255)"), "Ar.Mnp.","Elemental Manipulation (Air)", "Elemental Manipulation (Air)",0),
            new HitOnPlayerMechanic(61534, "Elemental Manipulation (Air)", new MechanicPlotlySetting("square","rgb(255,0,255)"), "Ar.Mnp.","Elemental Manipulation (Air)", "Elemental Manipulation (Air)",0),
            new HitOnPlayerMechanic(61196, "Elemental Manipulation (Air)", new MechanicPlotlySetting("square","rgb(255,0,255)"), "Ar.Mnp.","Elemental Manipulation (Air)", "Elemental Manipulation (Air)",0),
            ...
            new HitOnPlayerMechanic(61205, "Wind Burst Launch", new MechanicPlotlySetting("triangle-down","rgb(255,0,255)"), "L.Wnd.Burst","Launched up by Wind Burst", "Wind Burst Launch",0,(de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            ...
            new EnemyBuffApplyMechanic(WhirlwindShield, "Whirlwind Shield",new MechanicPlotlySetting("asterisk-open","rgb(255,0,255)"), "W.Shield" ,"Whirlwind Shield","Whirlwind Shield",0),
            // Fire
            new HitOnPlayerMechanic(61279, "Elemental Manipulation (Fire)", new MechanicPlotlySetting("square","rgb(255,125,0)"), "Fr.Mnp.","Elemental Manipulation (Fire)", "Elemental Manipulation (Fire)",0),
            new HitOnPlayerMechanic(61256, "Elemental Manipulation (Fire)", new MechanicPlotlySetting("square","rgb(255,125,0)"), "Fr.Mnp.","Elemental Manipulation (Fire)", "Elemental Manipulation (Fire)",0),
            new HitOnPlayerMechanic(61271, "Elemental Manipulation (Fire)", new MechanicPlotlySetting("square","rgb(255,125,0)"), "Fr.Mnp.","Elemental Manipulation (Fire)", "Elemental Manipulation (Fire)",0),
            ...
            new SkillOnPlayerMechanic(61348, "Call Meteor", new MechanicPlotlySetting("hexagram","rgb(255,125,0)"), "Mtr.H","Hit by Meteor", "Meteor Hit",1000, (evt, log) => evt.HasDowned || evt.HasKilled),
            ...
            // Water
            new HitOnPlayerMechanic(61172, "Elemental Manipulation (Water)", new MechanicPlotlySetting("square","rgb(0,125,255)"), "Wtr.Mnp.","Elemental Manipulation (Water)", "Elemental Manipulation (Water)",0),
            new HitOnPlayerMechanic(61207, "Elemental Manipulation (Water)", new MechanicPlotlySetting("square","rgb(0,125,255)"), "Wtr.Mnp.","Elemental Manipulation (Water)", "Elemental Manipulation (Water)",0),
            new HitOnPlayerMechanic(61556, "Elemental Manipulation (Water)", new MechanicPlotlySetting("square","rgb(0,125,255)"), "Wtr.Mnp.","Elemental Manipulation (Water)", "Elemental Manipulation (Water)",0),
            new HitOnPlayerMechanic(61556, "Torrential Bolt", new MechanicPlotlySetting("circle","rgb(0,125,255)"), "Tr.Blt.","Torrential Bolt", "Torrential Bolt",0),
            new HitOnPlayerMechanic(61177, "Torrential Bolt", new MechanicPlotlySetting("circle","rgb(0,125,255)"), "Tr.Blt.","Torrential Bolt", "Torrential Bolt",0),
            ...
            new EnemyBuffApplyMechanic(TidalBarrier, "Tidal Barrier", new MechanicPlotlySetting("asterisk-open","rgb(0,125,255)"), "Tdl.Bar.", "Tidal Barrier", "Tidal Barrier", 0),
            new PlayerBuffApplyMechanic(TidalBargain, "Tidal Bargain", new MechanicPlotlySetting("star-open","rgb(0,125,255)"), "Tdl.Brgn.","Downed by Tidal Bargain", "Tidal Bargain",0),
            new PlayerBuffRemoveMechanic(TidalBargain, "Tidal Bargain Downed", new MechanicPlotlySetting("star","rgb(0,125,255)"), "Tdl.Brgn.Dwn.","Downed by Tidal Bargain", "Tidal Bargain Downed",0, (evt, log) => evt.RemovedStacks == 10 && Math.Abs(evt.RemovedDuration - 90000) < 10 * ParserHelper.ServerDelayConstant && log.CombatData.GetBuffData(Downed).Any(x => Math.Abs(x.Time - evt.Time) < 50 && x is BuffApplyEvent bae && bae.To == evt.To)),
            // Dark
            ...
            new HitOnPlayerMechanic(61604, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61508, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61217, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61529, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61260, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61600, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            new HitOnPlayerMechanic(61527, "Empathic Manipulation", new MechanicPlotlySetting("square","rgb(150,125,255)"), "Emp.Mnp.","Empathic Manipulation", "Empathic Manipulation",0),
            ...
            new EnemyCastEndMechanic(61606, "Empathic Manipulation (Sorrow) Interrupt", new MechanicPlotlySetting("triangle-left-open","rgb(150,125,255)"), "IntSor.Mnp.", "Empathic Manipulation (Sorrow) Interrupt", "Empathic Manipulation (Sorrow) Interrupt", 0, (evt, log) => evt is AnimatedCastEvent ace && ace.Status == AbstractCastEvent.AnimationStatus.Interrupted),
            new EnemyCastStartMechanic(61602, "Empathic Manipulation (Guilt)", new MechanicPlotlySetting("triangle-right","rgb(150,125,255)"), "Glt.Mnp.", "Empathic Manipulation (Guilt)", "Empathic Manipulation (Guilt)", 0),
            new EnemyCastEndMechanic(61602, "Empathic Manipulation (Guilt) Interrupt", new MechanicPlotlySetting("triangle-right-open","rgb(150,125,255)"), "Int.Glt.Mnp.", "Empathic Manipulation (Guilt) Interrupt", "Empathic Manipulation (Guilt) Interrupt", 0, (evt, log) => evt is AnimatedCastEvent ace && ace.Status == AbstractCastEvent.AnimationStatus.Interrupted),
            new EnemyBuffApplyMechanic(CacophonousMind, "Cacophonous Mind", new MechanicPlotlySetting("pentagon","rgb(150,125,255)"), "Ccphns.Mnd.","Cacophonous Mind", "Cacophonous Mind",0),
            });
            Extension = "ai";
