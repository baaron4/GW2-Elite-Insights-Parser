...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal abstract class FractalLogic : FightLogic
    {
        protected FractalLogic(int triggerID) : base(triggerID)
        {
            ...
            {
            new PlayerBuffApplyMechanic(FluxBombEffect, "Flux Bomb", new MechanicPlotlySetting("circle",Colors.Purple,10), "Flux","Flux Bomb application", "Flux Bomb",0),
            new HitOnPlayerMechanic(FluxBombSkill, "Flux Bomb", new MechanicPlotlySetting("circle-open",Colors.Purple,10), "Flux dmg","Flux Bomb hit", "Flux Bomb dmg",0),
            new SpawnMechanic((int)ArcDPSEnums.TrashID.FractalVindicator, "Fractal Vindicator", new MechanicPlotlySetting("star-diamond-open",Colors.Black,10), "Vindicator","Fractal Vindicator spawned", "Vindicator spawn",0),
            });
