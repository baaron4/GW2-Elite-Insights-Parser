...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class ConjuredAmalgamate : MythwrightGambit
    {
        ...
        public ConjuredAmalgamate(int triggerID) : base((int)ArcDPSEnums.TargetID.ConjuredAmalgamate)
        {
            ...
            {
            new HitOnPlayerMechanic(52173, "Pulverize", new MechanicPlotlySetting("square",Colors.LightOrange), "Arm Slam","Pulverize (Arm Slam)", "Arm Slam",0, (de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(52173, "Pulverize", new MechanicPlotlySetting("square-open",Colors.LightOrange), "Stab.Slam","Pulverize (Arm Slam) while affected by stability", "Stabilized Arm Slam",0,(de, log) => de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            ...
            new HitOnPlayerMechanic(new long[] {52878, 52120 }, "Junk Fall", new MechanicPlotlySetting("circle-open",Colors.Pink), "Junk","Junk Fall (Falling Debris)", "Junk Fall",0),
            ...
            new PlayerBuffApplyMechanic(GreatswordPower, "Greatsword Power", new MechanicPlotlySetting("diamond-tall",Colors.Red), "Sword.C","Collected Sword", "Sword Collect",50),
            new PlayerBuffApplyMechanic(ConjuredShield, "Conjured Shield", new MechanicPlotlySetting("diamond-tall",Colors.Green), "Shield.C","Collected Shield", "Shield Collect",50),
            new EnemyBuffApplyMechanic(AugmentedPower, "Augmented Power", new MechanicPlotlySetting("asterisk-open",Colors.Red), "Augmented Power","Augmented Power", "Augmented Power",50),
            new EnemyBuffApplyMechanic(Shielded, "Shielded", new MechanicPlotlySetting("asterisk-open",Colors.Green), "Shielded","Shielded", "Shielded",50),
            });
