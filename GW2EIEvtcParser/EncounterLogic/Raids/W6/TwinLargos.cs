...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class TwinLargos : MythwrightGambit
    {
        public TwinLargos(int triggerID) : base(triggerID)
        {
            ...
            {
            new PlayerBuffApplyMechanic(Waterlogged, "Waterlogged", new MechanicPlotlySetting("hexagon-open",Colors.LightBlue), "Debuff","Waterlogged (stacking water debuff)", "Waterlogged",0),
            ...
            new PlayerBuffApplyMechanic(TidalPool, "Tidal Pool", new MechanicPlotlySetting("diamond",Colors.Teal), "Poison","Expanding Water Field", "Water Poison",0),
            new HitOnPlayerMechanic(AquaticDetainment, "Aquatic Detainment", new MechanicPlotlySetting("circle-open",Colors.Blue), "Float","Aquatic Detainment (Float Bubble)", "Float Bubble",6000),
            ...
            new EnemyBuffApplyMechanic(EnragedTwinLargos, "Enraged", new MechanicPlotlySetting("star-diamond",Colors.Red), "Enrage","Enraged", "Enrage",0),
            new PlayerBuffApplyMechanic(AquaticAuraKenut, "Aquatic Aura Kenut", new MechanicPlotlySetting("square-open",Colors.Teal), "Ken Aura","Increasing Damage Debuff on Kenut's Last Platform", "Kenut Aura Debuff",0),
            new PlayerBuffApplyMechanic(AquaticAuraNikare, "Aquatic Aura Nikare", new MechanicPlotlySetting("diamond-open",Colors.Teal), "Nik Aura","Increasing Damage Debuff on Nikare's Last Platform", "Nikare Aura Debuff",0),
