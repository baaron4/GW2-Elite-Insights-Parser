...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Qadim : MythwrightGambit
    {
        ...
        public Qadim(int triggerID) : base(triggerID)
        {
            ...
            {
            new EnemyCastStartMechanic(51943, "Qadim CC", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkTeal), "Q.CC","Qadim CC", "Qadim CC",0),
            new EnemyCastEndMechanic(51943, "Qadim CC", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkGreen), "Q.CCed","Qadim Breakbar broken", "Qadim CCed",0, (ce, log) => ce.ActualDuration < 6500),
            new EnemyCastStartMechanic(52265, "Riposte", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.Red), "Q.CC Fail","Qadim Breakbar failed", "Qadim CC Fail",0),
            ...
            new HitOnPlayerMechanic(52224, "Fire Wave", new MechanicPlotlySetting(Symbols.CircleOpen,Colors.Orange), "D.Wave","Fire Wave (Shockwave after Destroyer's Jump or Stomp)", "Destroyer Shockwave",0),
            ...
            new EnemyCastEndMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkGreen), "H.CC Fail","Fiery Meteor (Hydra Breakbar not broken)", "Hydra CC Failed",0, (ce,log) => ce.ActualDuration >= 12364),
            ...
            new EnemyCastStartMechanic(53132, "Patriarch CC", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkTeal), "W.BB","Platform Destruction (Patriarch CC)", "Patriarch CC",0),
            new EnemyCastEndMechanic(53132, "Patriarch CC", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkGreen), "W.CCed","Platform Destruction (Patriarch Breakbar broken)", "Patriarch CCed",0, (ce, log) => ce.ActualDuration < 6500),
            new EnemyCastStartMechanic(51984, "Patriarch CC (Jump into air)", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.Red), "Wyv CC Fail","Platform Destruction (Patriarch Breakbar failed)", "Patriarch CC Fail",0),
            ...
            new HitOnPlayerMechanic(51759, "Wave of Force", new MechanicPlotlySetting(Symbols.DiamondOpen,Colors.Yellow), "D.Pizza","Wave of Force (Destroyer Pizza)", "Destroyer Auto",0),
            new EnemyCastStartMechanic(52054, "Summon", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkTeal), "D.CC","Summon (Destroyer Breakbar)", "Destroyer CC",0),
            new EnemyCastEndMechanic(52054, "Summon", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkGreen), "D.CCed","Summon (Destroyer Breakbar broken)", "Destroyer CCed",0, (ce, log) => ce.ActualDuration < 8332),
            new EnemyCastEndMechanic(52054, "Summon", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.Red), "D.CC Fail","Summon (Destroyer Breakbar failed)", "Destroyer CC Fail",0, (ce,log) => ce.ActualDuration >= 8332),
            new SpawnMechanic(20944, "Summon (Spawn)", new MechanicPlotlySetting(Symbols.DiamondTall,Colors.DarkRed), "D.Spwn","Summon (Destroyer Trolls summoned)", "Destroyer Summoned",0),
            ...
            new KilledMechanic(21050, "Pyre Guardian", new MechanicPlotlySetting(Symbols.Bowtie,Colors.Red), "Pyre.K","Pyre Killed", "Pyre Killed",0),
            new KilledMechanic((int)ArcDPSEnums.TrashID.PyreGuardianStab, "Stab Pyre Guardian", new MechanicPlotlySetting(Symbols.Bowtie,Colors.Red), "Pyre.S.K","Stab Pyre Killed", "Stab Pyre Killed",0),
            ...
            new KilledMechanic((int)ArcDPSEnums.TrashID.PyreGuardianResolution, "Resolution Pyre Guardian", new MechanicPlotlySetting(Symbols.Bowtie,Colors.LightRed), "Pyre.R.K","Resolution Pyre Killed", "Resolution Pyre Killed",0),
            });
            Extension = "qadim";
