...
internal class DecimaTheStormsinger : MountBalrior
{
    public DecimaTheStormsinger(int triggerID) : base(triggerID)
    {
        MechanicList.AddRange(new List<Mechanic>()
        {
            ...
            new PlayerDstSkillMechanic(Earthrend, "Earthrend", new MechanicPlotlySetting(Symbols.CircleCrossOpen, Colors.Red), "Earthrend.D", "Earthrend Death (Hitbox)", "Earthrend Death", 0).UsingChecker((hde, log) => hde.To.IsDead(log, hde.Time)).WithBuilds(ArcDPSEnums.GW2Builds.November2024MountBalriorRelease, ArcDPSEnums.GW2Builds.December2024MountBalriorNerfs), // Legacy
            new PlayerDstSkillMechanic(SeismicCrashHitboxDamage, "Seismic Crash", new MechanicPlotlySetting(Symbols.CircleCross, Colors.Red), "SeisCrash.D", "Seismic Crash Death (Hitbox)", "Seismic Crash Death", 0).UsingChecker((hde, log) => hde.To.IsDead(log, hde.Time)).WithBuilds(ArcDPSEnums.GW2Builds.November2024MountBalriorRelease, ArcDPSEnums.GW2Builds.December2024MountBalriorNerfs), // Legacy
