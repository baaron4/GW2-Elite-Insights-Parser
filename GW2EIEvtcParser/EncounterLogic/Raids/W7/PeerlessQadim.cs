    ...
    internal class PeerlessQadim : TheKeyOfAhdashim
    {
        public PeerlessQadim(int triggerID) : base(triggerID)
        {
            ...
            MechanicList.AddRange(new List<Mechanic>()
            {
                ...
                new HitOnPlayerMechanic(56134, "Force of Retaliation", new MechanicPlotlySetting("circle-open",Colors.Black), "Pushed", "Pushed by Shockwave", "Shockwave Push", 1000, (de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
                ...
                new HitOnPlayerMechanic(BatteringBlitz, "Battering Blitz", new MechanicPlotlySetting("bowtie",Colors.Orange), "Rush.H", "Hit by Qadim Rush", "Qadim Rush", 500),
                ...
                new PlayerBuffApplyMechanic(FixatedQadimThePeerless, "Fixated", new MechanicPlotlySetting("star",Colors.Magenta), "Fixated", "Fixated", "Fixated", 0),
                new PlayerBuffApplyMechanic(CriticalMass, "Critical Mass", new MechanicPlotlySetting("circle-open",Colors.Red), "Orb caught", "Collected a Pylon Orb", "Critical Mass", 0),
                ...
                new PlayerBuffApplyMechanic(SappingSurge, "Sapping Surge", new MechanicPlotlySetting("y-down-open",Colors.Red), "B.Tether", "25% damage reduction", "Bad Tether", 0),
            });
            Extension = "prlqadim";
