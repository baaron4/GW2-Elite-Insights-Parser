...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Cairn : BastionOfThePenitent
    {
        public Cairn(int triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(new long[] {37611, 37629, 37642, 37673, 38074, 38302 }, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(new long[] {37611, 37629, 37642, 37673, 38074, 38302 }, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(31875, "Spectral Impact", new MechanicPlotlySetting("hexagram",Colors.Red), "Slam","Spectral Impact (KB Slam)", "Slam",4000, (de, log) => !de.To.HasBuff(log, Stability, de.Time - ParserHelper.ServerDelayConstant)),
            ...
            new PlayerBuffApplyMechanic(SharedAgony, "Shared Agony", new MechanicPlotlySetting("circle",Colors.Red), "Agony","Shared Agony Debuff Application", "Shared Agony",0),//could flip
