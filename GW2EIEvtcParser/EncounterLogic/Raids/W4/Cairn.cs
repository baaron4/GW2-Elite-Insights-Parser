...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Cairn : BastionOfThePenitent
    {
        public Cairn(int triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(37611, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37629, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37642, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37673, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(38074, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(38302, "Spatial Manipulation", new MechanicPlotlySetting("circle",Colors.Green), "Green","Green Spatial Manipulation Field (lift)", "Green (lift)",0, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37611, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37629, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37642, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(37673, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(38074, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(38302, "Spatial Manipulation", new MechanicPlotlySetting("circle-open",Colors.Green), "Stab.Green","Green Spatial Manipulation Field while affected by stability", "Stabilized Green",0, (de, log) => de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
            new HitOnPlayerMechanic(31875, "Spatial Manipulation", new MechanicPlotlySetting("hexagram",Colors.Red), "Slam","Spectral Impact (KB Slam)", "Slam",4000, (de, log) => !de.To.HasBuff(log, 1122, de.Time - ParserHelper.ServerDelayConstant)),
