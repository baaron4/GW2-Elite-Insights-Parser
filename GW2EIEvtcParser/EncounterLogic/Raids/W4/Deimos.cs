...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Deimos : BastionOfThePenitent
    {
        ...
        public Deimos(int triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(new long[] {38208, 37929 }, "Annihilate", new MechanicPlotlySetting("hexagon",Colors.Yellow), "Pizza","Annihilate (Cascading Pizza attack)", "Boss Smash",0),
