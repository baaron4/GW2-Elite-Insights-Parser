...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Samarog : BastionOfThePenitent
    {
        public Samarog(int triggerID) : base(triggerID)
        {
            ...
            new PlayerBuffApplyMechanic(FixatedSamarog, "Fixate: Samarog", new MechanicPlotlySetting("star",Colors.Magenta), "S.Fix","Fixated by Samarog", "Fixate: Samarog",0),
            new PlayerBuffApplyMechanic(FixatedGuldhem, "Fixate: Guldhem", new MechanicPlotlySetting("star-open",Colors.Orange), "G.Fix","Fixated by Guldhem", "Fixate: Guldhem",0),
            new PlayerBuffApplyMechanic(FixatedRigom, "Fixate: Rigom", new MechanicPlotlySetting("star-open",Colors.Red), "R.Fix","Fixated by Rigom", "Fixate: Rigom",0),
            new PlayerBuffApplyMechanic(InevitableBetrayalBig, "Big Hug", new MechanicPlotlySetting("circle",Colors.DarkGreen), "B.Gr","Big Green (friends mechanic)", "Big Green",0),
            new PlayerBuffApplyMechanic(InevitableBetrayalSmall, "Small Hug", new MechanicPlotlySetting("circle-open",Colors.DarkGreen), "S.Gr","Small Green (friends mechanic)", "Small Green",0),
            ...
            new HitOnPlayerMechanic(new long[] {38260, 37851}, "Inevitable Betrayal", new MechanicPlotlySetting("circle",Colors.Red), "Gr.Fl","Inevitable Betrayal (failed Green)", "Failed Green",0),
            ...
            new PlayerBuffApplyMechanic(Brutalize, "Brutalize", new MechanicPlotlySetting("diamond-tall",Colors.Magenta),"Brtlz","Brutalize (jumped upon by Samarog->Breakbar)", "Brutalize",0),
            ...
            new EnemyBuffRemoveMechanic(Brutalize, "Brutalize (End)", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "CC End","Ended Brutalize", "CC Ended",0),
            ...
            new PlayerBuffApplyMechanic(SoulSwarm, "Soul Swarm", new MechanicPlotlySetting("x-thin-open",Colors.Teal),"Wall","Soul Swarm (stood in or beyond Spear Wall)", "Spear Wall",0),
