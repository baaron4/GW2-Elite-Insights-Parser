...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class MursaatOverseer : BastionOfThePenitent
    {
        public MursaatOverseer(int triggerID) : base(triggerID)
        {
            ...
            new PlayerBuffApplyMechanic(Invulnerability757, "Invulnerability", new MechanicPlotlySetting("circle-open",Colors.Teal), "Protect","Protected by the Protect Shield","Protect Shield",0, (ba, log) => ba.AppliedDuration == 1000),
            new PlayerBuffApplyMechanic(ProtectSAK, "Protect (SAK)", new MechanicPlotlySetting("circle",Colors.Blue), "Protect (SAK)","Took protect","Protect (SAK)",0),
            new PlayerBuffApplyMechanic(DispelSAK, "Dispel (SAK)", new MechanicPlotlySetting("circle",Colors.Purple), "Dispel (SAK)","Took dispel","Dispel (SAK)",0),
            new PlayerBuffApplyMechanic(ClaimSAK, "Claim (SAK)", new MechanicPlotlySetting("circle",Colors.Yellow), "Claim (SAK)","Took claim","Claim (SAK)",0),
            new EnemyBuffApplyMechanic(MursaatOverseersShield, "Mursaat Overseer's Shield", new MechanicPlotlySetting("circle-open",Colors.Yellow), "Shield","Jade Soldier Shield", "Soldier Shield",0),
            new EnemyBuffRemoveMechanic(MursaatOverseersShield, "Mursaat Overseer's Shield", new MechanicPlotlySetting("square-open",Colors.Yellow), "Dispel","Dispelled Jade Soldier Shield", "Dispel",0),
