...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class BanditTrio : SalvationPass
    {
        public BanditTrio(int triggerID) : base(triggerID)
        {
            ...
            {
            new PlayerBuffApplyMechanic(ShellShocked, "Shell-Shocked", new MechanicPlotlySetting("circle-open",Colors.DarkGreen), "Launchd","Shell-Shocked (Launched from pad)", "Shell-Shocked",0),
