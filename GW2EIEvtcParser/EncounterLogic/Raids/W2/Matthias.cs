...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Matthias : SalvationPass
    {
        public Matthias(int triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(new long[]{ 34380, 31750 }, "Oppressive Gaze", new MechanicPlotlySetting("hexagram",Colors.Red), "Hadouken","Oppressive Gaze (Hadouken projectile)", "Hadouken",0),
            new HitOnPlayerMechanic(new long[]{ 34480, 34440 }, "Blood Shards", new MechanicPlotlySetting("diamond-wide-open",Colors.Magenta), "Shoot Shards","Blood Shard projectiles during bubble", "Rapid Fire",0),
            new HitOnPlayerMechanic(new long[]{ 34404, 34411 }, "Shards of Rage", new MechanicPlotlySetting("star-diamond",Colors.Red), "Jump Shards","Shards of Rage (Jump)", "Jump Shards",1000),
            ...
            new PlayerBuffApplyMechanic(UnstableBloodMagic, "Unstable Blood Magic", new MechanicPlotlySetting("diamond",Colors.Red), "Well","Unstable Blood Magic application", "Well",0),
            ...
            new PlayerBuffApplyMechanic(Corruption1, "Corruption", new MechanicPlotlySetting("circle",Colors.LightOrange), "Corruption","Corruption Application", "Corruption",0),
            ...
            new PlayerBuffApplyMechanic(MatthiasSacrifice, "Sacrifice", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "Sacrifice","Sacrifice (Breakbar)", "Sacrifice",0),
            new PlayerBuffRemoveMechanic(MatthiasSacrifice, "Sacrifice", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "CC.End","Sacrifice (Breakbar) ended", "Sacrifice End",0, (br,log) => br.RemovedDuration > 25 && !log.CombatData.GetDeadEvents(br.To).Any(x => Math.Abs(br.Time - x.Time) < ParserHelper.ServerDelayConstant)),
            new PlayerBuffRemoveMechanic(MatthiasSacrifice, "Sacrificed", new MechanicPlotlySetting("diamond-tall",Colors.Red), "CC.Fail","Sacrifice time ran out", "Sacrificed",0, (br,log) => br.RemovedDuration <= 25 || log.CombatData.GetDeadEvents(br.To).Any(x => Math.Abs(br.Time - x.Time) < ParserHelper.ServerDelayConstant)),
            new PlayerBuffRemoveMechanic(Unbalanced, "Unbalanced", new MechanicPlotlySetting("square",Colors.LightPurple), "KD","Unbalanced (triggered Storm phase Debuff)", "Knockdown",0, (br,log) => br.RemovedDuration > 0 && !br.To.HasBuff(log, Stability, br.Time - ParserHelper.ServerDelayConstant)),
            ...
            new EnemyBuffApplyMechanic(new long[]{ BloodShield, BloodShieldAbo }, "Blood Shield", new MechanicPlotlySetting("octagon",Colors.Red), "Bubble","Blood Shield (protective bubble)", "Bubble",100, (ba, log) => !ba.To.HasBuff(log, BloodShield, ba.Time - 100) && !ba.To.HasBuff(log, BloodShieldAbo, ba.Time - 100)),
            new PlayerBuffApplyMechanic(ZealousBenediction, "Zealous Benediction", new MechanicPlotlySetting("circle",Colors.Yellow), "Bombs","Zealous Benediction (Expanding bombs)","Bomb",0),
            new PlayerBuffApplyMechanic(26766, "Icy Patch", new MechanicPlotlySetting("circle-open",Colors.Blue), "Icy KD","Knockdown by Icy Patch", "Icy Patch KD",0, (br,log) => br.AppliedDuration == 10000 && !br.To.HasBuff(log, Stability, br.Time - ParserHelper.ServerDelayConstant)),
