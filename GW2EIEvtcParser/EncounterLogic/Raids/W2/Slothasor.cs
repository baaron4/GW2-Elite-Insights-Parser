...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Slothasor : SalvationPass
    {
        public Slothasor(int triggerID) : base(triggerID)
        {
            ...
            new PlayerBuffApplyMechanic(VolatilePoison, "Volatile Poison", new MechanicPlotlySetting("circle",Colors.Red), "Poison","Volatile Poison Application (Special Action Key)", "Poison (Action Key)",0),
            ...
            new PlayerBuffApplyMechanic(MagicTransformation, "Magic Transformation", new MechanicPlotlySetting("hexagram",Colors.Teal), "Slub","Magic Transformation (Ate Magic Mushroom)", "Slub Transform",0), 
            ...
            new PlayerBuffApplyMechanic(FixatedSlothasor, "Fixated", new MechanicPlotlySetting("star",Colors.Magenta), "Fixate","Fixated by Slothasor", "Fixated",0),
            new HitOnPlayerMechanic(new long[] { 34565, 34537 }, "Toxic Cloud", new MechanicPlotlySetting("pentagon-open",Colors.DarkGreen), "Floor","Toxic Cloud (stood in green floor poison)", "Toxic Floor",0),
            new PlayerBuffApplyMechanic(Fear, "Fear", new MechanicPlotlySetting("square-open",Colors.Red), "Fear","Hit by fear after breakbar", "Feared",0, (ba,log) => ba.AppliedDuration == 8000),
            new EnemyBuffApplyMechanic(Narcolepsy, "Narcolepsy", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "CC","Narcolepsy (Breakbar)", "Breakbar",0),
            new EnemyBuffRemoveMechanic(Narcolepsy, "Narcolepsy", new MechanicPlotlySetting("diamond-tall",Colors.Red), "CC Fail","Narcolepsy (Failed CC)", "CC Fail",0, (br,log) => br.RemovedDuration > 120000),
            new EnemyBuffRemoveMechanic(Narcolepsy, "Narcolepsy", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "CCed","Narcolepsy (Breakbar broken)", "CCed",0, (br,log) => br.RemovedDuration <= 120000)
            });
            Extension = "sloth";
        ...
        {
            // Poison
            List<AbstractBuffEvent> poisonToDrop = GetFilteredList(log.CombatData, VolatilePoison, p, true, true);
            int toDropStart = 0;
