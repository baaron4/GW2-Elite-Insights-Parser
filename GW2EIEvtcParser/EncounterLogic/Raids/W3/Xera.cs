...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Xera : StrongholdOfTheFaithful
    {
        ...
        public Xera(int triggerID) : base(triggerID)
        {
            ...
            new PlayerBuffApplyMechanic(BloodstoneProtection, "Bloodstone Protection", new MechanicPlotlySetting("hourglass-open",Colors.DarkPurple), "In Bubble","Bloodstone Protection (Stood in Bubble)", "Inside Bubble",0),
            ...
            new PlayerBuffApplyMechanic(Derangement, "Derangement", new MechanicPlotlySetting("square-open",Colors.LightPurple), "Stacks","Derangement (Stacking Debuff)", "Derangement",0),
            new PlayerBuffApplyMechanic(BendingChaos, "Bending Chaos", new MechanicPlotlySetting("triangle-down-open",Colors.Yellow), "Button1","Bending Chaos (Stood on 1st Button)", "Button 1",0),
            new PlayerBuffApplyMechanic(ShiftingChaos, "Shifting Chaos", new MechanicPlotlySetting("triangle-ne-open",Colors.Yellow), "Button2","Bending Chaos (Stood on 2nd Button)", "Button 2",0),
            new PlayerBuffApplyMechanic(TwistingChaos, "Twisting Chaos", new MechanicPlotlySetting("triangle-nw-open",Colors.Yellow), "Button3","Bending Chaos (Stood on 3rd Button)", "Button 3",0),
            new PlayerBuffApplyMechanic(Intervention, "Intervention", new MechanicPlotlySetting("square",Colors.Blue), "Shield","Intervention (got Special Action Key)", "Shield",0),
