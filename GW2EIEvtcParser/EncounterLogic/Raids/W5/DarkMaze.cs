...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class DarkMaze : HallOfChains
    {
        ...
        public DarkMaze(int triggerID) : base(triggerID)
        {
            ...
            {
            new PlayerBuffApplyMechanic(Fear, "Fear", new MechanicPlotlySetting("star-square",Colors.Black), "Feared","Feared by Eye Teleport Skill", "Feared",0),
            new PlayerBuffApplyMechanic(LightCarrier, "Light Carrier", new MechanicPlotlySetting("circle-open",Colors.Yellow), "Light Orb","Light Carrier (picked up a light orb)", "Picked up orb",0),
            ...
            new PlayerBuffApplyToMechanic(new long[] { Daze, Stun, Fear }, "Hard CC Eye of Fate", new MechanicPlotlySetting("triangle",Colors.Red), "Hard CC Fate","Applied hard CC on Eye of Fate", "Hard CC Fate",50, (ba, log) => ba.To.ID == (int) ArcDPSEnums.TargetID.EyeOfFate),
            new PlayerBuffApplyToMechanic(new long[] { Daze, Stun, Fear }, "Hard CC Eye of Judge", new MechanicPlotlySetting("square",Colors.Red), "Hard CC Judge","Applied hard CC on Eye of Judgement", "Daze Judge",50, (ba, log) => ba.To.ID == (int) ArcDPSEnums.TargetID.EyeOfJudgement),
