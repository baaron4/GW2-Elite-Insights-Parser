...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class EaterOfSouls : HallOfChains
    {
        ...
        public EaterOfSouls(int triggerID) : base(triggerID)
        {
            ...
            new PlayerBuffApplyMechanic(FracturedSpirit, "Fractured Spirit", new MechanicPlotlySetting("circle",Colors.Green), "Orb CD","Applied when taking green", "Green port",0),
            }
            );
            Extension = "souleater";
