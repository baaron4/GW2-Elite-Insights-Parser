...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class Dhuum : HallOfChains
    {
        ...
        public Dhuum(int triggerID) : base(triggerID)
        {
            ...
            new PlayerOnPlayerBuffApplyMechanic(47335, "Soul Shackle", new MechanicPlotlySetting("diamond","rgb(0,255,255)"), "Shackles","Soul Shackle (Tether) application", "Shackles",29000),//  //also used for removal.
