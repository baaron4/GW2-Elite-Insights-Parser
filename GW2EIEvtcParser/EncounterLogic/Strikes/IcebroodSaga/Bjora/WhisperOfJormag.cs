    ...
    internal class WhisperOfJormag : Bjora
    {
        public WhisperOfJormag(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new PlayerDstHitMechanic(SpreadingIceOthers, "Spreading Ice (Others)", new MechanicPlotlySetting(Symbols.TriangleUp, Colors.LightOrange), "OtherIceSprd.H", "Hit by other's Spreading Ice", "Spreading Ice (Others)", 50),
                new PlayerDstHitMechanic(IcySlice, "Icy Slice", new MechanicPlotlySetting(Symbols.Hexagram, Colors.Orange), "IcySlice.H", "Hit by Icy Slice", "Icy Slice", 50),
                new PlayerDstHitMechanic(IceTempest, "Ice Tempest", new MechanicPlotlySetting(Symbols.Square, Colors.Orange), "IceTempest.H", "Hit by Ice Tempest (Tornadoes)", "Ice Tempest", 50),
                ...
                new PlayerDstBuffApplyMechanic(ChainsOfFrostApplication, "Chains of Frost", new MechanicPlotlySetting(Symbols.DiamondTall, Colors.LightRed), "Chains.A", "Selected for Chains of Frost", "Chains of Frost", 500),
                new PlayerDstBuffApplyMechanic(LethalCoalescenceEffect, "Lethal Coalescence", new MechanicPlotlySetting(Symbols.CircleOpenDot, Colors.Green), "LethalCoa.A", "Selected for Lethal Coalescence (Green)", "Lethal Coalescence", 500),
                new PlayerDstBuffApplyMechanic(FrigidVortexEffect, "Frigid Vortex", new MechanicPlotlySetting(Symbols.Star, Colors.LightBlue), "FrigVor.A", "Frigid Vortex Applied", "Frigid Vortex Buff", 0),
                ...
                new EnemyCastStartMechanic(SpreadingIceOwn, "Spreading Ice", new MechanicPlotlySetting(Symbols.Hexagram, Colors.DarkRed), "Spreading Ice", "Cast Spreading Ice", "Cast Spreading Ice", 0),
