...
namespace GW2EIEvtcParser.EncounterLogic
{
    internal class SuperKodanBrothers : Bjora
    {
        ...
        {
            if (TargetHPPercentUnderThreshold(ArcDPSEnums.TargetID.ClawOfTheFallen, fightData.FightStart, 90, combatData, Targets) ||
                TargetHPPercentUnderThreshold(ArcDPSEnums.TargetID.VoiceOfTheFallen, fightData.FightStart, 90, combatData, Targets))
            {
