    ...
    internal class XunlaiJadeJunkyard : CanthaStrike
    {
        public XunlaiJadeJunkyard(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new HitOnPlayerMechanic(WallOfFear, "Wall of Fear", new MechanicPlotlySetting(Symbols.TriangleRight, Colors.Yellow), "Krait.H", "Hit by in Kraits", "Krait Hit", 150),
                new HitOnPlayerMechanic(WaveOfTorment, "Wave of Torment", new MechanicPlotlySetting(Symbols.TriangleRight, Colors.LightPurple), "Quaggan.H", "Hit by in Quaggan Explosion", "Quaggan Hit", 150),
