    ...
    internal class AetherbladeHideout : CanthaStrike
    {
        public AetherbladeHideout(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new HitOnPlayerMechanic(new long[] {TormentingWave, TormentingWaveCM }, "Tormenting Wave", new MechanicPlotlySetting("circle", Colors.DarkRed), "Shck.Wv", "Hit by Shockwave attack", "Shockwave", 150),
                new HitOnPlayerMechanic(new long[] {LeyBreach, LeyBreachCM }, "Ley Breach", new MechanicPlotlySetting("circle", Colors.LightOrange), "Puddle", "Stood in Puddle", "Puddle", 150),
                ...
                new PlayerBuffApplyMechanic(new long[] {SharedDestructionMaiTrin, SharedDestructionMaiTrinCM }, "Shared Destruction", new MechanicPlotlySetting("circle", Colors.Green), "Green", "Selected for Green", "Green", 150),
