    ...
    internal class HarvestTemple : EndOfDragonsStrike
    {
        public HarvestTemple(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new HitOnPlayerMechanic(new []{HarvestTempleTargetedExpulsionNM, HarvestTempleTargetedExpulsionCM}, "Targeted Expulsion", new MechanicPlotlySetting(Symbols.TriangleUp, Colors.Orange), "Spread.H", "Hit by Spread mechanic", "Targeted Expulsion (Spread)", 150),
                // Jormag
                ...
                new HitOnPlayerMechanic(FrostMeteor, "Frost Meteor", new MechanicPlotlySetting(Symbols.TriangleUp, Colors.Blue), "J.Meteor.H", "Hit by Jormag Meteor", "Jormag Meteor", 150),
                // Primordus
                ...
                new HitOnPlayerMechanic(JawsOfDestruction, "Jaws of Destruction", new MechanicPlotlySetting(Symbols.TriangleUp, Colors.Red), "Jaws.H", "Hit by Primordus Jaws", "Primordus Jaws", 150),
                // Kralkatorrik 
                ...
                new HitOnPlayerMechanic(PoisonRoar, "Poison Roar", new MechanicPlotlySetting(Symbols.TriangleLeft, Colors.Green), "M.Poison.H", "Hit by Mordremoth Poison", "Mordremoth Poison", 150),
                // Zhaitan
                new HitOnPlayerMechanic(new []{ScreamOfZhaitanNM, ScreamOfZhaitanCM}, "Scream of Zhaitan", new MechanicPlotlySetting(Symbols.TriangleRight, Colors.DarkGreen), "Scream.H", "Hit by Zhaitan Scream", "Zhaitan Scream", 150),
