    ...
    internal class WhisperOfJormag : Bjora
    {
        public WhisperOfJormag(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new PlayerBuffApplyMechanic(ChainsOfFrostApplication, "Chains of Frost", new MechanicPlotlySetting("circle","rgb(0,0,255)"), "F.Chains","Selected for Chains of Frost", "Chains of Frost",500),
                new PlayerBuffRemoveMechanic(WhisperTeleportBack, "Teleport Back", new MechanicPlotlySetting("circle","rgb(0,125,255)"), "TP In","Teleported back to the arena", "Teleport Back",500),
                new PlayerBuffRemoveMechanic(WhisperTeleportOut, "Teleport Out", new MechanicPlotlySetting("circle-open","rgb(0,125,255)"), "TP Out","Teleported outside of the arena", "Teleport Out",500),
