    ...
    internal class IcebroodConstruct : IBSStrike
    {
        public IcebroodConstruct(int triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new HitOnPlayerMechanic(new long[] {57948, 57472, 57779 }, "Ice Shock Wave",new MechanicPlotlySetting("square","rgb(255,150,0)"),"ShockWave","Ice Shock Wave", "Ice Shock Wave", 0),
                ...
                new HitOnPlayerMechanic(new long[] {57678, 57463 }, "Ice Flail",new MechanicPlotlySetting("square","rgb(255,0,150)"),"I.Flail","Ice Flail", "Ice Flail", 50),
            }
            );
            Extension = "icebrood";
