...
internal class StatusEventsContainer
{
    ...
    public readonly Dictionary<AgentItem, List<FlyToEvent>> FlyToEventsBySrc = [];
    ...
    public readonly Dictionary<ulong, List<GadgetModelInfoEvent>> GadgetModelInfoEventsByPropID = [];
