...
namespace GW2EIParser.EIData
{
    public class BuffsContainer
    {
        ...
        private readonly List<Buff> _commons = new List<Buff>
        {
                ...
                //Auras
                new Buff("Chaos Aura", 10332, GeneralHelper.Source.Common, BuffNature.OffensiveBuffTable,"https://wiki.guildwars2.com/images/e/ec/Chaos_Aura.png"),
                new Buff("Fire Aura", 5677, GeneralHelper.Source.Common, BuffNature.OffensiveBuffTable,"https://wiki.guildwars2.com/images/c/ce/Fire_Aura.png"),
                new Buff("Frost Aura", 5579, GeneralHelper.Source.Common, BuffNature.DefensiveBuffTable,"https://wiki.guildwars2.com/images/8/87/Frost_Aura_%28effect%29.png"),
                new Buff("Light Aura", 25518, GeneralHelper.Source.Common, BuffNature.DefensiveBuffTable,"https://wiki.guildwars2.com/images/5/5a/Light_Aura.png"),
                new Buff("Magnetic Aura", 5684, GeneralHelper.Source.Common, BuffNature.DefensiveBuffTable, "https://wiki.guildwars2.com/images/0/0b/Magnetic_Aura_%28effect%29.png"),
                new Buff("Shocking Aura", 5577, GeneralHelper.Source.Common, BuffNature.DefensiveBuffTable,"https://wiki.guildwars2.com/images/5/5d/Shocking_Aura_%28effect%29.png"),
                new Buff("Dark Aura", 39978, GeneralHelper.Source.Common, BuffNature.OffensiveBuffTable,"https://wiki.guildwars2.com/images/e/ef/Dark_Aura.png", 96406, ulong.MaxValue),
                //race
        ...
        {
            new Buff("Mistlock Instability: Adrenaline Rush", 36341, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/7/72/Mistlock_Instability_Adrenaline_Rush.png"),
            new Buff("Mistlock Instability: Afflicted", 22228, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/3/3f/Mistlock_Instability_Afflicted.png"),
            new Buff("Mistlock Instability: Boon Overload", 53673, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/d/d7/Mistlock_Instability_Boon_Overload.png"),
            new Buff("Mistlock Instability: Flux Bomb", 36386, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/3/3f/Mistlock_Instability_Flux_Bomb.png"),
            new Buff("Mistlock Instability: Fractal Vindicators", 48296, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/4/48/Mistlock_Instability_Fractal_Vindicators.png"),
            ...
            new Buff("Mistlock Instability: Hamstrung", 47323, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/9/99/Mistlock_Instability_Hamstrung.png"),
            ...
            new Buff("Mistlock Instability: Mists Convergence", 36224, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/9/95/Mistlock_Instability_Mists_Convergence.png"),
            new Buff("Mistlock Instability: No Pain, No Gain", 22277, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/c/c3/Mistlock_Instability_No_Pain%2C_No_Gain.png"),
            ...
            new Buff("Mistlock Instability: Social Awkwardness", 32942, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/d/d2/Mistlock_Instability_Social_Awkwardness.png"),
            new Buff("Mistlock Instability: Stick Together", 53932, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/5/59/Mistlock_Instability_Stick_Together.png"),
            new Buff("Mistlock Instability: Sugar Rush", 54237, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/4/4c/Mistlock_Instability_Sugar_Rush.png"),
            new Buff("Mistlock Instability: Toxic Trail", 36204, GeneralHelper.Source.FractalInstability, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/d/df/Mistlock_Instability_Toxic_Trail.png"),
        ...
        private readonly List<Buff> _elementalist = new List<Buff>
        {
                ...
                new Buff("Persisting Flames",13342, GeneralHelper.Source.Elementalist, BuffStackType.Stacking, 10, BuffNature.GraphOnlyBuff, "https://wiki.guildwars2.com/images/5/5f/Persisting_Flames.png", 104844, ulong.MaxValue),
