    ...
    public class Boneskinner : StrikeMissionLogic
    {
        public Boneskinner(ushort triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new EnemyCastEndMechanic(58851, "Charge", new MechanicPlotlySetting("hexagram","rgb(255,0,125)"), "D.Torch","Destroyed a Torch", "Destroyed a Torch",0, (ce, log) => !ce.Interrupted),
                new EnemyCastEndMechanic(58546, "Death Wind", new MechanicPlotlySetting("square","rgb(255,125,0)"), "D.Wind","Death Wind (extinguished torches)", "Death Wind",0, (ce, log) => !ce.Interrupted),
                new EnemyCastEndMechanic(58809, "Douse in Darkness", new MechanicPlotlySetting("circle","rgb(255,125,0)"), "D.Darkness","Douse in Darkness (extinguished torches)", "Douse in Darkness",0, (ce, log) => !ce.Interrupted),
            }
            );
            Extension = "boneskin";
