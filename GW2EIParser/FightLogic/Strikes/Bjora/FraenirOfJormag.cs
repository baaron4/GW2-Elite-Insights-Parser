    ...
    public class FraenirOfJormag : StrikeMissionLogic
    {
        public FraenirOfJormag(ushort triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>
            {
                ...
                new PlayerBuffRemoveMechanic(58376, "Frozen", new MechanicPlotlySetting("circle-open","rgb(0,0,255)"), "Unfrozen","Unfrozen", "Unfrozen",500),
        ...
        protected override List<ParseEnum.TrashIDS> GetTrashMobsIDS()
        {
            ...
            {
                ParseEnum.TrashIDS.IcebroodElemental
            };
        }
    }
}
