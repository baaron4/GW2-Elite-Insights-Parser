...
namespace LuckParser.Models.Logic
{
    public class DarkMaze : RaidLogic
    {
        ...
        public DarkMaze(ushort triggerID) : base(triggerID)
        {
            ...
            new PlayerCastMechanic(47074, "Flare", new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Detonate","Flare (detonate light orb to incapacitate eye)", "Detonate orb",0, false),
