...
namespace LuckParser.Models.Logic
{
    public class Gorseval : RaidLogic
    {
        public Gorseval(ushort triggerID) : base(triggerID)
        {
            ...
            {
            new DamageOnPlayerMechanic(31875, "Spectral Impact", new MechanicPlotlySetting("hexagram","rgb(255,0,0)"), "Slam","Spectral Impact (KB Slam)", "Slam",4000, new List<DamageMechanic.DamageChecker>{(de, log) => !de.To.HasBuff(log, 1122, de.Time)}, Mechanic.TriggerRule.AND ),
            ...
            new DamageOnPlayerMechanic(31720, "Kick", new MechanicPlotlySetting("triangle-right","rgb(255,0,255)"), "Kick","Kicked by small add", "Spirit Kick",0, new List<DamageMechanic.DamageChecker>{(de, log) => !de.To.HasBuff(log, 1122, de.Time)}, Mechanic.TriggerRule.AND),
            ...
            new EnemyCastMechanic(31834, "Ghastly Rampage", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC End","Ghastly Rampage (Full duration)", "CC ran out",0,new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration > 21985 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(31834, "Ghastly Rampage", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Ghastly Rampage (Breakbar broken)", "CCed",0,new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration <= 21985 }, Mechanic.TriggerRule.AND),
            });
            Extension = "gors";
