...
namespace LuckParser.Models.Logic
{
    public class Sabetha : RaidLogic
    {
        public Sabetha(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastMechanic(31763, "Platform Quake", new MechanicPlotlySetting("diamond-tall","rgb(0,160,150)"), "CC","Platform Quake (Breakbar)","Breakbar",0, false),
            new EnemyCastMechanic(31763, "Platform Quake", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Platform Quake (Breakbar broken) ", "CCed",0, true, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration <= 4400 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(31763, "Platform Quake", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Platform Quake (Breakbar failed) ", "CC Fail",0, true, new List<CastMechanic.CastChecker>{ (ce,log) =>  ce.ActualDuration > 4400 }, Mechanic.TriggerRule.AND),
