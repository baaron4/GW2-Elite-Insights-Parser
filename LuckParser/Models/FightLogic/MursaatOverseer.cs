...
namespace LuckParser.Models.Logic
{
    public class MursaatOverseer : RaidLogic
    {
        public MursaatOverseer(ushort triggerID) : base(triggerID)
        {
            ...
            new PlayerBoonApplyMechanic(757, "Invulnerability", new MechanicPlotlySetting("circle-open","rgb(0,255,255)"), "Protect","Protected by the Protect Shield","Protect Shield",0,(condition=> condition.Value == 1000)),
