...
namespace LuckParser.Models.Logic
{
    public class Arkk : FractalLogic
    {
        public Arkk(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastMechanic(39645, "Breakbar Start", new MechanicPlotlySetting("diamond-tall","rgb(0,160,150)"), "Breakbar","Start Breakbar", "CC",0, false),
            new EnemyCastMechanic(39645, "Breakbar End", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC.Fail","Breakbar (Failed CC)", "CC Fail",0, true, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration > 9668}, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(39645, "Breakbar End", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Breakbar broken", "CCed",0, true, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration < 9668 }, Mechanic.TriggerRule.AND),
            ...
            new EnemyCastMechanic(39021, "Cosmic Streaks", new MechanicPlotlySetting("diamond-open","rgb(255,0,100)"), "DDR Beam","Triple Death Ray Cast (last phase)", "Death Ray Cast",0, false),
            ...
            new EnemyCastMechanic(35761, "Pull Charge", new MechanicPlotlySetting("bowtie","rgb(0,160,150)"), "Pull","Pull Charge (Gladiator Pull)", "Gladiator Pull",0, false), //
            new EnemyCastMechanic(35761, "Pull Charge", new MechanicPlotlySetting("bowtie","rgb(255,0,0)"), "Pull CC Fail","Pull Charge CC failed", "CC fail (Gladiator)",0, true, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration > 3200 }, Mechanic.TriggerRule.AND), //
            new EnemyCastMechanic(35761, "Pull Charge", new MechanicPlotlySetting("bowtie","rgb(0,160,0)"), "Pull CCed","Pull Charge CCed", "CCed (Gladiator)",0, true, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration < 3200 }, Mechanic.TriggerRule.AND), //
