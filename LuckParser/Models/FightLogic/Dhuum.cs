...
namespace LuckParser.Models.Logic
{
    public class Dhuum : RaidLogic
    {
        ...
        public Dhuum(ushort triggerID) : base(triggerID)
        {
            ...
            new PlayerBoonRemoveMechanic(47646, "Arcing Affliction", new MechanicPlotlySetting("diamond","rgb(255,0,0)"), "Bomb Trig","Arcing Affliction (Bomb) manualy triggered", "Bomb Triggered",0, new List<BoonRemoveMechanic.BoonRemoveChecker>{ (br, log) => br.RemovedDuration > 50 && br.By != br.To }, Mechanic.TriggerRule.AND),
