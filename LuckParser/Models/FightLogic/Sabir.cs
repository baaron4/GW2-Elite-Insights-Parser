    ...
    public class Sabir : RaidLogic
    {
        public Sabir(ushort triggerID) : base(triggerID)
        {
            MechanicList.AddRange(new List<Mechanic>()
            {
                ...
                new EnemyCastMechanic(56349, "Regenerative Breakbar", new MechanicPlotlySetting("cross","rgb(255,150,0)"), "Reg.Breakbar","Regenerating Breakbar", "Regenerative Breakbar", 0, false),
