...
namespace LuckParser.Models.Logic
{
    public class Siax : FractalLogic
    {
        public Siax(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastEndMechanic(37320, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "Phase Fail","Phase Fail (Failed to kill Echos in time)", "Phase Fail", 0, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration >= 20649 }), //
            ...
            new EnemyCastEndMechanic(36929, "Caustic Explosion", new MechanicPlotlySetting("diamond-wide","rgb(255,0,0)"), "CC Fail","Failed to CC in time", "CC Fail", 0, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration >= 15232 }),
