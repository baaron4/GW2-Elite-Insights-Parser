...
namespace LuckParser.Models.Logic
{
    public class Siax : FractalLogic
    {
        public Siax(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(37320, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "Phase Fail","Phase Fail (Failed to kill Echos in time)", "Phase Fail", 0, new List<MechanicChecker>{ new CombatItemValueChecker(20649, MechanicChecker.ValueCompare.GEQ) }, Mechanic.TriggerRule.AND), //
            ...
            new EnemyCastMechanic(36929, "Caustic Explosion", new MechanicPlotlySetting("diamond-wide","rgb(255,0,0)"), "CC Fail","Failed to CC in time", "CC Fail", 0, new List<MechanicChecker>{ new CombatItemValueChecker(15232, MechanicChecker.ValueCompare.GEQ) }, Mechanic.TriggerRule.AND), 
