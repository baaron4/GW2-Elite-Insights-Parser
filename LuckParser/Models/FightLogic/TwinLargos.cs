...
namespace LuckParser.Models.Logic
{
    public class TwinLargos : RaidLogic
    {
        public TwinLargos(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyBoonApplyMechanic(52626, "Enraged (Nikare)", new MechanicPlotlySetting("star-diamond","rgb(255,0,0)"), "Nik Enrage","Enraged (Kenut Dead)", "Nikare Enrage",0,(condition => condition.SrcInstid == Targets.Find(x => x.ID == (ushort)ParseEnum.TargetIDS.Nikare).InstID)),
            new EnemyBoonApplyMechanic(52626, "Enraged (Kenut)", new MechanicPlotlySetting("star-diamond","rgb(255,0,0)"), "Ken Enrage","Enraged (Nikare Dead)", "Kenut Enrage",0,(condition => condition.SrcInstid == Targets.Find(x => x.ID == (ushort)ParseEnum.TargetIDS.Kenut).InstID)),
