...
namespace LuckParser.Models.Logic
{
    public class SoullessHorror : RaidLogic
    {
        public SoullessHorror(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(48662, "Howling Death", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Howling Death (Breakbar) broken", "CCed",0,new List<MechanicChecker>{ new CombatItemValueChecker(6800, MechanicChecker.ValueCompare.LEQ) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(48662, "Howling Death", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Howling Death (Breakbar failed) ", "CC Fail",0,new List<MechanicChecker>{ new CombatItemValueChecker(6800, MechanicChecker.ValueCompare.G) }, Mechanic.TriggerRule.AND),
