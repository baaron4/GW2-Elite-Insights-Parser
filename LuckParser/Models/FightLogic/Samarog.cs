...
namespace LuckParser.Models.Logic
{
    public class Samarog : RaidLogic
    {
        public Samarog(ushort triggerID) : base(triggerID)
        {
            ...
            new DamageOnPlayerMechanic(38013, "Brutalize", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Brutalize (Failed CC)", "CC Fail",0, new List<MechanicChecker>{ new CombatItemResultChecker(ParseEnum.Result.KillingBlow) }, Mechanic.TriggerRule.AND),
