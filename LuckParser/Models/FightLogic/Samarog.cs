...
namespace LuckParser.Models.Logic
{
    public class Samarog : RaidLogic
    {
        public Samarog(ushort triggerID) : base(triggerID)
        {
            ...
            new HitOnPlayerMechanic(38013, "Brutalize", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Brutalize (Failed CC)", "CC Fail",0,(condition => condition.ResultEnum == ParseEnum.Result.KillingBlow)),
            new EnemyCastEndMechanic(38013, "Brutalize", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CC End","Ended Brutalize", "CC Ended",0,(condition => (condition.IsActivation == ParseEnum.Activation.CancelCancel || condition.IsActivation == ParseEnum.Activation.CancelFire))),
