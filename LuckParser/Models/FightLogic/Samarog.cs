...
namespace LuckParser.Models.Logic
{
    public class Samarog : RaidLogic
    {
        public Samarog(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new SkillOnPlayerMechanic(38013, "Brutalize", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Brutalize (Failed CC)", "CC Fail",0, new List<DamageMechanic.DamageChecker>{ (de, log) => de.HasKilled }, Mechanic.TriggerRule.AND),
