...
namespace LuckParser.Models.Logic
{
    public class Xera : RaidLogic
    {
        ...
        public Xera(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Summon Fragment (Failed CC)", "CC Fail",0,new List<MechanicChecker>{ new CombatItemValueChecker(11940, MechanicChecker.ValueCompare.G) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Summon Fragment (Breakbar broken)", "CCed",0,new List<MechanicChecker>{ new CombatItemValueChecker(11940, MechanicChecker.ValueCompare.LEQ) }, Mechanic.TriggerRule.AND),
