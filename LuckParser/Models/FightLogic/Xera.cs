...
namespace LuckParser.Models.Logic
{
    public class Xera : RaidLogic
    {
        ...
        public Xera(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastMechanic(34887, "Summon Fragment Start", new MechanicPlotlySetting("diamond-tall","rgb(0,160,150)"), "CC","Summon Fragment (Xera Breakbar)", "Breakbar",0, false),
            new EnemyCastMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Summon Fragment (Failed CC)", "CC Fail",0, true, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration > 11940 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Summon Fragment (Breakbar broken)", "CCed",0, true, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration <= 11940 }, Mechanic.TriggerRule.AND),
        ...
        public override List<AbstractBuffEvent> CreateCustomBuffEvents(Dictionary<AgentItem, List<AbstractBuffEvent>> buffsByDst, Dictionary<long, List<AbstractBuffEvent>> buffsById, FightData fightData, SkillData skillData)
        {
            ...
            {
                res.Add(new BuffRemoveAllEvent(mainTarget.AgentItem, mainTarget.AgentItem, fightData.ToFightSpace(_specialSplitLogTime), int.MaxValue, skillData.Get(762), 1, int.MaxValue));
                res.Add(new BuffRemoveManualEvent(mainTarget.AgentItem, mainTarget.AgentItem, fightData.ToFightSpace(_specialSplitLogTime), int.MaxValue, skillData.Get(762)));
            }
            return res;
        }
