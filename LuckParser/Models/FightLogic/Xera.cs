...
namespace LuckParser.Models.Logic
{
    public class Xera : RaidLogic
    {
        ...
        public Xera(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastEndMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Summon Fragment (Failed CC)", "CC Fail",0, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration > 11940 }, Mechanic.TriggerRule.AND),
            new EnemyCastEndMechanic(34887, "Summon Fragment End", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Summon Fragment (Breakbar broken)", "CCed",0, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration <= 11940 }, Mechanic.TriggerRule.AND),
