...
namespace LuckParser.Models.Logic
{
    public class Deimos : RaidLogic
    {
        ...
        public Deimos(ushort triggerID) : base(triggerID)
        {
            ...
            new DamageOnPlayerMechanic(37613, "Mind Crush", new MechanicPlotlySetting("square","rgb(0,0,255)"), "Mind Crush","Hit by Mind Crush without Bubble Protection", "Mind Crush",0,new List<MechanicChecker>{ new CombatItemValueChecker(0, MechanicChecker.ValueCompare.G) }, Mechanic.TriggerRule.AND),
