...
namespace LuckParser.Models.Logic
{
    public class Deimos : RaidLogic
    {
        ...
        public Deimos(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(37846, "Off Balance", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "TP CC Fail","Failed Saul TP CC", "Failed CC (TP)",0, new List<CastMechanic.CastChecker>{ (ce,log) => (ce.ReducedAnimation || ce.FullAnimation || ce.ActualDuration >= 2200) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(37846, "Off Balance", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "TP CCed","Saul TP CCed", "CCed (TP)",0, new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 2200) }, Mechanic.TriggerRule.AND),
            ...
            new EnemyCastMechanic(38272, "Boon Thief", new MechanicPlotlySetting("diamond-wide","rgb(255,0,0)"), "Thief CC Fail","Failed Boon Thief CC", "Failed CC (Thief)",0,new List<CastMechanic.CastChecker>{ (ce,log) => (ce.ReducedAnimation || ce.FullAnimation || ce.ActualDuration >= 4400) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(38272, "Boon Thief", new MechanicPlotlySetting("diamond-wide","rgb(0,160,0)"), "Thief CCed","Boon Thief CCed", "CCed (Thief)",0,new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 4400) }, Mechanic.TriggerRule.AND),
            ...
            new SkillOnPlayerMechanic(37613, "Mind Crush", new MechanicPlotlySetting("square","rgb(0,0,255)"), "Mind Crush","Hit by Mind Crush without Bubble Protection", "Mind Crush",0,new List<DamageMechanic.DamageChecker>{ (de,log) => de.Damage > 0 }, Mechanic.TriggerRule.AND),
