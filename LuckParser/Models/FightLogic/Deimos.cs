...
namespace LuckParser.Models.Logic
{
    public class Deimos : RaidLogic
    {
        ...
        public Deimos(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastMechanic(37846, "Off Balance", new MechanicPlotlySetting("diamond-tall","rgb(0,160,150)"), "TP CC","Off Balance (Saul TP Breakbar)", "Saul TP Start",0, false),
            new EnemyCastMechanic(37846, "Off Balance", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "TP CC Fail","Failed Saul TP CC", "Failed CC (TP)",0, true, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration >= 2200 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(37846, "Off Balance", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "TP CCed","Saul TP CCed", "CCed (TP)",0, true, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration < 2200 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(38272, "Boon Thief", new MechanicPlotlySetting("diamond-wide","rgb(0,160,150)"), "Thief CC","Boon Thief (Saul Breakbar)", "Boon Thief Start",0, false),
            new EnemyCastMechanic(38272, "Boon Thief", new MechanicPlotlySetting("diamond-wide","rgb(255,0,0)"), "Thief CC Fail","Failed Boon Thief CC", "Failed CC (Thief)",0, true,new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration >= 4400 }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(38272, "Boon Thief", new MechanicPlotlySetting("diamond-wide","rgb(0,160,0)"), "Thief CCed","Boon Thief CCed", "CCed (Thief)",0, true,new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration < 4400 }, Mechanic.TriggerRule.AND),
