...
namespace LuckParser.Models.Logic
{
    public class Qadim : RaidLogic
    {
        public Qadim(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(51943, "Qadim CC", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "Qadim CCed","Quadim Breakbar broken", "Quadim CCed",0, new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 6500) }, Mechanic.TriggerRule.AND),
            ...
            new DamageOnPlayerMechanic(52265, "Riposte", new MechanicPlotlySetting("circle","rgb(255,0,255)"), "NoCC Attack", "Riposte (Attack if CC on Qadim failed)", "Riposte (No CC)", 0),
            new DamageOnPlayerMechanic(52614, "Fiery Dance", new MechanicPlotlySetting("asterisk-open","rgb(255,100,0)"), "Fiery Dance", "Fiery Dance (Fire running along metal edges)", "Fire on Lines", 0),
            new DamageOnPlayerMechanic(52864, "Fiery Dance", new MechanicPlotlySetting("asterisk-open","rgb(255,100,0)"), "Fiery Dance", "Fiery Dance (Fire running along metal edges)", "Fire on Lines", 0),
            new DamageOnPlayerMechanic(53153, "Fiery Dance", new MechanicPlotlySetting("asterisk-open","rgb(255,100,0)"), "Fiery Dance", "Fiery Dance (Fire running along metal edges)", "Fire on Lines", 0),
            new DamageOnPlayerMechanic(52383, "Fiery Dance", new MechanicPlotlySetting("asterisk-open","rgb(255,100,0)"), "Fiery Dance", "Fiery Dance (Fire running along metal edges)", "Fire on Lines", 0),
            new DamageOnPlayerMechanic(52242, "Shattering Impact", new MechanicPlotlySetting("circle","rgb(255,200,0)"), "Stun","Shattering Impact (Stunning flame bolt)", "Flame Bolt Stun",0),
            new DamageOnPlayerMechanic(52814, "Flame Wave", new MechanicPlotlySetting("star-triangle-up-open","rgb(255,150,0)"), "KB","Flame Wave (Knockback Frontal Beam)", "KB Push",0),
            new DamageOnPlayerMechanic(52820, "Fire Wave", new MechanicPlotlySetting("circle-open","rgb(255,100,0)"), "Qadim Wave","Fire Wave (Shockwave after Qadim's Mace attack)", "Mace Shockwave",0),
            new DamageOnPlayerMechanic(52224, "Fire Wave", new MechanicPlotlySetting("circle-open","rgb(255,100,0)"), "Destr Wave","Fire Wave (Shockwave after Destroyer's Jump or Stomp)", "Destroyer Shockwave",0),
            new DamageOnPlayerMechanic(52520, "Elemental Breath", new MechanicPlotlySetting("triangle-left","rgb(255,0,0)"), "Hydra Breath","Elemental Breath (Hydra Breath)", "Hydra Breath",0),
            new DamageOnPlayerMechanic(53013, "Fireball", new MechanicPlotlySetting("circle-open","rgb(255,200,0)",10), "Hydra FBall","Fireball (Hydra)", "Hydra Fireball",0),
            new DamageOnPlayerMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("circle-open","rgb(255,150,0)"), "Hydra Meteor","Fiery Meteor (Hydra)", "Hydra Meteor",0),
            ...
            new EnemyCastMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "Hydra CCed","Fiery Meteor (Hydra Breakbar broken)", "Hydra CCed",0,new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 12364) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "Hydra CC Fail","Fiery Meteor (Hydra Breakbar not broken)", "Hydra CC Failed",0,new List<CastMechanic.CastChecker>{ (ce,log) => (ce.ReducedAnimation || ce.FullAnimation || ce.ActualDuration >= 12364) }, Mechanic.TriggerRule.AND),
            new DamageOnPlayerMechanic(53051, "Teleport", new MechanicPlotlySetting("circle","rgb(150,0,200)"), "Hydra KB","Teleport Knockback (Hydra)", "Hydra TP KB",0),
            new DamageOnPlayerMechanic(52310, "Big Hit", new MechanicPlotlySetting("circle","rgb(255,0,0)"), "Mace","Big Hit (Mace Impact)", "Mace Impact",0),
            new DamageOnPlayerMechanic(52587, "Inferno", new MechanicPlotlySetting("triangle-down-open","rgb(255,0,0)"), "Inferno","Inferno (Lava Pool drop  on long platform spokes)", "Inferno Pool",0),
            new DamageOnPlayerMechanic(51958, "Slash (Wyvern)", new MechanicPlotlySetting("triangle-down-open","rgb(255,200,0)"), "Slash","Wyvern Slash (Double attack: knock into pin down)", "KB/Pin down",0),
            new DamageOnPlayerMechanic(52705, "Tail Swipe", new MechanicPlotlySetting("diamond-open","rgb(255,200,0)"), "Wyv Pizza","Wyvern Tail Swipe (Pizza attack)", "Tail Swipe",0),
            new DamageOnPlayerMechanic(52726, "Fire Breath", new MechanicPlotlySetting("triangle-right-open","rgb(255,100,0)"), "Wyv Breath","Fire Breath (Wyvern)", "Fire Breath",0),
            new DamageOnPlayerMechanic(52734, "Wing Buffet", new MechanicPlotlySetting("star-diamond-open","rgb(0,125,125)"), "Wyv Wing","Wing Buffet (Wyvern Launching Wing Storm)", "Wing Buffet",0),
            ...
            new EnemyCastMechanic(53132, "Patriarch CC", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "Wyv CCed","Platform Destruction (Patriarch Breakbar broken)", "Patriarch CCed",0, new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 6500)  }, Mechanic.TriggerRule.AND),
            ...
            new DamageOnPlayerMechanic(52330, "Seismic Stomp", new MechanicPlotlySetting("star-open","rgb(255,255,0)"), "Dest Stomp","Seismic Stomp (Destroyer Stomp)", "Seismic Stomp (Destroyer)",0),
            new DamageOnPlayerMechanic(51923, "Shattered Earth", new MechanicPlotlySetting("hexagram-open","rgb(255,0,0)"), "Dest Slam","Shattered Earth (Destroyer Jump Slam)", "Jump Slam (Destroyer)",0),
            new DamageOnPlayerMechanic(51759, "Wave of Force", new MechanicPlotlySetting("diamond-open","rgb(255,200,0)"), "Dest Pizza","Wave of Force (Destroyer Pizza)", "Destroyer Auto",0),
            ...
            new EnemyCastMechanic(52054, "Summon", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "Dest CCed","Summon (Destroyer Breakbar broken)", "Destroyer CCed",0, new List<CastMechanic.CastChecker>{ (ce, log) => (ce.Interrupted || ce.ActualDuration < 8332)  }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(52054, "Summon", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "Dest CC Fail","Summon (Destroyer Breakbar failed)", "Destroyer CC Fail",0, new List<CastMechanic.CastChecker>{ (ce,log) => (ce.ReducedAnimation || ce.FullAnimation || ce.ActualDuration >= 8332) }, Mechanic.TriggerRule.AND),
            ...
            new DamageOnPlayerMechanic(51879, "Body of Flame", new MechanicPlotlySetting("star-open","rgb(255,150,0)",10), "Pyre AoE","Body of Flame (Pyre Ground AoE (CM))", "Pyre Hitbox AoE",0),
            new DamageOnPlayerMechanic(52461, "Sea of Flame", new MechanicPlotlySetting("circle-open","rgb(255,0,0)"), "Qadim Hitbox","Sea of Flame (Stood in Qadim Hitbox)", "Qadim Hitbox AoE",0),
            new DamageOnPlayerMechanic(52221, "Claw", new MechanicPlotlySetting("triangle-left-open","rgb(0,150,150)",10), "Claw","Claw (Reaper of Flesh attack)", "Reaper Claw",0),
            new DamageOnPlayerMechanic(52281, "Swap", new MechanicPlotlySetting("circle-cross-open","rgb(170,0,170)"), "Port","Swap (Ported from below Legendary Creature to Qadim)", "Port to Qadim",0),
