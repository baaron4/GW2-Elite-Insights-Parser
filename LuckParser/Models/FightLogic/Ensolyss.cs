...
namespace LuckParser.Models
{
    public class Ensolyss : FractalLogic
    {
        public Ensolyss(ushort triggerID) : base(triggerID)
        {
            ...
            {
            new Mechanic(37154, "Lunge", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("triangle-right-open","rgb(255,140,0)"), "Chrg","Lunge (KB charge over arena)", "Charge",150), 
            new Mechanic(37278, "Upswing", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(255,100,0)"), "Smsh1","High damage Jump hit", "First Smash",0),
            new Mechanic(36927, "Lunge", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("triangle-right-open","rgb(255,140,0)"), "Chrg","Lunge (KB charge over arena)", "Charge",150), 
            new Mechanic(36962, "Upswing", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(255,200,0)"), "Smsh2","Torment Explosion from Illusions after jump", "Torment Smash",50),
            ...
            new Mechanic(37523, "Nightmare Devastation", Mechanic.MechType.EnemyCastStart, new MechanicPlotlySetting("square-open","rgb(0,0,255)"), "Bbbl","Nightmare Devastation (bubble attack)", "Bubble",0), 
            new Mechanic(37050, "Nightmare Devastation", Mechanic.MechType.EnemyCastStart, new MechanicPlotlySetting("square-open","rgb(0,0,255)"), "Bbbl","Nightmare Devastation (bubble attack)", "Bubble",0),
            ...
            new Mechanic(37434, "Rampage", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("asterisk-open","rgb(255,0,0)"), "Rmpg","Rampage (asterisk shaped Arrow attack)", "Rampage",150),
            ...
            new Mechanic(36926, "Tormenting Blast", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("diamond","rgb(255,255,0)"), "Qrtr","Tormenting Blast (Two Quatrer Circle attacks)", "Quarter circle",0), 
            });
            Extension = "ensol";
