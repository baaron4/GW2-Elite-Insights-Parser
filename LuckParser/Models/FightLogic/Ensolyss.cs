...
namespace LuckParser.Models.Logic
{
    public class Ensolyss : FractalLogic
    {
        public Ensolyss(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastEndMechanic(37096, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","After Phase CC Failed", "CC Fail", 0, new List<CastMechanic.CastChecker>{ (ce,log) => ce.ActualDuration >= 15260 }, Mechanic.TriggerRule.AND),
            new EnemyCastEndMechanic(37096, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","After Phase CC Success", "CCed", 0, new List<CastMechanic.CastChecker>{ (ce, log) => ce.ActualDuration < 15260 }, Mechanic.TriggerRule.AND),
