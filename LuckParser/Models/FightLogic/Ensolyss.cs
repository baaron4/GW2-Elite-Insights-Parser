...
namespace LuckParser.Models.Logic
{
    public class Ensolyss : FractalLogic
    {
        public Ensolyss(ushort triggerID, AgentData agentData) : base(triggerID, agentData)
        {
            ...
            new EnemyCastMechanic(37096, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","After Phase CC Failed", "CC Fail", 0, new List<MechanicChecker>{ new CombatItemValueChecker(15260, MechanicChecker.ValueCompare.GEQ) }, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(37096, "Caustic Explosion", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","After Phase CC Success", "CCed", 0,  new List<MechanicChecker>{ new CombatItemValueChecker(15260, MechanicChecker.ValueCompare.L) }, Mechanic.TriggerRule.AND),
