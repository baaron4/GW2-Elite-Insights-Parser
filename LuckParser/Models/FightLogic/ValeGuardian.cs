...
namespace LuckParser.Models.Logic
{
    public class ValeGuardian : RaidLogic
    {
        public ValeGuardian(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastEndMechanic(31419, "Magic Storm", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Magic Storm (Breakbar broken) ", "CCed",0, new List<CastMechanic.CastChecker>{ (c, log) => c.ActualDuration <= 8544}),
            new EnemyCastEndMechanic(31419, "Magic Storm", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Magic Storm (Breakbar failed) ", "CC Fail",0,new List<CastMechanic.CastChecker>{ (c, log) => c.ActualDuration > 8544 }),
            });
            Extension = "vg";
