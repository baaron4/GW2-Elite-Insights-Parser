...
namespace LuckParser.Models.Logic
{
    public class ValeGuardian : RaidLogic
    {
        public ValeGuardian(ushort triggerID) : base(triggerID)
        {
            ...
            new EnemyCastMechanic(31340, "Distributed Magic", new MechanicPlotlySetting("circle-open","rgb(0,128,255)") , "Green Cast B","Distributed Magic (Green Field appeared in Blue Sector)", "Green in Blue",0, false),
            ...
            new EnemyCastMechanic(31391, "Distributed Magic", new MechanicPlotlySetting("circle-open","rgb(255,128,0)"), "Green Cast R","Distributed Magic (Green Field appeared in Red Sector)", "Green in Red",0, false),
            ...
            new EnemyCastMechanic(31750, "Distributed Magic", new MechanicPlotlySetting("circle-open","rgb(0,255,0)"), "Green Cast G","Distributed Magic (Green Field appeared in Green Sector)", "Green in Green",0, false),
            ...
            new EnemyCastMechanic(31419, "Magic Storm", new MechanicPlotlySetting("diamond-tall","rgb(0,160,150)"), "CC","Magic Storm (Breakbar)","Breakbar",0, false),
            new EnemyCastMechanic(31419, "Magic Storm", new MechanicPlotlySetting("diamond-tall","rgb(0,160,0)"), "CCed","Magic Storm (Breakbar broken) ", "CCed",0, true, new List<CastMechanic.CastChecker>{ (c, log) => c.ActualDuration <= 8544}, Mechanic.TriggerRule.AND),
            new EnemyCastMechanic(31419, "Magic Storm", new MechanicPlotlySetting("diamond-tall","rgb(255,0,0)"), "CC Fail","Magic Storm (Breakbar failed) ", "CC Fail",0, true,new List<CastMechanic.CastChecker>{ (c, log) => c.ActualDuration > 8544 }, Mechanic.TriggerRule.AND),
            });
            Extension = "vg";
