...
namespace LuckParser.Models
{
    public class Cairn : RaidLogic
    {
        public Cairn(ushort triggerID) : base(triggerID)
        {
            ...
            new Mechanic(38113, "Displacement", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(255,140,0)"), "TP","Orange Teleport Field", "Orange TP",0), 
            new Mechanic(37611, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0), 
            new Mechanic(37629, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0),
            new Mechanic(37642, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0),
            new Mechanic(37673, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0),
            new Mechanic(38074, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0),
            new Mechanic(38302, "Spatial Manipulation", Mechanic.MechType.SkillOnPlayer, new MechanicPlotlySetting("circle","rgb(0,255,0)"), "Grn","Green Spatial Manipulation Field (lift)", "Green",0),
            ...
            new Mechanic(38049, "Shared Agony", Mechanic.MechType.PlayerBoon, new MechanicPlotlySetting("circle","rgb(255,0,0)"), "SA","Shared Agony Debuff Application", "Shared Agony",0),//could flip
            new Mechanic(38170, "Shared Agony", Mechanic.MechType.PlayerBoon, new MechanicPlotlySetting("star-triangle-up-open","rgb(255,150,0)"), "SA.25","Shared Agony Damage (25% Player's HP)", "SA dmg 25%",0), // Seems to be a (invisible) debuff application for 1 second from the Agony carrier to the closest(?) person in the circle.
            new Mechanic(37768, "Shared Agony", Mechanic.MechType.PlayerBoon, new MechanicPlotlySetting("star-diamond-open","rgb(255,50,0)"), "SA.50","Shared Agony Damage (50% Player's HP)", "SA dmg 50%",0), //Chaining from the first person hit by 38170, applying a 1 second debuff to the next person.
            new Mechanic(38209, "Shared Agony", Mechanic.MechType.PlayerBoon, new MechanicPlotlySetting("star-open","rgb(200,0,0)"), "SA.75","Shared Agony Damage (75% Player's HP)", "SA dmg 75%",0), //Chaining from the first person hit by 37768, applying a 1 second debuff to the next person.
