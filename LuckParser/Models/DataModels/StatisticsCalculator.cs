            ...
            for (int phaseIndex = 0; phaseIndex < _statistics.Phases.Count; phaseIndex++)
            {
                ...
                foreach (Boon boon in boonsToTrack)
                {
                    ...
                    foreach (BoonDistribution boons in boonDistributions.Values)
                    {
                        ...
                        {
                            totalGeneration += boons.GetGeneration(boon.ID, player);
                            totalOverstack += boons.GetOverstack(boon.ID, player);
                            totalWasted += boons.GetWaste(boon.ID, player);
                            totalUnknownExtension += boons.GetUnknownExtension(boon.ID, player);
                            totalExtension += boons.GetExtension(boon.ID, player);
                            totalExtended += boons.GetExtended(boon.ID, player);
                        }
                    }
            ...
            foreach (Player player in _log.PlayerList)
            {
                ...
                for (int phaseIndex = 0; phaseIndex < _statistics.Phases.Count; phaseIndex++)
                {
                    ...
                    foreach (Boon boon in player.TrackedBoons)
                    {
                        ...
                        {
                            long generation = selfBoons.GetGeneration(boon.ID, player);
                            if (boon.Type == Boon.BoonType.Duration)
                            {
                                ...
                                uptime.Overstack = Math.Round(100.0 * (selfBoons.GetOverstack(boon.ID, player) + generation) / fightDuration, 2);
                                uptime.Wasted = Math.Round(100.0 * selfBoons.GetWaste(boon.ID, player) / fightDuration, 2);
                                uptime.UnknownExtension = Math.Round(100.0 * selfBoons.GetUnknownExtension(boon.ID, player) / fightDuration, 2);
                                uptime.Extension = Math.Round(100.0 * selfBoons.GetExtension(boon.ID, player) / fightDuration, 2);
                                uptime.Extended = Math.Round(100.0 * selfBoons.GetExtended(boon.ID, player) / fightDuration, 2);
                            }
                            else if (boon.Type == Boon.BoonType.Intensity)
                            {
                                ...
                                uptime.Overstack = Math.Round((double)(selfBoons.GetOverstack(boon.ID, player) + generation) / fightDuration, 2);
                                uptime.Wasted = Math.Round((double)selfBoons.GetWaste(boon.ID, player) / fightDuration, 2);
                                uptime.UnknownExtension = Math.Round((double)selfBoons.GetUnknownExtension(boon.ID, player) / fightDuration, 2);
                                uptime.Extension = Math.Round((double)selfBoons.GetExtension(boon.ID, player) / fightDuration, 2);
                                uptime.Extended = Math.Round((double)selfBoons.GetExtended(boon.ID, player) / fightDuration, 2);
                    ...
                    foreach (Boon boon in target.TrackedBoons)
                    {
                        ...
                        if (boonDistribution.ContainsKey(boon.ID))
                        {
                            if (boon.Type == Boon.BoonType.Duration)
                            {
                                ...
                                {
                                    long gen = boonDistribution.GetGeneration(boon.ID, p);
                                    buff.Generated[p] = Math.Round(100.0 * gen / fightDuration, 2);
                                    buff.Overstacked[p] = Math.Round(100.0 * (boonDistribution.GetOverstack(boon.ID, p) + gen) / fightDuration, 2);
                                    buff.Wasted[p] = Math.Round(100.0 * boonDistribution.GetWaste(boon.ID, p) / fightDuration, 2);
                                    buff.UnknownExtension[p] = Math.Round(100.0 * boonDistribution.GetUnknownExtension(boon.ID, p) / fightDuration, 2);
                                    buff.Extension[p] = Math.Round(100.0 * boonDistribution.GetExtension(boon.ID, p) / fightDuration, 2);
                                    buff.Extended[p] = Math.Round(100.0 * boonDistribution.GetExtended(boon.ID, p) / fightDuration, 2);
                                }
                            }
                            else if (boon.Type == Boon.BoonType.Intensity)
                            {
                                ...
                                foreach (Player p in _log.PlayerList)
                                {
                                    ...
                                    buff.Overstacked[p] = Math.Round((double)(boonDistribution.GetOverstack(boon.ID, p) + gen) / fightDuration, 2);
                                    buff.Wasted[p] = Math.Round((double)boonDistribution.GetWaste(boon.ID, p) / fightDuration, 2);
                                    buff.UnknownExtension[p] = Math.Round((double)boonDistribution.GetUnknownExtension(boon.ID, p) / fightDuration, 2);
                                    buff.Extension[p] = Math.Round((double)boonDistribution.GetExtension(boon.ID, p) / fightDuration, 2);
                                    buff.Extended[p] = Math.Round((double)boonDistribution.GetExtended(boon.ID, p) / fightDuration, 2);
                                }
                                if (boonPresence.TryGetValue(boon.ID, out long presenceValueBoon))
                                {
