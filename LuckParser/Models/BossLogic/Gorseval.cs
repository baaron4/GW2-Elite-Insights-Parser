...
namespace LuckParser.Models
{
    public class Gorseval : RaidLogic
    {
        public Gorseval()
        {
            ...
            new Mechanic(738, "Ghastly Rampage Black Goo Hit", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Gorseval, "symbol:'circle',color:'rgb(0,0,0)',", "Black","Hit by Black Goo","Black Goo",3000,(value => value == 10000)),
            ...
            new Mechanic(31834, "Ghastly Rampage", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Gorseval, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.End","Ghastly Rampage (Full duration)", "CC ran out",0,(value => value > 21985)),
            new Mechanic(31834, "Ghastly Rampage", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Gorseval, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Ghastly Rampage (Breakbar broken)", "CCed",0,(value => value <= 21985)),
}); 
        }
