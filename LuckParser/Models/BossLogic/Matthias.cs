...
namespace LuckParser.Models
{
    public class Matthias : RaidLogic
    {
        public Matthias()
        {
            ...
            //new Mechanic(34442, "Sacrifice", Mechanic.MechType.PlayerBoonRemove, ParseEnum.BossIDS.Matthias, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Sacrifice broken", "Sacrifice broken",0),
            //new Mechanic(34442, "Sacrifice", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Matthias, "symbol:'diamond-tall',color:'rgb(0,160,150)',", "Scrfc","Sacrifice (Breakbar)", "Sacrifice",0),
            ...
            new Mechanic(34367, "Unbalanced", Mechanic.MechType.PlayerBoonRemove, ParseEnum.BossIDS.Matthias, "symbol:'square',color:'rgb(0,140,0)',", "KD","Unbalanced (triggered Storm phase Debuff) only on successful interrupt", "Knockdown (interrupt)",0,(condition => condition.getCombatItem().Result == ParseEnum.Result.Interrupt)),
