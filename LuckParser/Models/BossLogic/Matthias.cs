...
namespace LuckParser.Models
{
    public class Matthias : BossLogic
    {
        public Matthias() : base()
        {
            ...
            new Mechanic(34367, "Unbalanced", Mechanic.MechType.PlayerBoonRemove, ParseEnum.BossIDS.Matthias, "symbol:'square',color:'rgb(200,140,255)',", "KD",5000,(value => value > 0)), // Unbalanced (triggered Storm phase Debuff), Knockdown //Does this only trigger on actual Knockdown or also when just reaching 10 stacks and letting the debuff time out? Maybe check is_buffremove==3.
