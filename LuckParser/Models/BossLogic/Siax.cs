...
namespace LuckParser.Models
{
    public class Siax : FractalLogic
    {
        public Siax()
        {
            ...
            new Mechanic(37320, "Caustic Explosion", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Siax, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "Ph.Fail","Phase Fail (Failed to kill Echos in time)", "Phase Fail", 0, (value=> value >=20649)), //
            ...
            new Mechanic(36929, "Caustic Explosion", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Siax, "symbol:'diamond-wide',color:'rgb(255,0,0)',", "CC.Fail","Failed to CC in time", "CC Fail", 0, (value => value >=15232)), 
