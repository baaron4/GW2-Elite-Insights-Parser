...
namespace LuckParser.Models
{
    public class MursaatOverseer : RaidLogic
    {
        public MursaatOverseer()
        {
            ...
            new Mechanic(757, "Invulnerability", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.MursaatOverseer, "symbol:'circle-open',color:'rgb(0,255,255)',", "Prtct","Protected by the Protect Shield","Protect Shield",0,(value=> value == 1000)),
