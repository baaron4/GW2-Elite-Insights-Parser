...
namespace LuckParser.Models
{
    public class Xera : RaidLogic
    {
        public Xera()
        {
            ...
            new Mechanic(34887, "Summon Fragment End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Summon Fragment (Breakbar broken)", "CCed",0,(value => value <= 11940)),
