...
namespace LuckParser.Models
{
    public class Xera : BossLogic
    {
        public Xera()
        {
            ...
            new Mechanic(34887, "Summon Fragment End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(255,0,255)',", "CC.Fail",0,(value => value >= 11940)), //Summon Fragment (Failed CC), CC Fail
