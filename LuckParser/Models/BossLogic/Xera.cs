...
namespace LuckParser.Models
{
    public class Xera : BossLogic
    {
        public Xera()
        {
            ...
            new Mechanic(35084, "Bending Chaos", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Xera, "symbol:'triangle-down-open',color:'rgb(255,200,0)',","Bending Chaos (Stood on 1st Button)", "Button 1", "Btn1",0),
