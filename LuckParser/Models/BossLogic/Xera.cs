...
namespace LuckParser.Models
{
    public class Xera : BossLogic
    {
        public Xera()
        {
            ...
            new Mechanic(34887, "Summon Fragment Start", Mechanic.MechType.EnemyCastStart, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(0,160,150)',", "CC",0), //Summon Fragment (Xera Breakbar), Breakbar
            new Mechanic(34887, "Summon Fragment End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail",0,(value => value >= 11940)), //Summon Fragment (Failed CC), CC Fail
            ...
            new Mechanic(34997, "Teleport Out", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Xera, "symbol:'circle',color:'rgb(0,128,0)',", "TP.Out",0), //Teleport Out (Teleport to Platform),  TP
            new Mechanic(35076, "Hero's Return", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Xera, "symbol:'circle',color:'rgb(0,200,0)',", "TP.Back",0), //Hero's Return (Teleport back), TP back
