...
namespace LuckParser.Models
{
    public class Xera : BossLogic
    {
        public Xera() : base()
        {
            ...
            new Mechanic(34887, "Summon Fragment End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail",0,delegate(long value){return value >= 11940;}), //Summon Fragment (Failed CC), CC Fail
