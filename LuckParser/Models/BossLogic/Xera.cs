...
namespace LuckParser.Models
{
    public class Xera : BossLogic
    {
        public Xera() : base()
        {
            ...
            new Mechanic(34887, "Summon Fragment", Mechanic.MechType.BossCast, ParseEnum.BossIDS.Xera, "symbol:'diamond-tall',color:'rgb(255,0,255)',", "CC.Fail",0), //Summon Fragment (Failed CC), CC Fail
