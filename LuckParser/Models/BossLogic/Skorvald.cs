...
namespace LuckParser.Models
{
    public class Skorvald : FractalLogic
    {
        public Skorvald()
        {
            ...
            new Mechanic(39228, "Solar Cyclone", Mechanic.MechType.SkillOnPlayer, ParseEnum.BossIDS.Skorvald, "symbol:'asterisk-open',color:'rgb(140,0,140)',", "Cycln","Solar Cyclone (Circling Knockback)", "KB Cyclone",0),
            new Mechanic(791, "Fear", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Skorvald, "symbol:'square-open',color:'rgb(255,0,0)',", "Eye","Hit by the Overhead Eye Fear", "Eye (Fear)",0,(condition => condition.getCombatItem().Value == 3000)), //not triggered under stab, still get blinded/damaged, seperate tracking desired?
