...
namespace LuckParser.Models
{
    public class Skorvald : FractalLogic
    {
        ...
        { 
            ...
            new Mechanic(39507, "Horizon Strike", Mechanic.MechType.SkillOnPlayer, ParseEnum.BossIDS.Skorvald, "symbol:'circle',color:'rgb(128,0,0)',", "HS",0), // Horizon Strike (turning pizza slices), Horizon Strike
            new Mechanic(39846, "Crimson Dawn", Mechanic.MechType.SkillOnPlayer, ParseEnum.BossIDS.Skorvald, "symbol:'circle',color:'rgb(50,0,0)',", "HS.end",0), //Crimson Dawn (almost Full platform attack after Horizon Strike), Horizon Strike (last)
