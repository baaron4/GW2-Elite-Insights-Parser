...
namespace LuckParser.Models
{
    public class SoullessHorror : RaidLogic
    {
        public SoullessHorror()
        {
            ...
            new Mechanic(48662, "Howling Death", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.SoullessHorror, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Howling Death (Breakbar) broken", "CC Success",0,(value => value <=6800)),
