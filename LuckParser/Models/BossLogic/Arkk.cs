...
namespace LuckParser.Models
{
    public class Arkk : FractalLogic
    {
        public Arkk()
        {
            ...
            new Mechanic(791, "Fear", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Arkk, "symbol:'square-open',color:'rgb(255,0,0)',", "Eye","Hit by the Overhead Eye Fear", "Eye (Fear)",0,(condition => condition.getCombatItem().Value == 3000)), // //not triggered under stab, still get blinded/damaged, seperate tracking desired?
            ...
            new Mechanic(39645, "Breakbar End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail","Breakbar (Failed CC)", "CC Fail",0,(condition => condition.getCombatItem().Value > 9668)),
            new Mechanic(39645, "Breakbar End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Breakbar broken", "CCed",0,(condition => condition.getCombatItem().Value < 9668)),
            ...
            new Mechanic(35761, "Pull Charge", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'bowtie',color:'rgb(255,0,0)',", "Pll.Fail","Pull Charge CC failed", "CC fail (Gladiator)",0,(condition => condition.getCombatItem().Value > 3200)), //
            new Mechanic(35761, "Pull Charge", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'bowtie',color:'rgb(0,160,0)',", "Pll.CCed","Pull Charge CCed", "CCed (Gladiator)",0,(condition => condition.getCombatItem().Value <= 3200)), //
