...
namespace LuckParser.Models
{
    public class Arkk : FractalLogic
    {
        public Arkk()
        {
            ...
            new Mechanic(39645, "Breakbar End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail","Breakbar (Failed CC)", "CC Fail",0,(value => value > 9668)),
            new Mechanic(39645, "Breakbar End", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Breakbar broken", "CCed",0,(value => value < 9668)),
            ...
            new Mechanic(35761, "Pull Charge", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Arkk, "symbol:'bowtie',color:'rgb(0,160,0)',", "Pll.CCed","Pull Charge CCed", "CCed (Gladiator)",0,(value => value <= 3200)), //
