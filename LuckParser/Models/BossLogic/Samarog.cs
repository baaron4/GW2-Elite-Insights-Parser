...
namespace LuckParser.Models
{
    public class Samarog : RaidLogic
    {
        public Samarog()
        {
            ...
            new Mechanic(38013, "Brutalize", Mechanic.MechType.SkillOnPlayer, ParseEnum.BossIDS.Samarog, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail","Brutalize (Failed CC)", "CC Fail",0,(condition => condition.getDLog().Result == ParseEnum.Result.KillingBlow)),
