...
namespace LuckParser.Models
{
    public class BossLogic
    {
        ...
        protected readonly List<Mechanic> MechanicList = new List<Mechanic> {
            ...
            new Mechanic(SkillItem.ResuccectId, "Resurrect", Mechanic.MechType.PlayerStatus, ParseEnum.BossIDS.Unknown, "symbol:'cross-open',color:'rgb(0,255,255)',", "Res",0)}; //Resurrects (start), Resurrect
