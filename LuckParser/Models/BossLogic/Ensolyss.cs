...
namespace LuckParser.Models
{
    public class Ensolyss : FractalLogic
    {
        public Ensolyss()
        {
            ...
            new Mechanic(37096, "Caustic Explosion", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Ensolyss, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail","After Phase CC Failed", "CC Fail", 0, (value => value >=15260)),
            new Mechanic(37096, "Caustic Explosion", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Ensolyss, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","After Phase CC Success", "CCed", 0, (value => value <15260)),
