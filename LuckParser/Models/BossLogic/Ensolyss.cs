...
namespace LuckParser.Models
{
    public class Ensolyss : FractalLogic
    {
        public Ensolyss()
        {
            ...
            new Mechanic(37096, "Caustic Explosion", Mechanic.MechType.EnemyCastStart, ParseEnum.BossIDS.Ensolyss, "symbol:'diamond-wide',color:'rgb(0,200,100)',", "CC","After Phase CC", "Breakbar", 0),
            new Mechanic(37096, "Caustic Explosion", Mechanic.MechType.EnemyCastEnd, ParseEnum.BossIDS.Ensolyss, "symbol:'diamond-wide',color:'rgb(255,0,0)',", "CC.Fail","After Phase CC Failed", "CC Fail", 0, (value => value >=15260)),
