...
namespace LuckParser.Models
{
    public class Sabetha : BossLogic
    {
        public Sabetha() : base()
        {
            ...
            new Mechanic(31485, "Time Bomb", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Sabetha, "symbol:'circle-open',color:'rgb(255,0,0)',", "Time Bomb",0),//or 3? buff or hits //It's the buff, not the hit (see below)
            ...
            new Mechanic(31643, "Cannon Barrage", Mechanic.MechType.SkillOnPlayer, ParseEnum.BossIDS.Sabetha, "symbol:'circle',color:'rgb(255,200,0)',", "Cannon Shot",0),
