...
namespace LuckParser.Models
{
    public class Slothasor : RaidLogic
    {
        public Slothasor()
        {
            ...
            new Mechanic(34467, "Narcolepsy", Mechanic.MechType.EnemyBoonStrip, ParseEnum.BossIDS.Slothasor, "symbol:'diamond-tall',color:'rgb(255,0,0)',", "CC.Fail","Narcolepsy (Failed CC)", "CC Fail",0,(value => value > 120000)),
            new Mechanic(34467, "Narcolepsy", Mechanic.MechType.EnemyBoonStrip, ParseEnum.BossIDS.Slothasor, "symbol:'diamond-tall',color:'rgb(0,160,0)',", "CCed","Narcolepsy (Breakbar broken)", "CCed",0,(value => value <= 120000))
            });
        }
