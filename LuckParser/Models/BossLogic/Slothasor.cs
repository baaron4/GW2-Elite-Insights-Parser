...
namespace LuckParser.Models
{
    public class Slothasor : BossLogic
    {
        public Slothasor()
        {
            ...
            new Mechanic(34387, "Volatile Poison", Mechanic.MechType.PlayerBoon, ParseEnum.BossIDS.Slothasor, "symbol:'circle',color:'rgb(255,0,0)',", "Psn",0), //Volatile Poison Application (Special Action Key), Poison (Action Key)
