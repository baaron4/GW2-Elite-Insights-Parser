        ...
        private static List<Boon> _allBoons = new List<Boon>
            {
                ...
                //signets
                new Boon("Signet of Renewal (Active)",41147, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/1/11/Signet_of_Renewal.png"),
                new Boon("Signet of Stone (Active)",12627, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/6/63/Signet_of_Stone.png"),
                new Boon("Signet of the Hunt (Active)",12626, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/d/df/Signet_of_the_Hunt.png"),
                new Boon("Signet of the Wild (Active)",12636, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/2/23/Signet_of_the_Wild.png"),
                new Boon("Signet of Renewal",12538, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/1/11/Signet_of_Renewal.png"),
                new Boon("Signet of Stone",12543, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/6/63/Signet_of_Stone.png"),
                new Boon("Signet of the Hunt",12541, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/d/df/Signet_of_the_Hunt.png"),
                new Boon("Signet of the Wild",12518, BoonSource.Ranger, BoonType.Duration, 1, BoonEnum.GraphOnlyBuff, RemoveType.Manual, Logic.Override, "https://wiki.guildwars2.com/images/2/23/Signet_of_the_Wild.png"),
                //spirits
