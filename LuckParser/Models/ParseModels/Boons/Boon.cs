        ...
        private static List<Boon> _allBoons = new List<Boon>
            {
                ...
                new Boon("Bane Signet (PI)",9240, BoonSource.Guardian, BoonType.Duration, 1, BoonNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/5/56/Bane_Signet.png"),
                new Boon("Bane Signet (Shared)",-9240, BoonSource.Guardian, BoonType.Intensity, 99, BoonNature.OffensiveBuffTable, Logic.Override, "https://wiki.guildwars2.com/images/5/56/Bane_Signet.png"),
                ...
                new Boon("Signet of Judgment (PI)",9239, BoonSource.Guardian, BoonType.Duration, 1, BoonNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/f/fe/Signet_of_Judgment.png"),
                new Boon("Signet of Judgment (Shared)",-9239, BoonSource.Guardian, BoonType.Intensity, 99, BoonNature.DefensiveBuffTable, Logic.Override, "https://wiki.guildwars2.com/images/f/fe/Signet_of_Judgment.png"),
                ...
                new Boon("Signet of Mercy (PI)",9238, BoonSource.Guardian, BoonType.Duration, 1, BoonNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/3/37/Signet_of_Mercy.png"),
                new Boon("Signet of Mercy (Shared)",-9238, BoonSource.Guardian, BoonType.Intensity, 99, BoonNature.DefensiveBuffTable, Logic.Override, "https://wiki.guildwars2.com/images/3/37/Signet_of_Mercy.png"),
                ...
                new Boon("Signet of Wrath (PI)",9237, BoonSource.Guardian, BoonType.Duration, 1, BoonNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/1/18/Signet_of_Wrath.png"),
                new Boon("Signet of Wrath (Shared)",-9237, BoonSource.Guardian, BoonType.Intensity, 99, BoonNature.OffensiveBuffTable, Logic.Override, "https://wiki.guildwars2.com/images/1/18/Signet_of_Wrath.png"),
