        ...
        private static List<Boon> allBoons = new List<Boon>
            {
                ...
                // Condis         
                new Boon("Bleeding", 736, BoonSource.Mixed, BoonType.Intensity, 1500, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/3/33/Bleeding.png/20px-Bleeding.png"),
                new Boon("Burning", 737, BoonSource.Mixed, BoonType.Intensity, 1500, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/4/45/Burning.png/20px-Burning.png"),
                new Boon("Confusion", 861, BoonSource.Mixed, BoonType.Intensity, 1500, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/e/e6/Confusion.png/20px-Confusion.png"),
                new Boon("Poison", 723, BoonSource.Mixed, BoonType.Intensity, 1500, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/0/05/Poison.png/20px-Poison.png"),
                new Boon("Torment", 19426, BoonSource.Mixed, BoonType.Intensity, 1500, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/0/08/Torment.png/20px-Torment.png"),
                ...
                new Boon("Taunt", 46996, BoonSource.Mixed, BoonType.Duration, 5, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/c/cc/Taunt.png/20px-Taunt.png"),
                new Boon("Vulnerability", 738, BoonSource.Mixed, BoonType.Intensity, 25, BoonEnum.Condition, RemoveType.CleanseFriend, Logic.Queue, "https://wiki.guildwars2.com/images/thumb/a/af/Vulnerability.png/20px-Vulnerability.png"),
                ...
                new Boon("Koi Cake",-1, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Food,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/1/14/Koi_Cake.png"),
                ...
                new Boon("Plate of Mussels Gnashblade",-1, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Food,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/7/7b/Plate_of_Mussels_Gnashblade.png"),
                /// UTILITIES
                ...
                new Boon("Master Maintenance Oil",-1, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Utility,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
                ...
                new Boon("Toxic Sharpening Stone",-1, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Utility,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/d/db/Toxic_Sharpening_Stone.png"),
                ...
                new Boon("Potent Master Maintenance Oil",9968, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Utility,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
                new Boon("Furious Maintenance Oil",-1, BoonSource.Item, BoonType.Duration, 1, BoonEnum.Utility,RemoveType.None, Logic.Override, "https://wiki.guildwars2.com/images/5/5b/Master_Maintenance_Oil.png"),
