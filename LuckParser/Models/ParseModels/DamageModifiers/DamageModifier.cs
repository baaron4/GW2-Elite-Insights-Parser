...
namespace LuckParser.Models.ParseModels
{
    public abstract class DamageModifier
    {
        ...
        private static readonly List<DamageModifier> _gearDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(BoonHelper.NumberOfBoonsID, "Spellbreaker Rune", "7% on boonless target",  DamageSource.NoPets, 7.0, DamageType.Power, DamageType.Power, ModifierSource.ItemBuff, ByAbsence, "https://wiki.guildwars2.com/images/1/1a/Superior_Rune_of_the_Spellbreaker.png"),
        ...
        private static readonly List<DamageModifier> _revenantDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Reinforced Potency", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Herald, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png"),
        ...
        private static readonly List<DamageModifier> _warriorDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Empowered", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByStack, "https://wiki.guildwars2.com/images/c/c2/Empowered.png"),
            new BuffDamageModifierTarget(BoonHelper.NumberOfBoonsID, "Destruction of the Empowered", "3% per target boon", DamageSource.NoPets, 3.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByStack, "https://wiki.guildwars2.com/images/5/5c/Destruction_of_the_Empowered.png"),
        ...
        private static readonly List<DamageModifier> _guardianDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Power of the Virtuous", "1% per boon", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByStack, "https://wiki.guildwars2.com/images/e/ee/Power_of_the_Virtuous.png"),
        ...
        private static readonly List<DamageModifier> _engineerDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(BoonHelper.NumberOfConditionsID, "Modified Ammunition", "2% per condition on target", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Engineer, ByStack, "https://wiki.guildwars2.com/images/9/94/Modified_Ammunition.png"),
        };
        private static readonly List<DamageModifier> _thiefDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifierTarget(BoonHelper.NumberOfConditionsID, "Exposed Weakness", "2% per condition on target", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Thief, ByStack, "https://wiki.guildwars2.com/images/0/02/Exposed_Weakness.png", 90455, ulong.MaxValue),
            new BuffDamageModifierTarget(BoonHelper.NumberOfConditionsID, "Exposed Weakness", "10% if condition on target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Thief, ByPresence, "https://wiki.guildwars2.com/images/0/02/Exposed_Weakness.png", 0, 90455),
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Premeditation", "1% per boon",DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Deadeye, ByStack, "https://wiki.guildwars2.com/images/d/d7/Premeditation.png"),
        };
        private static readonly List<DamageModifier> _rangerDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Bountiful Hunter", "1% per boon", DamageSource.All, 1.0, DamageType.Power, DamageType.All, ModifierSource.Ranger, ByStack, "https://wiki.guildwars2.com/images/2/25/Bountiful_Hunter.png"),
        ...
        {
            new BuffDamageModifierTarget(BoonHelper.NumberOfBoonsID, "Spiteful Talisman", "10% on boonless target", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Necromancer, ByAbsence, "https://wiki.guildwars2.com/images/9/96/Spiteful_Talisman.png"),
        ...
        private static readonly List<DamageModifier> _elementalistDamageModifiers = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(BoonHelper.NumberOfBoonsID, "Bountiful Power", "2% per boon", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByStack, "https://wiki.guildwars2.com/images/7/75/Bountiful_Power.png"),
