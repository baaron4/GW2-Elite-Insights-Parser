...
namespace LuckParser.Models.ParseModels
{
    public abstract class DamageModifier
    {
        ...
        private static List<DamageModifier> _allDamageModifier = new List<DamageModifier>
        {
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Number of Boons"), "Reinforced Potency", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Herald, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png"),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Kalla's Fervor"), DamageSource.NoPets, 2.0, DamageType.Condition, DamageType.All, ModifierSource.Renegade, ByStack),
            new BuffDamageModifier(Boon.GetBoonByName("Improved Kalla's Fervor"), DamageSource.NoPets, 3.0, DamageType.Condition, DamageType.All, ModifierSource.Renegade, ByStack),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Number of Boons"), "Power of the Virtuous", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByStack, "https://wiki.guildwars2.com/images/e/ee/Power_of_the_Virtuous.png"),
            new BuffDamageModifierTarget(Boon.GetBoonByName("Crippled"), "Zealot's Aggression", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Dragonhunter, ByPresence, "https://wiki.guildwars2.com/images/7/7e/Zealot%27s_Aggression.png"),
            /// ENGINEER
            new BuffDamageModifier(Boon.GetBoonByName("Laser's Edge"), DamageSource.NoPets, 15.0, DamageType.Power, DamageType.All, ModifierSource.Holosmith, ByPresence),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Twice as Vicious"), DamageSource.NoPets, 5.0, DamageType.All, DamageType.All, ModifierSource.Soulbeast, ByPresence),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Fury"), "Furious Strength", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Soulbeast, ByStack, "https://wiki.guildwars2.com/images/c/ca/Furious_Strength.png"),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Lotus Training"), DamageSource.NoPets, 10.0, DamageType.Condition, DamageType.All, ModifierSource.Daredevil, ByPresence),
            new BuffDamageModifier(Boon.GetBoonByName("Bounding Dodger"), DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Daredevil, ByPresence),
            ...
            new BuffDamageModifier(Boon.GetBoonByName("Number of Boons"), "Premeditation", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Deadeye, ByStack, "https://wiki.guildwars2.com/images/d/d7/Premeditation.png"),
            /// MESMER
            ...
            new BuffDamageModifierTarget(Boon.GetBoonByName("Slow"), "Danger Time", DamageSource.All, 10.0, DamageType.Power, DamageType.All, ModifierSource.Chronomancer, ByPresence, "https://wiki.guildwars2.com/images/3/33/Fragility.png", (x => x.Result == ParseEnum.Result.Crit)),
            /// NECROMANCER     
            ...
            new BuffDamageModifierTarget(Boon.GetBoonByName("Chilled"), "Cold Shoulder", DamageSource.NoPets, 15.0, DamageType.Power, DamageType.All, ModifierSource.Reaper, ByPresence, "https://wiki.guildwars2.com/images/7/78/Cold_Shoulder.png"),
            /// ELEMENTALIST
            new BuffDamageModifier(Boon.GetBoonByName("Harmonious Conduit"), DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Tempest, ByPresence),
            new BuffDamageModifier(Boon.GetBoonByName("Weaver's Prowess"), DamageSource.NoPets, 10.0, DamageType.Condition, DamageType.All, ModifierSource.Weaver, ByPresence),
            new BuffDamageModifier(Boon.GetBoonByName("Elements of Rage"), DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Weaver, ByPresence),
            ...
            new BuffDamageModifier(new BuffsTrackerMulti(Boon.GetBoonByName("Swiftness"), Boon.GetBoonByName("Superspeed")), "Swift Revenge", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Weaver, "https://wiki.guildwars2.com/images/9/94/Swift_Revenge.png")
