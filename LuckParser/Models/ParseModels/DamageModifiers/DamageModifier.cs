...
namespace LuckParser.Models.ParseModels
{
    public abstract class DamageModifier
    {
        ...
        private static readonly List<DamageModifier> _elementalistDamageModifiers = new List<DamageModifier>
        {
            ...
            new DamageLogDamageModifier("Aquamancer's Training", "10% over 90% HP", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist,"https://wiki.guildwars2.com/images/8/81/Aquamancer%27s_Training.png", x => x.IsOverNinety, ByPresence),
