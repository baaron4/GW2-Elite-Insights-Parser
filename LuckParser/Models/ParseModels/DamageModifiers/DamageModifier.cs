...
namespace LuckParser.Models.ParseModels
{
    public abstract class DamageModifier
    {
        ...
        private static readonly List<DamageModifier> _allDamageModifier = new List<DamageModifier>() {
            ...
            new BuffDamageModifier(Boon.BoonsByName["Frost Spirit"], DamageSource.NoPets, 5.0, DamageType.Power, DamageType.All, ModifierSource.CommonBuff, ByPresence),
            ...
            /// Revenant
            new BuffDamageModifier(Boon.BoonsByName["Vicious Lacerations"], DamageSource.NoPets, 3.0, DamageType.Power, DamageType.All, ModifierSource.Revenant, ByStack),
            new BuffDamageModifier(Boon.BoonsByName["Retaliation"], "Vicious Reprisal", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Revenant, ByPresence, "https://wiki.guildwars2.com/images/c/cf/Vicious_Reprisal.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Weakness"], "Dwarven Battle Training", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Revenant, ByPresence, "https://wiki.guildwars2.com/images/5/50/Dwarven_Battle_Training.png"),
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Reinforced Potency", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Revenant, ByStack, "https://wiki.guildwars2.com/images/0/0a/Envoy_of_Sustenance.png"),
            ...
            new BuffDamageModifier(Boon.BoonsByName["Kalla's Fervor"], DamageSource.NoPets, 2.0, DamageType.Condition, DamageType.All, ModifierSource.Revenant, ByStack),
            new BuffDamageModifier(Boon.BoonsByName["Improved Kalla's Fervor"], DamageSource.NoPets, 3.0, DamageType.Condition, DamageType.All, ModifierSource.Revenant, ByStack),
            new BuffDamageModifierTarget(Boon.BoonsByName["Vulnerability"], "Targeted Destruction", DamageSource.NoPets, 0.5, DamageType.Power, DamageType.All, ModifierSource.Revenant, ByStack, "https://wiki.guildwars2.com/images/e/ed/Targeted_Destruction.png"),
            ...
            /// Warrior
            new BuffDamageModifier(Boon.BoonsByName["Peak Performance"], DamageSource.NoPets, 20.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByPresence),
            ...
            new BuffDamageModifierTarget(Boon.BoonsByName["Weakness"], "Cull the Weak", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByPresence, "https://wiki.guildwars2.com/images/7/72/Cull_the_Weak.png"),
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Empowered", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByStack, "https://wiki.guildwars2.com/images/c/c2/Empowered.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Number of Boons"], "Destruction of the Empowered", DamageSource.NoPets, 3.0, DamageType.Power, DamageType.All, ModifierSource.Warrior, ByStack, "https://wiki.guildwars2.com/images/5/5c/Destruction_of_the_Empowered.png"),
            ...
            /// Guardian
            new BuffDamageModifierTarget(Boon.BoonsByName["Burning"], "Fiery Wrath", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByPresence, "https://wiki.guildwars2.com/images/7/70/Fiery_Wrath.png"),
            new BuffDamageModifier(Boon.BoonsByName["Retaliation"], "Retribution", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByStack, "https://wiki.guildwars2.com/images/d/d7/Retribution_%28trait%29.png"),
            new BuffDamageModifier(Boon.BoonsByName["Aegis"], "Unscathed Contender", DamageSource.NoPets, 20.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByPresence, "https://wiki.guildwars2.com/images/b/b4/Unscathed_Contender.png"),
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Power of the Virtuous", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByStack, "https://wiki.guildwars2.com/images/b/b4/Unscathed_Contender.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Crippled"], "Zealot's Aggression", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Guardian, ByPresence, "https://wiki.guildwars2.com/images/b/b4/Unscathed_Contender.png"),
            /// ENGINEER
            new BuffDamageModifier(Boon.BoonsByName["Laser's Edge"], DamageSource.NoPets, 15.0, DamageType.Power, DamageType.All, ModifierSource.Engineer, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Thermal Vision"], DamageSource.NoPets, 5.0, DamageType.Condition, DamageType.All, ModifierSource.Engineer, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Vigor"], "Excessive Energy", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Engineer, ByPresence, "https://wiki.guildwars2.com/images/1/1f/Excessive_Energy.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Vulnerability"], "Shaped Charge", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Engineer, ByPresence, "https://wiki.guildwars2.com/images/f/f3/Explosive_Powder.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Number of Conditions"], "Modified Ammunition", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Engineer, ByStack, "https://wiki.guildwars2.com/images/9/94/Modified_Ammunition.png"),
            /// RANGER
            new BuffDamageModifier(Boon.BoonsByName["Sic 'Em!"], DamageSource.NoPets, 40.0, DamageType.Power, DamageType.All, ModifierSource.Ranger, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Light on your Feet"], DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Ranger, ByPresence),
            ...
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Bountiful Hunter", DamageSource.All, 1.0, DamageType.Power, DamageType.All, ModifierSource.Ranger, ByStack, "https://wiki.guildwars2.com/images/2/25/Bountiful_Hunter.png"),
            new BuffDamageModifier(Boon.BoonsByName["Fury"], "Furious Strength", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Ranger, ByStack, "https://wiki.guildwars2.com/images/c/ca/Furious_Strength.png"),
            ...
            new BuffDamageModifier(Boon.BoonsByName["Lotus Training"], DamageSource.NoPets, 10.0, DamageType.Condition, DamageType.All, ModifierSource.Thief, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Bounding Dodger"], DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Thief, ByPresence),
            new BuffDamageModifierTarget(Boon.BoonsByName["Number of Conditions"], "Exposed Weakness", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Thief, ByStack, "https://wiki.guildwars2.com/images/0/02/Exposed_Weakness.png"),
            ...
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Premeditation", DamageSource.NoPets, 1.0, DamageType.Power, DamageType.All, ModifierSource.Thief, ByStack, "https://wiki.guildwars2.com/images/d/d7/Premeditation.png"),
            /// MESMER
            new BuffDamageModifier(Boon.BoonsByName["Compounding Power"], DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Mesmer, ByStack),
            new BuffDamageModifierTarget(Boon.BoonsByName["Vulnerability"], "Fragility", DamageSource.NoPets, 0.5, DamageType.Power, DamageType.All, ModifierSource.Mesmer, ByStack, "https://wiki.guildwars2.com/images/3/33/Fragility.png"),
            ...
            new BuffDamageModifierTarget(Boon.BoonsByName["Slow"], "Danger Time", DamageSource.All, 10.0, DamageType.Power, DamageType.All, ModifierSource.Mesmer, ByPresence, "https://wiki.guildwars2.com/images/3/33/Fragility.png", (x => x.Result == ParseEnum.Result.Crit)),
            /// NECROMANCER     
            new BuffDamageModifierTarget(Boon.BoonsByName["Number of Boons"], "Spiteful Talisman", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Necromancer, ByAbsence, "https://wiki.guildwars2.com/images/9/96/Spiteful_Talisman.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Fear"], "Dread", DamageSource.NoPets, 33.0, DamageType.Power, DamageType.All, ModifierSource.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/e/e2/Unholy_Fervor.png"),
            ...
            new BuffDamageModifierTarget(Boon.BoonsByName["Chilled"], "Cold Shoulder", DamageSource.NoPets, 15.0, DamageType.Power, DamageType.All, ModifierSource.Necromancer, ByPresence, "https://wiki.guildwars2.com/images/7/78/Cold_Shoulder.png"),
            /// ELEMENTALIST
            new BuffDamageModifier(Boon.BoonsByName["Harmonious Conduit"], DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Weaver's Prowess"], DamageSource.NoPets, 10.0, DamageType.Condition, DamageType.All, ModifierSource.Elementalist, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Elements of Rage"], DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByPresence),
            new BuffDamageModifier(Boon.BoonsByName["Fire Attunement"], "Pyromancer's Training", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/e/e6/Pyromancer%27s_Training.png"),
            new BuffDamageModifierTarget(Boon.BoonsByName["Burning"], "Burning Rage", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/b/bd/Burning_Rage.png"),
            ...
            new BuffDamageModifierTarget(Boon.BoonsByName["Bleeding"], "Serrated Stones", DamageSource.NoPets, 5.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByPresence, "https://wiki.guildwars2.com/images/6/60/Serrated_Stones.png"),
            ...
            new BuffDamageModifier(Boon.BoonsByName["Number of Boons"], "Bountiful Power", DamageSource.NoPets, 2.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, ByStack, "https://wiki.guildwars2.com/images/7/75/Bountiful_Power.png"),
            new BuffDamageModifier(new BuffsTrackerMulti(Boon.BoonsByName["Swiftness"], Boon.BoonsByName["Superspeed"]), "Swift Revenge", DamageSource.NoPets, 7.0, DamageType.Power, DamageType.All, ModifierSource.Elementalist, "https://wiki.guildwars2.com/images/9/94/Swift_Revenge.png"),
            // TODO Swift Revenge
        };
