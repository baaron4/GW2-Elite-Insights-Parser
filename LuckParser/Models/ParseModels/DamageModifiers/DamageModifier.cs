...
namespace LuckParser.Models.ParseModels
{
    public abstract class DamageModifier
    {
        ...
        private static List<DamageModifier> _allDamageModifier = new List<DamageModifier>
        {
            ...
            new DamageLogDamageModifier("Aquamancer's Training", "Aquamancer's Training – 10% over 90% HP", DamageSource.NoPets, 10.0, DamageType.Power, DamageType.Power, ModifierSource.Elementalist,"https://wiki.guildwars2.com/images/8/81/Aquamancer%27s_Training.png", x => x.IsNinety, ByPresence),
